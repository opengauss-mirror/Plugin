...
extern List* db_a_raw_parser(const char* str, List** query_string_locationlist = NULL);
...
stmt_dynexecute : K_EXECUTE
                    {
                        ...
                        {
                            plasql_push_back_token(endtoken);
                        }
