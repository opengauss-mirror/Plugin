...
extern int plbsql_yylex(void);
extern void plbsql_push_back_token(int token);
...
extern void plbsql_yyerror(const char* message, bool isError = false);
...
extern int plbsql_yyparse(void);
