----------------------- test 1: add new node && rebalance -----------------------------
\c - - - :master_port

SET spq.next_shard_id TO 1000000;
...
select spq_move_shard_placement(1000000, 'localhost', :worker_1_port, 'localhost', :worker_2_port);

select spq_move_shard_placement(1000005, 'localhost', :worker_1_port, 'localhost', :worker_2_port);

select spq_move_shard_placement(1000006, 'localhost', :worker_1_port, 'localhost', :worker_2_port);

select spq_move_shard_placement(1000007, 'localhost', :worker_1_port, 'localhost', :worker_2_port);
