...
--
SET spq.next_shard_id TO 1400000;
SET spq.shard_count = 4;
...
\copy users_table FROM 'data/users_table.data' WITH CSV;
SELECT count(*) FROM users_table;
\copy events_table FROM 'data/events_table.data' WITH CSV;
SELECT count(*) FROM events_table;

SET spq.shard_count = 16;
