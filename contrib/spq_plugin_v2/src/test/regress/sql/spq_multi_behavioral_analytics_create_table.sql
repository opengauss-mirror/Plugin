...
--
SET spq.next_shard_id TO 1300000;
SET spq.shard_replication_factor = 1;
SET spq.shard_count = 32;

CREATE SCHEMA with_basics_create;
SET search_path TO 'with_basics_create';
...
SET spq.shard_count = 96;
CREATE SCHEMA subquery_and_ctes_create;
SET search_path TO 'subquery_and_ctes_create';
...
SET spq.shard_count TO DEFAULT;
...
SET spq.next_shard_id TO 1300297;
