...
SET spq.next_shard_id TO 1840000;
...
SET spq.enable_fast_path_router_planner TO true;
...
SET spq.shard_replication_factor TO 2;
...
DELETE FROM modify_fast_path WHERE value_1 = 15 AND (key = 1 AND value_2 = 'spq');
...
DELETE FROM modify_fast_path WHERE value_1 = 15 OR (key = 1 AND value_2 = 'spq');
DELETE FROM modify_fast_path WHERE value_1 = 15 AND (key = 1 OR value_2 = 'spq');
...
SET spq.log_remote_commands TO ON;
...
SET spq.enable_fast_path_router_planner TO FALSE;
...
RESET spq.enable_fast_path_router_planner;

RESET client_min_messages;
RESET spq.log_remote_commands;
