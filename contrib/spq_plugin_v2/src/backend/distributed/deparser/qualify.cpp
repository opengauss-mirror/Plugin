 ...
 */
void QualifyTreeNode(Node* stmt)
{
...
/*
 * QualifyRenameAttributeStmt transforms a RENAME ATTRIBUTE statement in place and makes
 * all (supported) statements fully qualified.
 */
void QualifyRenameAttributeStmt(Node* node)
{
