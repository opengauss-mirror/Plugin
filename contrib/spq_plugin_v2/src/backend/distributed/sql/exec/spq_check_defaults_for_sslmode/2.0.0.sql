...
$$
BEGIN
    -- Spq 8.1 and higher default to requiring SSL for all outgoing connections
    -- (specified by __$spq$__.node_conninfo).
    ...
    -- This will only be the case for upgrades from previous versions of Spq, on new
