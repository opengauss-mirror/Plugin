-- we use the spq_extradata_container function as a range table entry in the query part
...
CREATE OR REPLACE FUNCTION pg_catalog.spq_extradata_container(INTERNAL)
    RETURNS SETOF record
    LANGUAGE C
AS 'MODULE_PATHNAME', $$spq_extradata_container$$;
COMMENT ON FUNCTION pg_catalog.spq_extradata_container(INTERNAL)
