CREATE OR REPLACE FUNCTION pg_catalog.spq_add_rebalance_strategy(
    name name,
    ...
    $$ LANGUAGE sql;
COMMENT ON FUNCTION pg_catalog.spq_add_rebalance_strategy(name,regproc,regproc,regproc,float4, float4, float4)
