...
CREATE OR REPLACE FUNCTION __$spq_internal$__.pg_dist_rebalance_strategy_trigger_func()
RETURNS TRIGGER AS $$
  BEGIN
    -- spq_add_rebalance_strategy also takes out a ShareRowExclusiveLock
