CREATE OR REPLACE FUNCTION pg_catalog.worker_partition_query_result(
    ...
    partition_method __$spq$__.distribution_type,
...
COMMENT ON FUNCTION pg_catalog.worker_partition_query_result(text, text, int, __$spq$__.distribution_type, text[], text[], boolean, boolean, boolean)
