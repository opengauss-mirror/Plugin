CREATE OR REPLACE FUNCTION pg_catalog.spq_internal_global_blocked_processes(
...
LANGUAGE C STRICT
AS $$MODULE_PATHNAME$$, $$spq_internal_global_blocked_processes$$;
COMMENT ON FUNCTION pg_catalog.spq_internal_global_blocked_processes()
