 ...
 * ref: https://docs.orafce.com/cd/E17952_01/mysql-5.7-en/signal.html
*/
...
#ifdef WHALE
extern void a_plpgsql_parser_setup(struct ParseState* pstate, PLpgSQL_expr* expr);
#else
 ...
 */
#ifdef WHALE
extern "C" DLL_PUBLIC Datum a_plpgsql_call_handler(PG_FUNCTION_ARGS);
extern "C" DLL_PUBLIC Datum a_plpgsql_inline_handler(PG_FUNCTION_ARGS);
extern "C" DLL_PUBLIC Datum a_plpgsql_validator(PG_FUNCTION_ARGS);
#else
