...
set orafce.nls_date_format='YY-MonDD HH24:MI:SS';
select orafce.to_char(orafce.to_date('14-Jan08 11:44:49+05:30'));
set orafce.nls_date_format='YY-DDMon HH24:MI:SS';
select orafce.to_char(orafce.to_date('14-08Jan 11:44:49+05:30'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select orafce.to_char(orafce.to_date('21052014 12:13:44+05:30'));
set orafce.nls_date_format='DDMMYY HH24:MI:SS';
select orafce.to_char(orafce.to_date('210514 12:13:44+05:30'));

set orafce.nls_date_format='DDMMYY HH24:MI:SS';
select orafce.to_char(to_date('14-Jan08 11:44:49+05:30' ,'YY-MonDD HH24:MI:SS'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select orafce.to_char(to_date('14-08Jan 11:44:49+05:30','YY-DDMon HH24:MI:SS'));
set orafce.nls_date_format='YY-MonDD HH24:MI:SS';
select orafce.to_char(to_date('21052014 12:13:44+05:30','DDMMYYYY HH24:MI:SS'));
set orafce.nls_date_format='DDMMYY HH24:MI:SS';
select orafce.to_char(to_date('210514 12:13:44+05:30','DDMMYY HH24:MI:SS'));
