...
SELECT orafce.REGEXP_LIKE('ORANGE' || chr(10) || 'GREEN', '([aeiou])\1', 'in');
...
SELECT orafce.REGEXP_LIKE('ORANGE' || chr(10) || 'GREEN', '^..([aeiou])\1', 'im');
...
SELECT REGEXP_COUNT('ABC123', '[A-Z]'), orafce.REGEXP_COUNT('A1B2C3', '[A-Z]');
-- ORACLE> SELECT REGEXP_COUNT('ABC123', '[A-Z][0-9]'), REGEXP_COUNT('A1B2C3', '[A-Z][0-9]') FROM DUAL; -> 1 | 3
SELECT REGEXP_COUNT('ABC123', '[A-Z][0-9]'), orafce.REGEXP_COUNT('A1B2C3', '[A-Z][0-9]');
...
SELECT REGEXP_COUNT('ABC123', '([A-Z][0-9]){2}'), orafce.REGEXP_COUNT('A1B2C3', '([A-Z][0-9]){2}');
...
-- ORACLE> SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[^ ]+', 1, 6) FROM DUAL; -> 37
SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[^ ]+', 1, 6);
-- ORACLE> SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[S|R|P][[:alpha:]]{6}', 3, 2, 0) FROM DUAL; -> 21
SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[S|R|P][[:alpha:]]{6}', 3, 2, 0);
-- ORACLE> SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[S|R|P][[:alpha:]]{6}', 3, 2, 1) FROM DUAL; -> 28
SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[S|R|P][[:alpha:]]{6}', 3, 2, 1);
-- ORACLE> SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[s|r|p][[:alpha:]]{6}', 3, 2, 1, 'i') FROM DUAL; -> 28
SELECT REGEXP_INSTR('500 Orafce Parkway, Redwood Shores, CA', '[q|r|p][[:alpha:]]{6}', 3, 2, 1, 'i');
...
SELECT orafce.REGEXP_REPLACE ('A PostgreSQL function', 'a|e|i|o|u', 'X', 1, 1, 'g');
...
--
SELECT orafce.REGEXP_LIKE(NULL, '\d+', 'i');
SELECT orafce.REGEXP_LIKE('1234', NULL, 'i');
SELECT orafce.REGEXP_LIKE('1234', '\d+', NULL);
SELECT orafce.REGEXP_LIKE('1234', '\d+', '');
SELECT orafce.REGEXP_COUNT('1234', '\d', NULL) ;
SELECT orafce.REGEXP_COUNT('1234', '\d', 1, NULL) ;
SELECT orafce.REGEXP_COUNT('1234', '\d', 1, '') ;
SELECT orafce.REGEXP_COUNT('1234', '\d', NULL, NULL) ;
SELECT orafce.REGEXP_COUNT(NULL, '4', 1, 'i');
SELECT orafce.REGEXP_INSTR('1234', '4', NULL);
SELECT orafce.REGEXP_INSTR('1234', '4', 1, NULL);
SELECT orafce.REGEXP_INSTR('1234', '4', 1, 1, NULL);
SELECT orafce.REGEXP_INSTR('1234', '4', 1, 1, 1, NULL);
SELECT orafce.REGEXP_INSTR('1234', '4', 1, 1, 0, NULL);
SELECT orafce.REGEXP_INSTR('1234', '4', 1, 1, 0, 'i', NULL);
SELECT orafce.REGEXP_INSTR('1234', '4', 1, 1, 0, '', NULL);
SELECT orafce.REGEXP_INSTR(NULL, '4', 1, 1, 0, 'i', 2);
SELECT orafce.REGEXP_INSTR(NULL, '4', 1, 1, 0, 'i', 2);
SELECT orafce.REGEXP_SUBSTR('1234', '1(.*)', null);
SELECT orafce.REGEXP_SUBSTR('1234', '234', 1, null);
SELECT orafce.REGEXP_SUBSTR('1234', '234', 1, 1, null);
SELECT orafce.REGEXP_SUBSTR('1234', '234', 1, 1, '');
SELECT orafce.REGEXP_SUBSTR('1234', '234', 1, 1, 'i', null);
-- test for capture group
SELECT orafce.REGEXP_SUBSTR('1234', '2(3)(4)', 1, 1, 'i', 1);
SELECT orafce.REGEXP_SUBSTR('1234', '2(3)(4)', 1, 1, 'i', 2);
SELECT orafce.REGEXP_SUBSTR('1234', '2(3)(4)', 1, 1, 'i', 0);
-- Special case for second parameter in REGEXP_REPLACE, when null returns the original value.
SELECT orafce.REGEXP_REPLACE(null, '\d', 'a');
SELECT orafce.REGEXP_REPLACE('1234', null, 'a');
SELECT orafce.REGEXP_REPLACE('1234', null, null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', 'a', null);
SELECT orafce.REGEXP_REPLACE('1234', null, 'a', 2);
SELECT orafce.REGEXP_REPLACE('1234', null, 'a', null);
SELECT orafce.REGEXP_REPLACE('1234', null, 'a', 1);
SELECT orafce.REGEXP_REPLACE('1234', null, 'a', 1, null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', 'a', 1, null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', 'a', 1, null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', 'a', 1, null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', 'a', 1, 1, null);
SELECT orafce.REGEXP_REPLACE('1234', '\d', 'a', 1, NULL, 'i');
SELECT orafce.REGEXP_REPLACE('1234', null, 'a', 1, 1, 'i');
