...
--
-- test built-in date type orafce compatibility functions
--
...
SET search_path TO orafce,"$user", public, pg_catalog;
...
select trunc(TIMESTAMP WITH TIME ZONE '2004-10-19 10:23:54+02','DAY') = '2004-10-19 00:00:00-07';
...
select orafce.substr('This is a test', 6, 2) = 'is';
select orafce.substr('This is a test', 6) =  'is a test';
select orafce.substr('TechOnTheNet', 1, 4) =  'Tech';
select orafce.substr('TechOnTheNet', -3, 3) =  'Net';
select orafce.substr('TechOnTheNet', -6, 3) =  'The';
select orafce.substr('TechOnTheNet', -8, 2) =  'On';
select orafce.substr('TechOnTheNet', -8, 0) =  '';
select orafce.substr('TechOnTheNet', -8, -1) =  '';
select orafce.substr(1234567,3.6::smallint)='4567';
select orafce.substr(1234567,3.6::int)='4567';
select orafce.substr(1234567,3.6::bigint)='4567';
select orafce.substr(1234567,3.6::numeric)='34567';
select orafce.substr(1234567,-1)='7';
select orafce.substr(1234567,3.6::smallint,2.6)='45';
select orafce.substr(1234567,3.6::smallint,2.6::smallint)='456';
select orafce.substr(1234567,3.6::smallint,2.6::int)='456';
select orafce.substr(1234567,3.6::smallint,2.6::bigint)='456';
select orafce.substr(1234567,3.6::smallint,2.6::numeric)='45';
select orafce.substr(1234567,3.6::int,2.6::smallint)='456';
select orafce.substr(1234567,3.6::int,2.6::int)='456';
select orafce.substr(1234567,3.6::int,2.6::bigint)='456';
select orafce.substr(1234567,3.6::int,2.6::numeric)='45';
select orafce.substr(1234567,3.6::bigint,2.6::smallint)='456';
select orafce.substr(1234567,3.6::bigint,2.6::int)='456';
select orafce.substr(1234567,3.6::bigint,2.6::bigint)='456';
select orafce.substr(1234567,3.6::bigint,2.6::numeric)='45';
select orafce.substr(1234567,3.6::numeric,2.6::smallint)='345';
select orafce.substr(1234567,3.6::numeric,2.6::int)='345';
select orafce.substr(1234567,3.6::numeric,2.6::bigint)='345';
select orafce.substr(1234567,3.6::numeric,2.6::numeric)='34';
select orafce.substr('abcdef'::varchar,3.6::smallint)='def';
select orafce.substr('abcdef'::varchar,3.6::int)='def';
select orafce.substr('abcdef'::varchar,3.6::bigint)='def';
select orafce.substr('abcdef'::varchar,3.6::numeric)='cdef';
select orafce.substr('abcdef'::varchar,3.5::int,3.5::int)='def';
select orafce.substr('abcdef'::varchar,3.5::numeric,3.5::numeric)='cde';
select orafce.substr('abcdef'::varchar,3.5::numeric,3.5::int)='cdef';
...
select round(TIMESTAMP WITHOUT TIME ZONE'12/08/1990 05:35:25','YEAR') = '1991-01-01 00:00:00';
select round(TIMESTAMP WITHOUT TIME ZONE'05/08/1990 05:35:25','Q') = '1990-04-01 00:00:00';
select round(TIMESTAMP WITHOUT TIME ZONE'12/08/1990 05:35:25','MONTH') = '1990-12-01 00:00:00';
select round(TIMESTAMP WITHOUT TIME ZONE'12/08/1990 05:35:25','DDD') = '1990-12-08 00:00:00';
select round(TIMESTAMP WITHOUT TIME ZONE'12/08/1990 05:35:25','DAY') = '1990-12-09 00:00:00';
select round(TIMESTAMP WITHOUT TIME ZONE'12/08/1990 05:35:25','hh') = '1990-12-08 06:00:00';
select round(TIMESTAMP WITHOUT TIME ZONE'12/08/1990 05:35:25','mi') = '1990-12-08 05:35:00';
select round(TIMESTAMP WITH TIME ZONE'12/01/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/02/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/03/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/04/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/05/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/06/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/07/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/08/1990 05:35:25','Iyyy');
select round(TIMESTAMP WITH TIME ZONE'12/08/1990 05:35:25','Cc');
select round(TIMESTAMP WITH TIME ZONE'12/08/1990 05:35:25','W');
select round(TIMESTAMP WITH TIME ZONE'12/08/1990 05:35:25','Ww');
...
-- LTRIM
--
SELECT '|' || orafce.ltrim(' abcd'::char(10)) || '|' as LTRIM;
SELECT '|' || orafce.ltrim(' abcd'::char(10),'a'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.ltrim(' abcd'::char(10),'a'::text) || '|' as LTRIM;
SELECT '|' || orafce.ltrim(' abcd'::char(10),'a'::varchar2(3)) || '|' as LTRIM;
SELECT '|' || orafce.ltrim(' abcd'::char(10),'a'::nvarchar2(3)) || '|' as LTRIM;

SELECT '|' || orafce.ltrim(' abcd  '::text,'a'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.ltrim(' abcd  '::varchar2(10),'a'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.ltrim(' abcd  '::nvarchar2(10),'a'::char(3)) || '|' as LTRIM;

--
-- RTRIM
--
SELECT '|' || orafce.rtrim(' abcd'::char(10)) || '|' as LTRIM;
SELECT '|' || orafce.rtrim(' abcd'::char(10),'d'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.rtrim(' abcd'::char(10),'d'::text) || '|' as LTRIM;
SELECT '|' || orafce.rtrim(' abcd'::char(10),'d'::varchar2(3)) || '|' as LTRIM;
SELECT '|' || orafce.rtrim(' abcd'::char(10),'d'::nvarchar2(3)) || '|' as LTRIM;

SELECT '|' || orafce.rtrim(' abcd  '::text,'d'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.rtrim(' abcd  '::varchar2(10),'d'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.rtrim(' abcd  '::nvarchar2(10),'d'::char(3)) || '|' as LTRIM;

--
-- BTRIM
--
SELECT '|' || orafce.btrim(' abcd'::char(10)) || '|' as LTRIM;
SELECT '|' || orafce.btrim(' abcd'::char(10),'ad'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.btrim(' abcd'::char(10),'ad'::text) || '|' as LTRIM;
SELECT '|' || orafce.btrim(' abcd'::char(10),'ad'::varchar2(3)) || '|' as LTRIM;
SELECT '|' || orafce.btrim(' abcd'::char(10),'ad'::nvarchar2(3)) || '|' as LTRIM;

SELECT '|' || orafce.btrim(' abcd  '::text,'d'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.btrim(' abcd  '::varchar2(10),'d'::char(3)) || '|' as LTRIM;
SELECT '|' || orafce.btrim(' abcd  '::nvarchar2(10),'d'::char(3)) || '|' as LTRIM;
...
SELECT orafce.round(1.234::double precision, 2), orafce.trunc(1.234::double precision, 2);
SELECT orafce.round(1.234::float, 2), orafce.trunc(1.234::float, 2);
...
CREATE TRIGGER trg_test_xx BEFORE INSERT OR UPDATE
  ON trg_test FOR EACH ROW EXECUTE PROCEDURE orafce.replace_empty_strings(true);
...
CREATE TRIGGER trg_test_xx BEFORE INSERT OR UPDATE
  ON trg_test FOR EACH ROW EXECUTE PROCEDURE orafce.replace_null_strings();
...
SELECT orafce.unistr('\0441\043B\043E\043D');
SELECT orafce.unistr('d\u0061t\U00000061');

-- run-time error
SELECT orafce.unistr('wrong: \db99');
SELECT orafce.unistr('wrong: \db99\0061');
SELECT orafce.unistr('wrong: \+00db99\+000061');
SELECT orafce.unistr('wrong: \+2FFFFF');
SELECT orafce.unistr('wrong: \udb99\u0061');
SELECT orafce.unistr('wrong: \U0000db99\U00000061');
SELECT orafce.unistr('wrong: \U002FFFFF');

SELECT orafce.sysdate();
SELECT orafce.dbtimezone();
SELECT orafce.sessiontimezone();
