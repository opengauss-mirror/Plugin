 ...
 * ----------
 */
PG_FUNCTION_INFO_V1_PUBLIC(a_plpgsql_call_handler);
...
Datum a_plpgsql_call_handler(PG_FUNCTION_ARGS)
{
    bool nonatomic;
 ...
 * ----------
 */
PG_FUNCTION_INFO_V1_PUBLIC(a_plpgsql_inline_handler);

Datum a_plpgsql_inline_handler(PG_FUNCTION_ARGS)
{
 ...
 * ----------
 */
PG_FUNCTION_INFO_V1_PUBLIC(a_plpgsql_validator);

Datum a_plpgsql_validator(PG_FUNCTION_ARGS)
{
