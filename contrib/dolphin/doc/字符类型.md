...
<td class="cellrowborder" valign="top" width="53%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0283136755_zh-cn_topic_0237121950_zh-cn_topic_0059777889_zh-cn_topic_0058966269_p60253707"><a name="zh-cn_topic_0283136755_zh-cn_topic_0237121950_zh-cn_topic_0059777889_zh-cn_topic_0058966269_p60253707"></a><a name="zh-cn_topic_0283136755_zh-cn_topic_0237121950_zh-cn_topic_0059777889_zh-cn_topic_0058966269_p60253707"></a>定长字符串，不足补空格。PG/B兼容模式下，n是指字符长度。其他兼容模式下，n是指字节长度。如不带精度n，默认精度为1。</p>
</td>
...
>3. 以上字符数据类型在对比时，均忽略尾部空格，如where条件过滤场景、join场景等。例如 'a'::text = 'a  '::text 为真。需要特别注意的是，对于VARCHAR、VARCHAR2、NVARCHAR2、NVARCHAR、TEXT、CLOB类型，只有GUC参数 string_hash_compatible 为on的情况下，hash join以及hash agg才会忽略尾部空格。
