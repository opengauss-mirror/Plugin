...
#ifdef DOLPHIN
PG_KEYWORD("dayofmonth", DAYOFMONTH, COL_NAME_KEYWORD)
PG_KEYWORD("dayofweek", DAYOFWEEK, COL_NAME_KEYWORD)
PG_KEYWORD("dayofyear", DAYOFYEAR, COL_NAME_KEYWORD)
#endif
...
PG_KEYWORD("hour", HOUR_P, COL_NAME_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("microsecond", MICROSECOND_P, COL_NAME_KEYWORD)
...
#ifdef DOLPHIN
PG_KEYWORD("minute", MINUTE_P, COL_NAME_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("quarter", QUARTER, COL_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("second", SECOND_P, COL_NAME_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("weekday", WEEKDAY, COL_NAME_KEYWORD)
PG_KEYWORD("weekofyear", WEEKOFYEAR, COL_NAME_KEYWORD)
#endif
