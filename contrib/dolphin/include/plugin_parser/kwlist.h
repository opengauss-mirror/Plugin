...
#ifdef DOLPHIN
PG_KEYWORD("authid", AUTHID, COL_NAME_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("binary", BINARY, COL_NAME_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("body", BODY_P, RESERVED_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("fixed", FIXED_P, COL_NAME_KEYWORD)
#else
...
#ifdef DOLPHIN
PG_KEYWORD("if", IF_P, COL_NAME_KEYWORD)
...
#ifdef DOLPHIN
PG_KEYWORD("index", INDEX, TYPE_FUNC_NAME_KEYWORD)
#else
