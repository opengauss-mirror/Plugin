...
#ifdef DOLPHIN
PG_KEYWORD("against", AGAINST, TYPE_FUNC_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("any", ANY, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("ascii", ASCII, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("authid", AUTHID, COL_NAME_KEYWORD) // origin: RESERVED_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("autoextend_size", AUTOEXTEND_SIZE, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("automapped", AUTOMAPPED, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("avg_row_length", AVG_ROW_LENGTH, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("binary", BINARY, COL_NAME_KEYWORD) // origin: TYPE_FUNC_NAME_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("box", DB_B_BOX, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("bytea", DB_B_BYTEA, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("cast", CAST, COL_NAME_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("channel", CHANNEL, UNRESERVED_KEYWORD)
#endif
...
PG_KEYWORD("cidr", DB_B_CIDR, UNRESERVED_KEYWORD)
PG_KEYWORD("circle", DB_B_CIRCLE, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("collation", COLLATION, UNRESERVED_KEYWORD) /* ORIGIN: TYPE_FUNC_NAME_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("count", COUNT, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("curtime", CURTIME, RESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("databases", DATABASES, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("date_add", DATE_ADD_P, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("date_format", DATE_FORMAT_P, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("date_sub", DATE_SUB_P, UNRESERVED_KEYWORD)
PG_KEYWORD("datetime", DATETIME, COL_NAME_KEYWORD)
#endif
PG_KEYWORD("day", DAY_P, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("day_hour", DAY_HOUR_P, UNRESERVED_KEYWORD)
PG_KEYWORD("day_microsecond", DAY_MICROSECOND_P, UNRESERVED_KEYWORD)
...
#ifdef DOLPHIN
PG_KEYWORD("delay_key_write", DELAY_KEY_WRITE, UNRESERVED_KEYWORD)
PG_KEYWORD("delayed", DELAYED, RESERVED_KEYWORD)
#endif
...
#endif
#ifdef DOLPHIN
PG_KEYWORD("div", DIV, TYPE_FUNC_NAME_KEYWORD)
PG_KEYWORD("do", DO, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("dual", DUAL_P, RESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("end", END_P, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif   
PG_KEYWORD("ends", ENDS, UNRESERVED_KEYWORD)
PG_KEYWORD("enforced", ENFORCED, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("engine", ENGINE_P, UNRESERVED_KEYWORD)
PG_KEYWORD("engine_attribute", ENGINE_ATTRIBUTE, UNRESERVED_KEYWORD)
PG_KEYWORD("engines", ENGINES, UNRESERVED_KEYWORD)
PG_KEYWORD("enum", ENUM_P, RESERVED_KEYWORD) // origin: UNRESERVED_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("expansion", EXPANSION, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("expired", EXPIRED_P, UNRESERVED_KEYWORD)
PG_KEYWORD("explain", EXPLAIN, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("extended", EXTENDED, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("fixed", FIXED_P, COL_NAME_KEYWORD) // origin: UNRESERVED_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("get_format", GET_FORMAT, COL_NAME_KEYWORD)
#endif
PG_KEYWORD("global", GLOBAL, UNRESERVED_KEYWORD)
PG_KEYWORD("grant", GRANT, RESERVED_KEYWORD)
PG_KEYWORD("granted", GRANTED, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("grants", GRANTS, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("hosts", HOSTS, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("hour", HOUR_P, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("hour_microsecond", HOUR_MICROSECOND_P, UNRESERVED_KEYWORD)
...
#ifdef DOLPHIN
PG_KEYWORD("if", IF_P, COL_NAME_KEYWORD) // origin: UNRESERVED_KEYWORD
PG_KEYWORD("ifnull", IFNULL, COL_NAME_KEYWORD)
PG_KEYWORD("ignore", IGNORE, TYPE_FUNC_NAME_KEYWORD) // origin: UNRESERVED_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("index", INDEX, TYPE_FUNC_NAME_KEYWORD) // origin: UNRESERVED_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("insert_method", INSERT_METHOD, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("json", DB_B_JSON, UNRESERVED_KEYWORD)
PG_KEYWORD("json_object", DB_B_JSOBJ, COL_NAME_KEYWORD)
PG_KEYWORD("jsonb", DB_B_JSONB, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("key", KEY, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("key_block_size", KEY_BLOCK_SIZE, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("last_day", LAST_DAY_FUNC, COL_NAME_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("less", LESS, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("locate", LOCATE, COL_NAME_KEYWORD)
#endif
...
PG_KEYWORD("longtext", TEXT_P, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("loop", LOOP, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("low_priority", LOW_PRIORITY, RESERVED_KEYWORD)
PG_KEYWORD("lseg", DB_B_LSEG, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("max_rows", MAX_ROWS, UNRESERVED_KEYWORD)
#endif
...
PG_KEYWORD("mediumtext", TEXT_P, UNRESERVED_KEYWORD)
PG_KEYWORD("memory", MEMORY, UNRESERVED_KEYWORD)
#endif
...
PG_KEYWORD("mid", MID, COL_NAME_KEYWORD)
PG_KEYWORD("min_rows", MIN_ROWS, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("minextents", MINEXTENTS, UNRESERVED_KEYWORD)
/* PG_KEYWORD("minus", MINUS_P, RESERVED_KEYWORD) */
PG_KEYWORD("minute", MINUTE_P, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("minute_microsecond", MINUTE_MICROSECOND_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("modify", MODIFY_P, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("ngram", NGRAM, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("no", NO, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("no_write_to_binlog", NO_WRITE_TO_BINLOG, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("notnull", NOTNULL, UNRESERVED_KEYWORD) /* ORIGIN: TYPE_FUNC_NAME_KEYWORD */
#endif
PG_KEYWORD("novalidate", NOVALIDATE, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("now", NOW_FUNC, RESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("only", ONLY, COL_NAME_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
#ifdef DOLPHIN
PG_KEYWORD("open", OPEN, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("operator", OPERATOR, UNRESERVED_KEYWORD)
PG_KEYWORD("optimization", OPTIMIZATION, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("optimize", OPTIMIZE, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("pack_keys", PACK_KEYS, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("partitioning", PARTITIONING, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("partitions", PARTITIONS, UNRESERVED_KEYWORD)
PG_KEYWORD("passing", PASSING, UNRESERVED_KEYWORD)
PG_KEYWORD("password", PASSWORD, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("path", DB_B_PATH, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("performance", PERFORMANCE, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("point", DB_B_POINT, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("policy", POLICY, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("polygon", DB_B_POLYGON, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("processlist", PROCESSLIST, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("profile", PROFILE, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("proxy", PROXY, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("quick", QUICK, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("recyclebin", RECYCLEBIN, UNRESERVED_KEYWORD) /* ORIGIN: TYPE_FUNC_NAME_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("reject", REJECT_P, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("reorganize", REORGANIZE, UNRESERVED_KEYWORD)
PG_KEYWORD("repair", REPAIR, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("replicas", REPLICAS, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("reset", RESET, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("resignal", RESIGNAL, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("reverse", REVERSE, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("row_format", ROW_FORMAT, UNRESERVED_KEYWORD)
#endif
/*
 * #ifndef ENABLE_MULTIPLE_NODES
...
#ifdef DOLPHIN
PG_KEYWORD("second_microsecond", SECOND_MICROSECOND_P, UNRESERVED_KEYWORD)
PG_KEYWORD("secondary_engine_attribute", SECONDARY_ENGINE_ATTRIBUTE, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("shrink", SHRINK, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("shutdown", SHUTDOWN, UNRESERVED_KEYWORD)
PG_KEYWORD("siblings", SIBLINGS, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("signal", SIGNAL, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("signed", SIGNED, COL_NAME_KEYWORD)
...
#ifdef DOLPHIN
PG_KEYWORD("sounds", SOUNDS, TYPE_FUNC_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("stats_auto_recalc", STATS_AUTO_RECALC, UNRESERVED_KEYWORD)
PG_KEYWORD("stats_persistent", STATS_PERSISTENT, UNRESERVED_KEYWORD)
PG_KEYWORD("stats_sample_pages", STATS_SAMPLE_PAGES, UNRESERVED_KEYWORD)
...
#ifdef DOLPHIN
PG_KEYWORD("sysdate", SYSDATE, COL_NAME_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("temptable", TEMPTABLE, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("terminated", TERMINATED, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("text", TEXT_P, COL_NAME_KEYWORD) // origin: UNRESERVED_KEYWORD
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("timestamptz", DB_B_TIMESTAMPTZ, UNRESERVED_KEYWORD)
PG_KEYWORD("timetz", DB_B_TIMETZ, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("tinyint", TINYINT, COL_NAME_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("tinytext", TEXT_P, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("triggers", TRIGGERS, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("undefined", UNDEFINED, UNRESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("unsigned", UNSIGNED, COL_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("use", USE, UNRESERVED_KEYWORD)
#endif
PG_KEYWORD("useeof", USEEOF, UNRESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("user", USER, UNRESERVED_KEYWORD) /* ORIGIN: RESERVED_KEYWORD */
#endif
PG_KEYWORD("using", USING, RESERVED_KEYWORD)
#ifdef DOLPHIN
PG_KEYWORD("utc_date", UTC_DATE, RESERVED_KEYWORD)
PG_KEYWORD("utc_time", UTC_TIME, RESERVED_KEYWORD)
PG_KEYWORD("utc_timestamp", UTC_TIMESTAMP, RESERVED_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("varbinary", VARBINARY, COL_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("verbose", VERBOSE, UNRESERVED_KEYWORD) /* ORIGIN: TYPE_FUNC_NAME_KEYWORD */
#endif
...
PG_KEYWORD("weight_string", WEIGHT_STRING, COL_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("xor", XOR, TYPE_FUNC_NAME_KEYWORD)
#endif
...
#ifdef DOLPHIN
PG_KEYWORD("zerofill", ZEROFILL, UNRESERVED_KEYWORD)
#endif
