...
#define B_FORMAT_TIMESTAMP_BASE_VALUE INT64CONST(-63113990400000000) /* datetime 0000-00-00 00:00:00.000000 */
...
extern void check_b_format_datetime_range_with_ereport(Timestamp &datetime, bool ignore = false);
