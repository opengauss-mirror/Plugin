...
#define OPT_SQL_MODE_AUTO_RECOMPILE_FUNCTION (1 << 8)
...
#define OPT_SQL_MODE_NO_AUTO_VALUE_ON_ZERO (1<<13)
#define OPT_SQL_MODE_DISABLE_ESCAPE_BYTEA (1<<14)
#define OPT_SQL_MODE_MAX 15
...
#define SQL_MODE_PIPES_AS_CONCAT() \
    ((GetSessionContext()->sqlModeFlags & OPT_SQL_MODE_PIPES_AS_CONCAT) || u_sess->attr.attr_common.IsInplaceUpgrade)
...
#define SQL_MODE_AUTO_RECOMPILE_FUNCTION() (GetSessionContext()->sqlModeFlags & OPT_SQL_MODE_AUTO_RECOMPILE_FUNCTION)
