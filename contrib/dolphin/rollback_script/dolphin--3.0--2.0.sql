...
BEGIN
    IF EXISTS (
        ...
        EXECUTE 'ALTER OPERATOR FAMILY integer_ops USING hash DROP OPERATOR 1 (int8, uint2)';
    END IF;
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER OPERATOR FAMILY integer_ops USING hash DROP OPERATOR 1 (int8, uint4)';
    END IF;
