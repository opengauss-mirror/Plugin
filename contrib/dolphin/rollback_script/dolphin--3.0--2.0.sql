...
DROP OPERATOR IF EXISTS pgcatalog.=(tinyblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(tinyblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>(tinyblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(tinyblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<(tinyblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(tinyblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.=(tinyblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<>(tinyblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.>(tinyblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.>=(tinyblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<(tinyblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<=(tinyblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.=(tinyblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(tinyblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>(tinyblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(tinyblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<(tinyblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(tinyblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.=(tinyblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(tinyblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>(tinyblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(tinyblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<(tinyblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(tinyblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.=(tinyblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<>(tinyblob, text);
DROP OPERATOR IF EXISTS pgcatalog.>(tinyblob, text);
DROP OPERATOR IF EXISTS pgcatalog.>=(tinyblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<(tinyblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<=(tinyblob, text);
DROP OPERATOR IF EXISTS pgcatalog.=(text, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(text, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>(text, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(text, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<(text, tinyblob);
...
DROP OPERATOR IF EXISTS pgcatalog.=(blob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(blob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>(blob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(blob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<(blob, tinyblob);
...
DROP OPERATOR IF EXISTS pgcatalog.<(blob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(blob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.=(blob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(blob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>(blob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(blob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<(blob, longblob);
...
DROP OPERATOR IF EXISTS pgcatalog.=(mediumblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(mediumblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>(mediumblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(mediumblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<(mediumblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(mediumblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.=(mediumblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<>(mediumblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.>(mediumblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.>=(mediumblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<(mediumblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<=(mediumblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.=(mediumblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(mediumblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>(mediumblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(mediumblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<(mediumblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(mediumblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.=(mediumblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(mediumblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>(mediumblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(mediumblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<(mediumblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(mediumblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.=(mediumblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<>(mediumblob, text);
DROP OPERATOR IF EXISTS pgcatalog.>(mediumblob, text);
DROP OPERATOR IF EXISTS pgcatalog.>=(mediumblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<(mediumblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<=(mediumblob, text);
DROP OPERATOR IF EXISTS pgcatalog.=(text, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(text, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>(text, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(text, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<(text, mediumblob);
...
DROP OPERATOR IF EXISTS pgcatalog.=(longblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(longblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>(longblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(longblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<(longblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(longblob, tinyblob);
DROP OPERATOR IF EXISTS pgcatalog.=(longblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<>(longblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.>(longblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.>=(longblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<(longblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.<=(longblob, blob);
DROP OPERATOR IF EXISTS pgcatalog.=(longblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(longblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>(longblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(longblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<(longblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(longblob, mediumblob);
DROP OPERATOR IF EXISTS pgcatalog.=(longblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(longblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>(longblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(longblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<(longblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<=(longblob, longblob);
DROP OPERATOR IF EXISTS pgcatalog.=(longblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<>(longblob, text);
DROP OPERATOR IF EXISTS pgcatalog.>(longblob, text);
DROP OPERATOR IF EXISTS pgcatalog.>=(longblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<(longblob, text);
DROP OPERATOR IF EXISTS pgcatalog.<=(longblob, text);
DROP OPERATOR IF EXISTS pgcatalog.=(text, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<>(text, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>(text, longblob);
DROP OPERATOR IF EXISTS pgcatalog.>=(text, longblob);
DROP OPERATOR IF EXISTS pgcatalog.<(text, longblob);
