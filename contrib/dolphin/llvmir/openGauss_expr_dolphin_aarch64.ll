; ModuleID = 'GaussDB_expr.cc'
source_filename = "GaussDB_expr.cc"
...
%struct.hashCell = type { %union.anon.2, [1 x %struct.hashVal] }
...
%struct.HeapScanDescData = type { %struct.RelationData*, %struct.SnapshotData*, i32, %struct.ScanKeyData*, i8, i8, i8, i8, i8, i32, i32, %struct.BufferAccessStrategyData*, i8, i8, i8, %struct.HeapTupleData, %struct.anon, i32, %struct.tupleDesc*, i32, %struct.ItemPointerData, i32, i32, i32, [291 x i16], %struct.SeqScanAccessor*, i32 }
%struct.ScanKeyData = type { i32, i16, i16, i32, i32, %struct.FmgrInfo, i64 }
%struct.BufferAccessStrategyData = type opaque
%struct.anon = type { %struct.HeapTupleHeaderData, [8144 x i8] }
...
%struct.stSSL2State = type { i32, i32, i32, i32, i32, i32, i8*, i32, i32, i32, i32, i32, i8*, i8*, i8*, i32, i32, i32, i32, i32, i8*, i8*, i8*, i8*, i8*, i32, [32 x i8], i32, [16 x i8], i32, [48 x i8], i32, i32, %struct.anon.10 }
%struct.anon.10 = type { i32, i32, i32, i32, i32, i32, [32 x i8], i32, i32, i32, i32 }
%struct.stSSL3State = type { i32, i32, [8 x i8], [64 x i8], [8 x i8], [64 x i8], [32 x i8], [32 x i8], i32, i32, %struct.stSSL3Buffer, %struct.stSSL3Buffer, %struct.stSSL3_Record, %struct.stSSL3_Record, [2 x i8], i32, [4 x i8], i32, i32, i32, i32, i32, i8*, i8*, i8*, i32, i32, i32, i32, [2 x i8], i32, i32, i32, i32, i32, %struct.anon.11, %struct.stIpsiSecureReneg, i8*, i8*, i8*, i8*, [16 x i8], [16 x i8] }
%struct.stSSL3Buffer = type { i8*, i32, i32, i32 }
%struct.stSSL3_Record = type { i32, i32, i32, i8*, i8*, i8*, i32, [8 x i8], i32 }
%struct.anon.11 = type { [128 x i8], [128 x i8], i32, [128 x i8], i32, i32, i32, %struct.stSSLCipher*, %struct.stSEC_PKEY*, i32, i32, i32, i32, [7 x i8], %struct.stSEC_List*, i32, i32, i8*, i32, i32, %struct.stSSLComp*, i32 }
...
%struct.stSSLCtx = type { %struct.stSSLMethod*, %struct.stSEC_List*, %struct.stSEC_List*, %struct.stX509Store*, %struct.lhash_st*, i32, %struct.stSSLSession*, %struct.stSSLSession*, i32, i32, i32 (%struct.stSSL*, %struct.stSSLSession*)*, void (%struct.stSSLCtx*, %struct.stSSLSession*)*, %struct.stSSLSession* (%struct.stSSL*, i8*, i32, i32*)*, %struct.anon.9, i32, i32 (%struct.stX509StoreCtx*, i8*)*, i8*, i8*, i8*, i32 (%struct.stSSL*, %struct.stCertExtnData**, %struct.stSEC_PKEY**)*, i32, i32, i32, %struct.stSEC_List*, %struct.stSEC_List*, void (%struct.stSSL*, i32, i32)*, %struct.stSEC_List*, i32, i32, i32, %struct.cert_st*, i32, void (i32, i32, i32, i8*, i32, %struct.stSSL*, i8*)*, i8*, i32, i32, [32 x i8], i32 (i32, %struct.stX509StoreCtx*)*, i32 (%struct.stSSL*, i8*, i32*)*, %struct.stX509VerifyParam*, i32, %struct.stTLSExtension*, i32 (%struct.stSSL*, %struct.stCertExtnData**, %struct.stSEC_PKEY**)*, i32 (%struct.stSSL*, i32*, %struct.stSEC_List*, %struct.stSEC_PKEY**)*, i32 (%struct.stSSL*, %struct.stSEC_ASNOCTS*)*, i32 (%struct.stSSL*, %struct.stSEC_ASNOCTS*)*, i32 (i8*, %struct.stSEC_ASNOCTS*)*, i32 (%struct.stSSL*)*, i32 (i8*, i32, i8*, i32*)*, i32 (%struct.stSSL*, i8*, i8*, i32*, i8*, i32, i8*)*, i32 (%struct.stSSL*, i8*, i32, i8*, i32, i8*)*, i8*, i8*, %struct.stIpsiDTLS1CtxInfo*, %struct.stCBAppData, i8*, i32, i32, i32, i32, i32, i32, i8*, i32 (%struct.stSSL*, i8*)*, i8* }
%struct.lhash_st = type opaque
%struct.anon.9 = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32 }
...
%union.StreamIdentity = type { %struct.anon.12, [4 x i8] }
...
%union.StreamNetCtlLayer = type { %struct.anon.15 }
%struct.anon.15 = type { i32*, i32*, %struct.gsocket* }
...
@.str.2 = private unnamed_addr constant [43 x i8] c"../../../../src/include/utils/biginteger.h\00", align 1
...
; <label>:11:                                     ; preds = %1
  %12 = inttoptr i64 %0 to %struct.anon.3*
  %13 = getelementptr inbounds %struct.anon.3, %struct.anon.3* %12, i64 0, i32 1, i64 0
  %14 = getelementptr inbounds %struct.anon.3, %struct.anon.3* %12, i64 0, i32 0
...
; <label>:34:                                     ; preds = %28, %23
  ...
  %38 = insertvalue [2 x i64] %37, i64 %35, 1
  ret [2 x i64] %38
}
...
; <label>:28:                                     ; preds = %26, %35
  ...
  %33 = load i8, i8* %30, align 1, !tbaa !19
  %34 = icmp eq i8 %32, %33
...
; <label>:36:                                     ; preds = %29
  %37 = getelementptr i8, i8* %32, i64 1
...
; <label>:28:                                     ; preds = %21
  tail call void @_Z20ExceptionalConditionPKcS0_S0_i(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i64 0, i64 0), i32 98) #8
  unreachable
