...
CharacterSet g_characterSets[] = {
    ...
    {"gb18030", "National Standard", 4, false},
    {"gbk", "Extended National Standard", 2, false},
    ...
    {"windows936", "alias for GBK", 2, false},
...
Datum ShowCharset(PG_FUNCTION_ARGS)
{
    ...
    if (fctx->call_cntr < fctx->max_calls) {
        ...
        bool nulls[fctx->tuple_desc->natts] = {false, false, true, false, false};
