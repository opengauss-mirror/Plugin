...
SELECT CAST('高斯' AS binary) COLLATE "utf8mb4_unicode_ci"; -- ERROR
SELECT CAST('高斯' AS binary) COLLATE "binary";
...
-- 中文 const charset
SELECT CAST('高斯' AS binary);
SELECT CAST(_binary'高斯' AS binary);
SELECT CAST(_utf8mb4'高斯' AS binary);
SELECT CAST(_gbk'高斯' AS binary);
SELECT _binary'高斯';
SELECT _utf8mb4'高斯';
SELECT _gbk'高斯';
SELECT _gb18030'高斯';
...
insert into tarray values(_utf8mb4'{高斯}'::varchar[]);
insert into tarray values(_gbk'{高斯}'::varchar[]); -- ERROR
drop table tarray;
-- -- JSON TEST
...
SELECT _utf8mb4'高斯db' COLLATE utf8mb4_unicode_ci = _binary'高斯DB' COLLATE 'binary';
...
SELECT _utf8mb4'高斯db' COLLATE utf8mb4_unicode_ci = _binary'高斯DB'; -- binary compare, false
...
SELECT CONCAT(_gbk'高斯DB' , _binary'高斯DB') result;
SELECT CONCAT(_gbk'高斯DB' , _gb18030'高斯DB') result, pg_collation_for(result); -- ERROR
SELECT CONCAT(_gb18030'高斯DB' , '高斯DB') result, pg_collation_for(result);
SELECT CONCAT(_gb18030'高斯DB' , _binary'高斯DB') result;
...
SELECT CONCAT(_utf8mb4'高斯DB' , '高斯DB' COLLATE "zh_CN.utf8") result, pg_collation_for(result);
SELECT CONCAT(_utf8mb4'高斯DB' , '高斯DB' COLLATE utf8mb4_unicode_ci) result, pg_collation_for(result);
SELECT CONCAT(_utf8mb4'高斯DB' , '高斯DB' COLLATE utf8mb4_bin) result, pg_collation_for(result);
...
-- -- -- -- same charset
SELECT CONCAT('高斯DB', trim('1.2.3')) result, pg_collation_for(result);
SELECT CONCAT(trim('1.2.3'), '高斯DB') result, pg_collation_for(result);
...
-- -- -- -- diff charset
SELECT CONCAT(_gbk'高斯DB', trim('1.2.3')) result, pg_collation_for(result);
SELECT CONCAT(trim('1.2.3'), _gbk'高斯DB') result, pg_collation_for(result);
SELECT CONCAT(_gbk'高斯DB', 123) result, pg_collation_for(result);
SELECT CONCAT(123, _gbk'高斯DB') result, pg_collation_for(result);
SELECT CONCAT(_gbk'高斯DB', DATE '2023-05-01') result, pg_collation_for(result);
SELECT CONCAT(DATE '2023-05-01', _gbk'高斯DB') result, pg_collation_for(result);
SELECT CONCAT(_gbk'高斯DB', NULL) result, pg_collation_for(result);
SELECT CONCAT(NULL, _gbk'高斯DB') result, pg_collation_for(result);
-- -- -- CONCAT CONCAT with other diff DERIVATION
-- -- -- -- same charset
SELECT CONCAT(CONCAT('高斯DB'), trim('1.2.3')) result, pg_collation_for(result);
SELECT CONCAT(trim('1.2.3'), CONCAT('高斯DB')) result, pg_collation_for(result);
...
-- -- -- -- diff charset
SELECT CONCAT(CONCAT(_gbk'高斯DB'), trim('1.2.3')) result, pg_collation_for(result);
SELECT CONCAT(trim('1.2.3'), CONCAT(_gbk'高斯DB')) result, pg_collation_for(result);
SELECT CONCAT(CONCAT(_gbk'高斯DB'), 123) result, pg_collation_for(result);
SELECT CONCAT(123, CONCAT(_gbk'高斯DB')) result, pg_collation_for(result);
SELECT CONCAT(CONCAT(_gbk'高斯DB'), DATE '2023-05-01') result, pg_collation_for(result);
SELECT CONCAT(DATE '2023-05-01', CONCAT(_gbk'高斯DB')) result, pg_collation_for(result);
SELECT CONCAT(CONCAT(_gbk'高斯DB'), NULL) result, pg_collation_for(result);
SELECT CONCAT(NULL, CONCAT(_gbk'高斯DB')) result, pg_collation_for(result);
-- -- -- CONCAT NUMBERS
...
SELECT CONCAT(futf8_uni, trim('1.2.3')) result, pg_collation_for(result) FROM t_diff_charset_columns;
SELECT CONCAT(trim('1.2.3'), futf8_uni) result, pg_collation_for(result) FROM t_diff_charset_columns;
...
SELECT CONCAT(fgbk_chi, trim('1.2.3')) result, pg_collation_for(result) FROM t_diff_charset_columns;
SELECT CONCAT(trim('1.2.3'), fgbk_bin) result, pg_collation_for(result) FROM t_diff_charset_columns;
SELECT CONCAT(fgbk_chi, '高斯DB') result, pg_collation_for(result) FROM t_diff_charset_columns;
SELECT CONCAT('高斯DB', fgbk_bin) result, pg_collation_for(result) FROM t_diff_charset_columns;
...
-- -- -- -- conflict
SELECT CASE _gb18030'高斯' WHEN fgbk_bin THEN (fgbk_bin) ELSE (futf8_bin) END result, pg_collation_for(result) FROM t_diff_charset_columns; -- ERROR
-- -- in
-- -- -- column utf8
EXPLAIN (costs off)
...
-- -- -- for string function
SELECT CONCAT(_utf8mb4'高斯DB' COLLATE utf8mb4_unicode_ci , _gbk'高斯DB' COLLATE gbk_chinese_ci) COLLATE utf8mb4_general_ci result, pg_collation_for(result);
SELECT CONCAT(_utf8mb4'高斯DB' COLLATE utf8mb4_unicode_ci , _gbk'高斯DB' COLLATE gbk_chinese_ci) COLLATE gbk_chinese_ci result, pg_collation_for(result); -- ERROR
SELECT CONCAT(_utf8mb4'高斯DB' , _gbk'高斯DB') COLLATE utf8mb4_bin result, pg_collation_for(result);
SELECT CONCAT(_utf8mb4'高斯DB' , _gbk'高斯DB') COLLATE gbk_chinese_ci result, pg_collation_for(result); -- ERROR
SELECT CONCAT(_utf8mb4'高斯DB' , _gbk'高斯DB') COLLATE "binary" result, pg_collation_for(result); -- ERROR
...
SELECT CONCAT(_utf8mb4'高斯DB', _binary'高斯DB') COLLATE "binary" result; -- ERROR
SELECT CONCAT(_utf8mb4'高斯DB', _binary'高斯DB') COLLATE utf8mb4_unicode_ci result;
SELECT CONCAT(futf8_uni, fbin) COLLATE "binary" result FROM t_diff_charset_columns; -- ERROR
SELECT CONCAT(futf8_uni, fbin) COLLATE gbk_chinese_ci result FROM t_diff_charset_columns; -- ERROR
...
INSERT INTO t_charset_utf8mb4(a,b) VALUES(_gbk'高斯DB', (_gbk'高斯DB')::varbinary(16));
INSERT INTO t_charset_utf8mb4(a,b) VALUES(_gbk'高斯DB' COLLATE 'gbk_chinese_ci',
    (_gbk'高斯DB' COLLATE 'gbk_chinese_ci')::varbinary(16));
INSERT INTO t_charset_utf8mb4 SELECT 6,_gbk'高斯DB', (_gbk'高斯DB')::varbinary(16);
...
UPDATE t_charset_utf8mb4 SET a=_gbk'高斯DB', b=(_gbk'高斯DB')::varbinary(16)
	WHERE a='楂樻柉';
UPDATE t_charset_utf8mb4 SET a=_utf8mb4'高斯DB', b=(_utf8mb4'高斯DB')::varbinary(16)
	WHERE a=_gbk'高斯DB';
SELECT * FROM t_charset_utf8mb4 ORDER BY id;

DELETE FROM t_charset_utf8mb4 WHERE a=_utf8mb4'高斯';
DELETE FROM t_charset_utf8mb4 WHERE a::varbinary(16)=_binary'高斯DB';
SELECT * FROM t_charset_utf8mb4 ORDER BY id;
-- -- -- -- test assign expr
INSERT INTO t_charset_utf8mb4(a,b) VALUES(CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16));
INSERT INTO t_charset_utf8mb4 SELECT 0, CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16);
SELECT * FROM t_charset_utf8mb4 ORDER BY id;
INSERT INTO t_charset_utf8mb4(id,a,b) VALUES(7, CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16)) ON DUPLICATE KEY UPDATE a=CONCAT('高斯','db');
SELECT * FROM t_charset_utf8mb4 ORDER BY id;
UPDATE t_charset_utf8mb4 SET a=CONCAT('DB','高斯'), b=(CONCAT('DB','高斯'))::varbinary(16)
...
INSERT INTO t_charset_gbk(a,b) VALUES(_gbk'高斯DB', (_gbk'高斯DB')::varbinary(16));
INSERT INTO t_charset_gbk(a,b) VALUES(_gbk'高斯DB' COLLATE 'gbk_chinese_ci',
    (_gbk'高斯DB' COLLATE 'gbk_chinese_ci')::varbinary(16));
INSERT INTO t_charset_gbk(a,b) VALUES('楂樻柉', '楂樻柉');
INSERT INTO t_charset_gbk SELECT 6,_gbk'高斯DB', (_gbk'高斯DB')::varbinary(16);
-- -- -- -- test deparse for explain and select into
EXPLAIN (costs off)
...
UPDATE t_charset_gbk SET a='高斯DB', b='高斯DB'
	WHERE a=_gbk'高斯DB' COLLATE 'gbk_chinese_ci';
UPDATE t_charset_gbk SET a=_gbk'高斯DB', b=(_gbk'高斯DB')::varbinary(16)
	WHERE a='楂樻柉';
UPDATE t_charset_gbk SET a=_utf8mb4'高斯DB', b=(_utf8mb4'高斯DB')::varbinary(16)
	WHERE a=_gbk'高斯DB';
SELECT * FROM t_charset_gbk ORDER BY id;

DELETE FROM t_charset_gbk WHERE a=_utf8mb4'高斯';
DELETE FROM t_charset_gbk WHERE a::varbinary(16)=_binary'高斯DB'; -- DELETE 0
DELETE FROM t_charset_gbk WHERE a::varbinary(16)= E'\\xB8DFCBB94442'::varbinary(16);
SELECT * FROM t_charset_gbk ORDER BY id;
-- -- -- -- test assign expr
INSERT INTO t_charset_gbk(a,b) VALUES(CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16));
INSERT INTO t_charset_gbk SELECT 0, CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16);
SELECT * FROM t_charset_gbk ORDER BY id;
INSERT INTO t_charset_gbk(id,a,b) VALUES(7, CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16)) ON DUPLICATE KEY UPDATE a=CONCAT('高斯','db');
SELECT * FROM t_charset_gbk ORDER BY id;
UPDATE t_charset_gbk SET a=CONCAT('DB','高斯'), b=(CONCAT('DB','高斯'))::varbinary(16)
	WHERE a=CONCAT('高斯','DB');
SELECT * FROM t_charset_gbk ORDER BY id;
DROP TABLE IF EXISTS t_charset_gbk;
...
INSERT INTO t_charset_utf8mb4(a,b) VALUES('高斯DB', '高斯DB');
INSERT INTO t_charset_utf8mb4(a,b) VALUES(_utf8mb4'高斯DB', (_utf8mb4'高斯DB')::varbinary(16));
INSERT INTO t_charset_utf8mb4(a,b) VALUES(_utf8mb4'高斯DB' COLLATE 'utf8mb4_unicode_ci',
    (_utf8mb4'高斯DB' COLLATE 'utf8mb4_unicode_ci')::varbinary(16));
INSERT INTO t_charset_utf8mb4 SELECT 6,_utf8mb4'高斯DB', (_utf8mb4'高斯DB')::varbinary(16);
...
INSERT INTO t_charset_gbk(a,b) VALUES('高斯', '高斯');
INSERT INTO t_charset_gbk(a,b) VALUES('高斯DB', '高斯DB');
INSERT INTO t_charset_gbk(a,b) VALUES(_utf8mb4'高斯DB', (_utf8mb4'高斯DB')::varbinary(16));
...
INSERT INTO t_charset_gbk SELECT 6,_utf8mb4'高斯DB', (_utf8mb4'高斯DB')::varbinary(16);
-- -- -- -- test deparse for explain and select into
EXPLAIN (costs off)
...
DELETE FROM t_charset_gbk WHERE a::varbinary(16)= _binary'高斯DB';
SELECT * FROM t_charset_gbk ORDER BY id;
-- -- -- -- test assign expr
INSERT INTO t_charset_gbk(a,b) VALUES(CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16));
INSERT INTO t_charset_gbk SELECT 0, CONCAT('高斯','DB'), (CONCAT('高斯','DB'))::varbinary(16);
