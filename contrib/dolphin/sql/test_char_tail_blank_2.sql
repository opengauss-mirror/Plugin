drop database if exists b_char_blank_test_2;
create database b_char_blank_test_2 encoding 'UTF-8' lc_collate 'en_US.UTF-8' lc_ctype 'en_US.UTF-8' dbcompatibility 'B';
\c b_char_blank_test_2
...
drop table t_char2;
\c postgres
drop database b_char_blank_test_2;