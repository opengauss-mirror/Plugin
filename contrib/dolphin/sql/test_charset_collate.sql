...
create index index1 on test_type_table(`binary`);
create index index2 on test_type_table(`varbinary`);
create index index3 on test_type_table(`tinyblob`);
create index index4 on test_type_table(`blob`);
create index index5 on test_type_table(`mediumblob`);
create index index6 on test_type_table(`longblob`);
