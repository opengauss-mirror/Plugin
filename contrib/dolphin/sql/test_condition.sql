...
----------------GS_INTERVAL expression------------------------
select gs_interval(null);
select gs_interval(null, 123);
select gs_interval(null, 123.45);
select gs_interval(123,null);
select gs_interval(123,null,17,43.123);
select gs_interval(123.213,null,17,43.123);
select gs_interval(100, '10e2');
select gs_interval(100, '   10e1');
select gs_interval(100, '   10e1', '      10Eeasd');
select gs_interval(10e3, '   10e1', '      10E1easd    ', '2e10');
select gs_interval(0, '   wa');
select gs_interval(0, '   wa', '  e1212');
select gs_interval(0, '   abiusdhiw');
select gs_interval(0, '   abiusdhiw', '   kqiwjoiqh  ');
select gs_interval(0, '   1e12abiusdhiw');
select gs_interval(0, '   e13fsdsda');
select gs_interval(0, '1e13fsdsda');
select gs_interval(100, '1e1fsdsda');
select gs_interval('+12', 121);
select gs_interval('+12', 12);
select gs_interval('+12', 0);
select gs_interval('-12', 0);
select gs_interval('-12.2', 0);
select gs_interval('-.2', 0);
select gs_interval('-.2', -100);
select gs_interval('-.2E2', -100);
select gs_interval('-.2E4', -100);
select gs_interval('..', 21);
select gs_interval('.21.', 21);
select gs_interval('.21.', 0);
select gs_interval('+.21.', 0);
select gs_interval('-.21.', 0);
select gs_interval('-.21.', -1);
select gs_interval('-..21.', -1);
select gs_interval('...', -1);
select gs_interval('...', -1);


select gs_interval(123::int2,null);
select gs_interval(123::int4,null);
select gs_interval(123::int8,null);
select gs_interval(123,123.23);
select gs_interval(123,123.23::int);

select gs_interval(null, '2001-01-01 01:01:01.3654'::date);
select gs_interval('2001-01-01 01:01:01.3654'::date, null);
select gs_interval('2001-01-01 01:01:01.3654'::date, '2001-01-01 01:01:01.3654'::date);
select gs_interval('2001-01-01 01:01:01.3654'::date, '1999-01-01 01:01:01.3654'::date);
select gs_interval('2022-12-12'::timestamp,123);
select gs_interval('2022-12-12'::timestamp,'2022-12-12'::timestamp);
select gs_interval(123,'2022-12-12'::timestamp);
select gs_interval(1,' ');
select gs_interval(b'1',' ');
select gs_interval('a',' ');
select gs_interval(false,' ');
select gs_interval(' ',true);
select gs_interval(' ',b'1');
select gs_interval(' ','a');
select gs_interval(' ',12);

select gs_interval(t1, t2) from test_bccf;
select gs_interval(t2, t1) from test_bccf;
...
select gs_interval(tyint, smint) from typeset;
select gs_interval(tyint, anint) from typeset;
select gs_interval(tyint, bgint) from typeset;
select gs_interval(tyint, dcmal) from typeset;
select gs_interval(tyint, nmric) from typeset;
select gs_interval(tyint, flt) from typeset;
select gs_interval(tyint, bt) from typeset;
select gs_interval(tyint, dt) from typeset;
select gs_interval(tyint, tmstp) from typeset;
select gs_interval(tyint, tm) from typeset;
select gs_interval(tyint, ch) from typeset;
select gs_interval(tyint, vch) from typeset;
select gs_interval(tyint, blb) from typeset;
select gs_interval(tyint, txt) from typeset;
select gs_interval(smint, anint) from typeset;
select gs_interval(smint, bgint) from typeset;
select gs_interval(smint, dcmal) from typeset;
select gs_interval(smint, nmric) from typeset;
select gs_interval(smint, flt) from typeset;
select gs_interval(smint, bt) from typeset;
select gs_interval(smint, dt) from typeset;
select gs_interval(smint, tmstp) from typeset;
select gs_interval(smint, tm) from typeset;
select gs_interval(smint, ch) from typeset;
select gs_interval(smint, vch) from typeset;
select gs_interval(smint, blb) from typeset;
select gs_interval(smint, txt) from typeset;
select gs_interval(anint, bgint) from typeset;
select gs_interval(anint, dcmal) from typeset;
select gs_interval(anint, nmric) from typeset;
select gs_interval(anint, flt) from typeset;
select gs_interval(anint, bt) from typeset;
select gs_interval(anint, dt) from typeset;
select gs_interval(anint, tmstp) from typeset;
select gs_interval(anint, tm) from typeset;
select gs_interval(anint, ch) from typeset;
select gs_interval(anint, vch) from typeset;
select gs_interval(anint, blb) from typeset;
select gs_interval(anint, txt) from typeset;
select gs_interval(bgint, dcmal) from typeset;
select gs_interval(bgint, nmric) from typeset;
select gs_interval(bgint, flt) from typeset;
select gs_interval(bgint, bt) from typeset;
select gs_interval(bgint, dt) from typeset;
select gs_interval(bgint, tmstp) from typeset;
select gs_interval(bgint, tm) from typeset;
select gs_interval(bgint, ch) from typeset;
select gs_interval(bgint, vch) from typeset;
select gs_interval(bgint, blb) from typeset;
select gs_interval(bgint, txt) from typeset;
select gs_interval(dcmal, nmric) from typeset;
select gs_interval(dcmal, flt) from typeset;
select gs_interval(dcmal, bt) from typeset;
select gs_interval(dcmal, dt) from typeset;
select gs_interval(dcmal, tmstp) from typeset;
select gs_interval(dcmal, tm) from typeset;
select gs_interval(dcmal, ch) from typeset;
select gs_interval(dcmal, vch) from typeset;
select gs_interval(dcmal, blb) from typeset;
select gs_interval(dcmal, txt) from typeset;
select gs_interval(nmric, flt) from typeset;
select gs_interval(nmric, bt) from typeset;
select gs_interval(nmric, dt) from typeset;
select gs_interval(nmric, tmstp) from typeset;
select gs_interval(nmric, tm) from typeset;
select gs_interval(nmric, ch) from typeset;
select gs_interval(nmric, vch) from typeset;
select gs_interval(nmric, blb) from typeset;
select gs_interval(nmric, txt) from typeset;
select gs_interval(flt, bt) from typeset;
select gs_interval(flt, dt) from typeset;
select gs_interval(flt, tmstp) from typeset;
select gs_interval(flt, tm) from typeset;
select gs_interval(flt, ch) from typeset;
select gs_interval(flt, vch) from typeset;
select gs_interval(flt, blb) from typeset;
select gs_interval(flt, txt) from typeset;
select gs_interval(bt, dt) from typeset;
select gs_interval(bt, tmstp) from typeset;
select gs_interval(bt, tm) from typeset;
select gs_interval(bt, ch) from typeset;
select gs_interval(bt, vch) from typeset;
select gs_interval(bt, blb) from typeset;
select gs_interval(bt, txt) from typeset;
select gs_interval(dt, tmstp) from typeset;
select gs_interval(dt, tm) from typeset;
select gs_interval(dt, ch) from typeset;
select gs_interval(dt, vch) from typeset;
select gs_interval(dt, blb) from typeset;
select gs_interval(dt, txt) from typeset;
select gs_interval(tmstp, tm) from typeset;
select gs_interval(tmstp, ch) from typeset;
select gs_interval(tmstp, vch) from typeset;
select gs_interval(tmstp, blb) from typeset;
select gs_interval(tmstp, txt) from typeset;
select gs_interval(tm, ch) from typeset;
select gs_interval(tm, vch) from typeset;
select gs_interval(tm, blb) from typeset;
select gs_interval(tm, txt) from typeset;
select gs_interval(ch, vch) from typeset;
select gs_interval(ch, blb) from typeset;
select gs_interval(ch, txt) from typeset;
select gs_interval(vch, blb) from typeset;
select gs_interval(vch, txt) from typeset;
select gs_interval(blb, txt) from typeset;
