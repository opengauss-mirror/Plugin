...
show default_week_format;
insert into test values('week(''2000-1-1'')', week('2000-1-1'));
alter system set default_week_format = 3;
select pg_sleep(1);
show default_week_format;
insert into test values('week(''2000-1-1'')', week('2000-1-1'));
alter system set default_week_format = 4;
select pg_sleep(1);
show default_week_format;
insert into test values('week(''2000-1-1'')', week('2000-1-1'));
alter system set default_week_format = 5;
select pg_sleep(1);
show default_week_format;
insert into test values('week(''2000-1-1'')', week('2000-1-1'));
alter system set default_week_format = 6;
select pg_sleep(1);
show default_week_format;
insert into test values('week(''2000-1-1'')', week('2000-1-1'));
alter system set default_week_format = 7;
select pg_sleep(1);
show default_week_format;
insert into test values('week(''2000-1-1'')', week('2000-1-1'));
-- 单参数-边界
