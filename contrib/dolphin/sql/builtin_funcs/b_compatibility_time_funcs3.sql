...
begin
a := '4714-11-24 00:00:00+08';
b := '4714-11-24 00:00:00';
c := '11:11:11+08';
d := '11:11:11';
raise notice 'RESULT COL :%t', a;
raise notice 'RESULT COL :%t', b;
raise notice 'RESULT COL :%t', c;
raise notice 'RESULT COL :%t', d;
end;
/
...
set timezone = 'PRC';
SELECT unix_timestamp('2000-12-30 23:59:59-08:00') ;
SELECT unix_timestamp('2000-12-30 23:59:59') ;
SELECT unix_timestamp('2000-12-30 23:59:59+08:00') ;
SELECT to_seconds('2000-12-30 23:59:59-08:00') ;
SELECT to_seconds('2000-12-30 23:59:59') ;
SELECT to_seconds('2000-12-30 23:59:59+08:00') ;
SELECT to_seconds('2000-12-30 23:59:59+00:00') ;
set timezone = 'UTC';
SELECT unix_timestamp('2000-12-30 23:59:59-08:00') ;
SELECT unix_timestamp('2000-12-30 23:59:59') ;
SELECT unix_timestamp('2000-12-30 23:59:59+08:00') ;
