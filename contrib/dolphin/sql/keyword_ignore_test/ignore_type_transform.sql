...
insert into t values(-100);
insert ignore into t values(10000);
insert ignore into t values(-10000);
insert ignore into t values(100);
insert ignore into t values(-100);
select * from t;
update ignore t set num = 100000 where num = 100;
select * from t;
...
create table t_numeric(num numeric(1000,100));
insert into t_numeric values (38764378634891278678324089237898634298778923472389687.123874);
insert into t_numeric values (-38764378634891278678324089237898634298778923472389687.123874);
insert ignore into t_tinyint select num from t_numeric;
...
insert into t values(10000);
insert into t values(-10000);
insert ignore into t values(100000);
insert ignore into t values(-100000);
insert ignore into t values(10000);
insert ignore into t values(-10000);
insert ignore into t values((-32769)::numeric);
insert ignore into t values((-32768)::float4);
insert ignore into t values((-32769)::float4);
insert ignore into t values((-32768)::float8);
insert ignore into t values((-32769)::float8);
select * from t;
update ignore t set num = 1000000 where num = 10000;
select * from t;
...
insert into t_numeric values (38764378634891278678324089237898634298778923472389687.123874);
insert into t_numeric values (-38764378634891278678324089237898634298778923472389687.123874);
insert into t_numeric values(32768);
insert into t_numeric values(-32769);
insert ignore into t_smallint select num from t_numeric;
...
insert into t values(-1000000);
insert ignore into t values(10000000000);
insert ignore into t values(-10000000000);
insert ignore into t values(1000000);
insert ignore into t values(-1000000);
select * from t;
update ignore t set num = 99999999999999999999 where num = 1000000;
select * from t;
...
insert into t_numeric values (38764378634891278678324089237898634298778923472389687.123874);
insert into t_numeric values (-38764378634891278678324089237898634298778923472389687.123874);
insert ignore into t_int select num from t_numeric;
select * from t_int;
...
insert into t values(-10000000::numeric);
insert ignore into t values(847329847839274398574389574398579834759384504385094386073456058984);
insert ignore into t values(-439058439498375898437567893745893275984375984375984375984345498759438);
insert ignore into t values(10000000::numeric);
insert ignore into t values(-10000000::numeric);
select * from t;
update ignore t set num = 99999999999999999999999999999999999999999999999999999999999999999999999999 where num = 10000000;
select * from t;
...
insert into t_numeric values (38764378634891278678324089237898634298778923472389687.123874);
insert into t_numeric values (-38764378634891278678324089237898634298778923472389687.123874);
insert ignore into t_bigint select num from t_numeric;
...
insert into t_int values(-10000);
insert ignore into t_tinyint select num from t_int;
select * from t_tinyint;
...
insert into t_int values(-1000000);
insert ignore into t_smallint select num from t_int;
select * from t_smallint;
...
insert into t_tinyint values (-123.023::float4);
insert ignore into t_tinyint values (10000.023::float4);
insert ignore into t_tinyint values (-10000.023::float4);
insert ignore into t_tinyint values (123.023::float4);
insert ignore into t_tinyint values (-123.023::float4);
select * from t_tinyint;
...
insert into t_smallint values (-10000.023::float4);
insert ignore into t_smallint values (1000000.023::float4);
insert ignore into t_smallint values (-1000000.023::float4);
insert ignore into t_smallint values (10000.023::float4);
insert ignore into t_smallint values (-10000.023::float4);
select * from t_smallint;
...
insert into t_int values (-123123.023::float4);
insert ignore into t_int values (72348787598743985743895.023::float4);
insert ignore into t_int values (-72348787598743985743895.023::float4);
insert ignore into t_int values (123123.023::float4);
insert ignore into t_int values (-123123.023::float4);
select * from t_int;
...
insert into t_bigint values (-100000.023::float4);
insert ignore into t_bigint values (238947289573489758943455436587549686.023::float4);
insert ignore into t_bigint values (-238947289573489758943455436587549686.023::float4);
insert ignore into t_bigint values (100000.023::float4);
insert ignore into t_bigint values (-100000.023::float4);
select * from t_bigint;
...
insert into t_tinyint values (-100.123::float8);
insert ignore into t_tinyint values (238947289573489758943455436587549686.023::float8);
insert ignore into t_tinyint values (-238947289573489758943455436587549686.023::float8);
insert ignore into t_tinyint values (100.123::float8);
insert ignore into t_tinyint values (-100.123::float8);
select * from t_tinyint;
...
insert into t_smallint values (-100.023::float8);
insert ignore into t_smallint values (238947289573489758943455436587549686.023::float8);
insert ignore into t_smallint values (-238947289573489758943455436587549686.023::float8);
insert ignore into t_smallint values (100.023::float8);
insert ignore into t_smallint values (-100.023::float8);
select * from t_smallint;
...
insert into t_int values (-123.023::float8);
insert ignore into t_int values (23894728957345798437986755479865476509486804965449876953489758943455436587549686.023::float8);
insert ignore into t_int values (-23894728957345798437986755479865476509486804965449876953489758943455436587549686.023::float8);
insert ignore into t_int values (123.023::float8);
insert ignore into t_int values (-123.023::float8);
select * from t_int;
...
insert into t_bigint values (-123.123::float8);
insert ignore into t_bigint values (238947289573457984379867554798658438574983768504985454690874578759765898798798709854353476509486804965449876953489758943455436587549686.023::float8);
insert ignore into t_bigint values (-238947289573457984379867554798658438574983768504985454690874578759765898798798709854353476509486804965449876953489758943455436587549686.023::float8);
insert ignore into t_bigint values (123.123::float8);
insert ignore into t_bigint values (-123.123::float8);
select * from t_bigint;
...
insert into t_float4 values(-123.123::float8);
insert ignore into t_float4 values (.::float8);
insert ignore into t_float4 values (-.::float8);
insert ignore into t_float4 values(123.123::float8);
insert ignore into t_float4 values(-123.123::float8);
...
insert into t_numeric values(-.);
insert ignore into t_float4 select num from t_numeric;
select * from t_float4;
...
insert ignore into t_char select cont from t_text;
select * from t_char;
...
insert into t_text values('abcdefghj');
insert into t_text values(123456789123456789);
insert ignore into t_varchar select cont from t_text;
...
insert into t_text values('abcdefghj');
insert into t_text values(123456789123456789);
insert ignore into t_character select cont from t_text;
...
insert into t_text values('abcdefghj');
insert into t_text values(123456789123456789);
insert ignore into t_nchar select cont from t_text;
select * from t_nchar;
...
insert into t_text values('abcdefghj');
insert into t_text values(123456789123456789);
insert ignore into t_varchar2 select cont from t_text;
