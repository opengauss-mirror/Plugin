drop schema if exists multi_type_bitwise_and_test_schema cascade;
create schema multi_type_bitwise_and_test_schema;
set current_schema to 'multi_type_bitwise_and_test_schema';
---------- head ----------
...
INSERT INTO TEST SELECT `int1` & `uint1` FROM test_multi_type_table;
INSERT INTO TEST SELECT `int2` & `uint2` FROM test_multi_type_table;
INSERT INTO TEST SELECT `int4` & `uint4` FROM test_multi_type_table;
INSERT INTO TEST SELECT `int8` & `uint8` FROM test_multi_type_table;
INSERT INTO TEST SELECT `float4` & `float8` FROM test_multi_type_table;
INSERT INTO TEST SELECT `numeric` & `bit1` FROM test_multi_type_table;
INSERT INTO TEST SELECT `bit64` & `boolean` FROM test_multi_type_table;
INSERT INTO TEST SELECT `char` & `int1` FROM test_multi_type_table;
INSERT INTO TEST SELECT `varchar` & `int1` FROM test_multi_type_table;
INSERT INTO TEST SELECT `binary` & `int1` FROM test_multi_type_table;
INSERT INTO TEST SELECT `varbinary` & `int1` FROM test_multi_type_table;
INSERT INTO TEST SELECT `text` & `text` FROM test_multi_type_table;

-- strict insert ignore
INSERT IGNORE INTO TEST SELECT `int1` & `uint1` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `int2` & `uint2` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `int4` & `uint4` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `int8` & `uint8` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `float4` & `float8` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `numeric` & `bit1` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `bit64` & `boolean` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `char` & `varchar` FROM test_multi_type_table;
INSERT IGNORE INTO TEST SELECT `text` & `text` FROM test_multi_type_table;

---------- tail ----------
drop schema multi_type_bitwise_and_test_schema cascade;
