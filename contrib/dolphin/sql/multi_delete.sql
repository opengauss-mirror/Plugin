create schema multidelete;
set current_schema to multidelete;
-- three relation
...
create table multidelete.delete_2(a int);
insert into delete_2 values(1),(1),(2),(2);
select * from delete_2;
delete multidelete.t.* from delete_2 t where a = 1;    -- mysql is error, can't recognize t is alias
select * from delete_2;
