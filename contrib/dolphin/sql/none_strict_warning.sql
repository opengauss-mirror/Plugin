...
CREATE TABLE test(wtg_id BIGINT, datatime_utc date, powercurve_valid_cond INTEGER, PRIMARY KEY (wtg_id,datatime_utc));
insert into test(wtg_id, datatime_utc) select 430000007, '2025-01-01 00:00:00';
-- warning
insert ignore into test(wtg_id, datatime_utc) select 430000007, '2025-01-01 00:00:00';
select * from test;
CREATE TABLE test1(wtg_id BIGINT, datatime_utc date, powercurve_valid_cond INTEGER);
insert into test1 values (430000007,  '2025-01-01 00:00:00', 1);
insert into test1 values (430000008,  '2025-01-01 00:00:00', 1);
-- 1 warning 1 insert
insert ignore into test(wtg_id, datatime_utc) select wtg_id,datatime_utc from test1;
select * from test;

insert into test1 values (430000009,  '2025-01-01 00:00:00', 1);
-- 2 warning 1 insert
insert ignore into test(wtg_id, datatime_utc) select wtg_id,datatime_utc from test1;
select * from test;
...
insert into test1 values (430000007,  '2025-01-01 00:00:00', 1),(430000007,  '2025-01-01 00:00:00', 1);
insert ignore into test select * from test1;
select * from test;
