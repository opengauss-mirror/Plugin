...
static FieldType field_types_merge_rules[FIELD_TYPE_NUM][FIELD_TYPE_NUM] = {
    ...
    //FIELD_TYPE_NULL         FIELD_TYPE_TIMESTAMP
    FIELD_TYPE_DECIMAL,  FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_LONGLONG     FIELD_TYPE_INT16
    FIELD_TYPE_DECIMAL,     FIELD_TYPE_DECIMAL,
    //FIELD_TYPE_DATE         FIELD_TYPE_TIME
    ...
    FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_SET          FIELD_TYPE_TINY_BLOB
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_TINY_BLOB,
    //FIELD_TYPE_MEDIUM_BLOB  FIELD_TYPE_LONG_BLOB
    FIELD_TYPE_MEDIUM_BLOB, FIELD_TYPE_LONG_BLOB,
    //FIELD_TYPE_BLOB         FIELD_TYPE_VAR_STRING
    ...
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    FIELD_TYPE_DECIMAL,  FIELD_TYPE_SHORT,
    //FIELD_TYPE_SHORT        FIELD_TYPE_LONG
    FIELD_TYPE_SHORT,       FIELD_TYPE_LONG,
    //FIELD_TYPE_FLOAT        FIELD_TYPE_DOUBLE
    FIELD_TYPE_FLOAT,       FIELD_TYPE_DOUBLE,
    ...
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    FIELD_TYPE_DECIMAL,  FIELD_TYPE_LONG,
    //FIELD_TYPE_SHORT        FIELD_TYPE_LONG
    ...
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    FIELD_TYPE_DOUBLE,      FIELD_TYPE_FLOAT,
    //FIELD_TYPE_SHORT        FIELD_TYPE_LONG
    FIELD_TYPE_FLOAT,       FIELD_TYPE_DOUBLE,
    //FIELD_TYPE_FLOAT        FIELD_TYPE_DOUBLE
    FIELD_TYPE_FLOAT,       FIELD_TYPE_DOUBLE,
    //FIELD_TYPE_NULL         FIELD_TYPE_TIMESTAMP
    FIELD_TYPE_FLOAT,       FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_LONGLONG     FIELD_TYPE_INT16
    FIELD_TYPE_FLOAT,       FIELD_TYPE_FLOAT,
    //FIELD_TYPE_DATE         FIELD_TYPE_TIME
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_DATETIME     FIELD_TYPE_YEAR
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_FLOAT,
    //FIELD_TYPE_VARCHAR
    FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_BIT
    FIELD_TYPE_DOUBLE,
    ...
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    FIELD_TYPE_DECIMAL,  FIELD_TYPE_LONGLONG,
    //FIELD_TYPE_SHORT        FIELD_TYPE_LONG
    ...
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    FIELD_TYPE_DECIMAL,     FIELD_TYPE_INT16,
    //FIELD_TYPE_SHORT        FIELD_TYPE_LONG
    FIELD_TYPE_INT16,       FIELD_TYPE_INT16,
    //FIELD_TYPE_FLOAT        FIELD_TYPE_DOUBLE
    FIELD_TYPE_FLOAT,       FIELD_TYPE_DOUBLE,
    //FIELD_TYPE_NULL         FIELD_TYPE_TIMESTAMP
    FIELD_TYPE_INT16,       FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_LONGLONG     FIELD_TYPE_INT16
    FIELD_TYPE_INT16,       FIELD_TYPE_INT16,
    //FIELD_TYPE_DATE         FIELD_TYPE_TIME
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_DATETIME     FIELD_TYPE_YEAR
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_INT16,
    //FIELD_TYPE_VARCHAR
    FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_BIT
    FIELD_TYPE_DECIMAL,
    ...
    FIELD_TYPE_BLOB,        FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_STRING     FIELD_TYPE_BIN_STRING
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_BIN_STRING
    },
    /* FIELD_TYPE_BIT -> */
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    ...
    FIELD_TYPE_DOUBLE,      FIELD_TYPE_DOUBLE,
    //FIELD_TYPE_NULL         FIELD_TYPE_TIMESTAMP
    FIELD_TYPE_BIT,         FIELD_TYPE_BLOB,
    //FIELD_TYPE_LONGLONG     FIELD_TYPE_INT16
    FIELD_TYPE_DECIMAL,     FIELD_TYPE_DECIMAL,
    //FIELD_TYPE_DATE         FIELD_TYPE_TIME
    FIELD_TYPE_BLOB,        FIELD_TYPE_BLOB,
    //FIELD_TYPE_DATETIME     FIELD_TYPE_YEAR
    FIELD_TYPE_BLOB,        FIELD_TYPE_LONG,
    //FIELD_TYPE_VARCHAR
    FIELD_TYPE_BLOB,
    //FIELD_TYPE_BIT
    FIELD_TYPE_LONG,
    ...
    FIELD_TYPE_BLOB,          FIELD_TYPE_BLOB,
    //FIELD_TYPE_STRING     FIELD_TYPE_BIN_STRING
    FIELD_TYPE_BLOB,        FIELD_TYPE_BIN_STRING
    },
    /* FIELD_TYPE_JSON -> */
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    ...
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_NULL         FIELD_TYPE_TIMESTAMP
    FIELD_TYPE_JSON,        FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_LONGLONG     FIELD_TYPE_INT16
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_DATE         FIELD_TYPE_TIME
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_VARCHAR,
    ...
    FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_SET          FIELD_TYPE_TINY_BLOB
    FIELD_TYPE_VARCHAR,     FIELD_TYPE_LONG_BLOB,
    //FIELD_TYPE_MEDIUM_BLOB  FIELD_TYPE_LONG_BLOB
    FIELD_TYPE_LONG_BLOB,   FIELD_TYPE_LONG_BLOB,
    //FIELD_TYPE_BLOB         FIELD_TYPE_VAR_STRING
    FIELD_TYPE_LONG_BLOB,   FIELD_TYPE_VARCHAR,
    //FIELD_TYPE_STRING     FIELD_TYPE_BIN_STRING
    FIELD_TYPE_STRING,      FIELD_TYPE_LONG_BLOB
    },
    /* FIELD_TYPE_ENUM -> */
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    ...
    FIELD_TYPE_MEDIUM_BLOB, FIELD_TYPE_LONG_BLOB,
    //FIELD_TYPE_BLOB         FIELD_TYPE_VAR_STRING
    FIELD_TYPE_BLOB,        FIELD_TYPE_TINY_BLOB,
    //FIELD_TYPE_STRING     FIELD_TYPE_BIN_STRING
    ...
    FIELD_TYPE_STRING,
    //FIELD_TYPE_SET          FIELD_TYPE_TINY_BLOB
    FIELD_TYPE_STRING,      FIELD_TYPE_TINY_BLOB,
    //FIELD_TYPE_MEDIUM_BLOB  FIELD_TYPE_LONG_BLOB
    FIELD_TYPE_MEDIUM_BLOB, FIELD_TYPE_LONG_BLOB,
    //FIELD_TYPE_BLOB         FIELD_TYPE_VAR_STRING
    FIELD_TYPE_BLOB,        FIELD_TYPE_VARCHAR,
    ...
    /* FIELD_TYPE_BIN_STRING -> */
    {
    //FIELD_TYPE_DECIMAL      FIELD_TYPE_TINY
    FIELD_TYPE_BIN_STRING,    FIELD_TYPE_BIN_STRING,
    //FIELD_TYPE_SHORT        FIELD_TYPE_LONG
    FIELD_TYPE_BIN_STRING,    FIELD_TYPE_BIN_STRING,
    //FIELD_TYPE_FLOAT        FIELD_TYPE_DOUBLE
    FIELD_TYPE_BIN_STRING,    FIELD_TYPE_BIN_STRING,
    ...
    FIELD_TYPE_BLOB,        FIELD_TYPE_BIN_STRING,
    //FIELD_TYPE_STRING     FIELD_TYPE_BIN_STRING
    FIELD_TYPE_LONG_BLOB,    FIELD_TYPE_BIN_STRING
    }
};

/* convert openGauss type to MySQL field type */
static FieldType type_to_index(Oid oid)
{
    switch (oid) {
        case FLOAT4OID:
        ...
        case BOOLOID:
            return FIELD_TYPE_TINY; // treat bool as tinyint
        case INT1OID:
...
static FieldType agg_field_type(List *args)
{
    /* traverse all arg, and get the final result type */
    ListCell *cell = list_head(args);
    ...
    for (cell = lnext(cell); cell != NULL && res != FIELD_TYPE_INVALID; cell = lnext(cell)) {
        ...
        /* get the final field type based on the merge rules */
        res = field_types_merge_rules[res][arg_field_type];
    }
    ...
    *unsigned_flag = false;
    ...
    switch (oid) {
        ...
        default:
            ...
            /* other type are openGauss unique type, use original routine */
...
static CmpType get_cmp_type(CmpType a, Oid oid, bool *oid_is_unsigned, bool unsigned_flag)
{
    if (a == CMP_UNKNOWN_TYPE) {
        return CMP_UNKNOWN_TYPE;
    }

    CmpType b = map_oid_to_cmp_type(oid, oid_is_unsigned);
    if (b == CMP_UNKNOWN_TYPE) {
        return CMP_UNKNOWN_TYPE;
    }

    /* precedence: string -> real -> decimal -> int. if there are int and uint mixed use, return decimal too */
    if (a == CMP_STRING_TYPE || b == CMP_STRING_TYPE) {
        return CMP_STRING_TYPE;
    }
    if (a == CMP_REAL_TYPE || b == CMP_REAL_TYPE) {
        return CMP_REAL_TYPE;
    }
    if (a == CMP_DECIMAL_TYPE || b == CMP_DECIMAL_TYPE || *oid_is_unsigned != unsigned_flag) {
        return CMP_DECIMAL_TYPE;
    }
    return CMP_INT_TYPE;
}
...
/*
 * get the final result openGauss type based on the args, return InvalidOid if there are some openGauss unique type,
 * if this happen, we should goto openGauss original routinue.
 */
static Oid agg_result_type(List *args)
{
    ListCell* arg = NULL;
    CmpType result_type = CMP_STRING_TYPE;
    bool unsigned_flag = false;
    ...
    foreach (arg, args) {
        if (!IsA(arg, Const) || !((Const*)arg)->constisnull) {
            result_type = map_oid_to_cmp_type(exprType((Node*)lfirst(arg)), &unsigned_flag);
            has_unsigned = unsigned_flag;
            arg = lnext(arg);
            break;
        }
    }

    /* traverse all arg, get the final return type, skip null arg */
    for (; arg != NULL && result_type != CMP_UNKNOWN_TYPE; arg = lnext(arg)) {
        if (!IsA(arg, Const) || !((Const*)arg)->constisnull) {
            bool arg_is_unsigned = false;
            result_type = get_cmp_type(result_type, exprType((Node*)lfirst(arg)), &arg_is_unsigned, unsigned_flag);
            unsigned_flag = unsigned_flag && arg_is_unsigned;
            has_unsigned |= arg_is_unsigned;
        }
    }
...
static Oid cmptype_map_to_oid(List *args, CmpType result_type, bool has_unsigned)
{
    ...
    switch (result_type) {
        case CMP_UNKNOWN_TYPE:
            /* not mysql type, goto openGauss original routine */
            return InvalidOid;
        case CMP_STRING_TYPE: {
            /* result is string, need to handle binary and time type specially */
            switch (res) {
                case FIELD_TYPE_INVALID:
                    /* should not happen */
                    return InvalidOid;
                case FIELD_TYPE_TINY_BLOB:
                case FIELD_TYPE_BIN_STRING:
                    return VARBINARYOID;
                case FIELD_TYPE_BLOB:
                    return BLOBOID;
                case FIELD_TYPE_MEDIUM_BLOB:
                    return MEDIUMBLOBOID;
        ...
        case CMP_REAL_TYPE:
            return res == FIELD_TYPE_FLOAT ? FLOAT4OID : FLOAT8OID;
        case CMP_DECIMAL_TYPE:
            return NUMERICOID;
        case CMP_INT_TYPE: {
            switch (res) {
                case FIELD_TYPE_TINY:
                    return has_unsigned ? UINT1OID : INT1OID;
                case FIELD_TYPE_SHORT:
                    return has_unsigned ? UINT2OID : INT2OID;
                case FIELD_TYPE_LONG:
                    return has_unsigned ? UINT4OID : INT4OID;
                case FIELD_TYPE_LONGLONG:
                    return has_unsigned ? UINT8OID : INT8OID;
