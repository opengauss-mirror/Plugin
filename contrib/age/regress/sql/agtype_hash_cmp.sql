...
-- BEGIN/END array tokens must preserve raw-scalar state independently.
SELECT agtype_hash_cmp('[[[[1]]], [2, [3, [4]]]]'::agtype) =
       agtype_hash_cmp('[[[[1]]], [2, [3, [4]]]]'::agtype)
       AS nested_array_hash_stable;
SELECT agtype_hash_cmp('1'::agtype) <>
       agtype_hash_cmp('[1]'::agtype)
       AS raw_scalar_hash_distinct_from_array;
