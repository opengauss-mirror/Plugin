...
//
//	@doc:
//		Implementation of the methods for translating from DXL tree to SPQDB
//		PlannedStmt.
//
//	@test:
//
...
#include "spq_optimizer_util/translate/CIndexQualInfo.h"
...
#define SPQDXL_ROOT_PLAN_ID -1
#define SPQDXL_PLAN_ID_START 1
...
{
	m_translator_dxl_to_scalar = SPQOS_NEW(m_mp)
...
CTranslatorDXLToPlStmt::~CTranslatorDXLToPlStmt()
{
	SPQOS_DELETE(m_translator_dxl_to_scalar);
}

// TODO SPQ add for distribute maybe del in future
extern List* reassign_nodelist(RangeTblEntry* rte, List* ori_node_list);
void CTranslatorDXLToPlStmt::SetQuery(Query *query)
{
	orig_query = query;
}
static void add_distribute_info(Plan* scanPlan, List* scanClauses, RangeTblEntry *rte, Query *query, Index relIndex)
{
    ExecNodes* execNodes = NULL;
    char relkind = get_rel_relkind(rte->relid);
    char locator_type = GetLocatorType(rte->relid);
    Distribution* distribution = ng_get_baserel_data_distribution(rte->relid, relkind);
 
    if (is_sys_table(rte->relid) || RELKIND_IS_SEQUENCE(relkind)) {
        execNodes = ng_convert_to_exec_nodes(distribution, locator_type, RELATION_ACCESS_READ);
        ...
        if (GetLocatorType(rte->relid) == LOCATOR_TYPE_REPLICATED) {
            Assert(locator_type == LOCATOR_TYPE_REPLICATED);
            execNodes = ng_convert_to_exec_nodes(distribution, locator_type, RELATION_ACCESS_READ);
        } else {
            ...
            execNodes = GetRelationNodesByQuals(
                    (void*)query, rte->relid, relIndex, (Node*)quals, RELATION_ACCESS_READ, NULL, false);
    ...
    scanPlan->distributed_keys = build_baserel_distributekey(rte, rte->relid);
}
...
{
	for (ULONG idx = 0;
		 idx < SPQOS_ARRAY_SIZE(m_dxlop_translator_func_mapping_array); idx++)
	{
	...
	static const STranslatorMapping dxlop_translator_func_mapping_array[] = {
		{EdxlopPhysicalTableScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLTblScan},
		{EdxlopPhysicalExternalScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLTblScan},
		{EdxlopPhysicalMultiExternalScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLTblScan},
		{EdxlopPhysicalIndexScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLIndexScan},
		{EdxlopPhysicalIndexOnlyScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLIndexOnlyScan},
		{EdxlopPhysicalHashJoin,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLHashJoin},
		{EdxlopPhysicalNLJoin,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLNLJoin},
		{EdxlopPhysicalMergeJoin,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLMergeJoin},
		{EdxlopPhysicalMotionGather,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLMotion},
		{EdxlopPhysicalMotionBroadcast,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLMotion},
		{EdxlopPhysicalMotionRedistribute,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLDuplicateSensitiveMotion},
		{EdxlopPhysicalMotionRandom,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLDuplicateSensitiveMotion},
		{EdxlopPhysicalMotionRoutedDistribute,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLMotion},
		{EdxlopPhysicalLimit,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLLimit},
		{EdxlopPhysicalAgg, &spqopt::CTranslatorDXLToPlStmt::TranslateDXLAgg},
		{EdxlopPhysicalWindow,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLWindow},
		{EdxlopPhysicalSort, &spqopt::CTranslatorDXLToPlStmt::TranslateDXLSort},
		{EdxlopPhysicalSubqueryScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLSubQueryScan},
		{EdxlopPhysicalResult,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLResult},
		{EdxlopPhysicalAppend,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLAppend},
		{EdxlopPhysicalMaterialize,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLMaterialize},
		{EdxlopPhysicalSequence,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLSequence},
		{EdxlopPhysicalDynamicTableScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLDynTblScan},
		{EdxlopPhysicalDynamicIndexScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLDynIdxScan},
		{EdxlopPhysicalTVF, &spqopt::CTranslatorDXLToPlStmt::TranslateDXLTvf},
		{EdxlopPhysicalDML, &spqopt::CTranslatorDXLToPlStmt::TranslateDXLDml},
		{EdxlopPhysicalSplit,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLSplit},
		{EdxlopPhysicalRowTrigger,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLRowTrigger},
		{EdxlopPhysicalAssert,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLAssert},
		{EdxlopPhysicalCTEProducer,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLCTEProducerToSharedScan},
		{EdxlopPhysicalCTEConsumer,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLCTEConsumerToSharedScan},
		{EdxlopPhysicalBitmapTableScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLBitmapTblScan},
		{EdxlopPhysicalDynamicBitmapTableScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLBitmapTblScan},
		{EdxlopPhysicalCTAS, &spqopt::CTranslatorDXLToPlStmt::TranslateDXLCtas},
		{EdxlopPhysicalPartitionSelector,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLPartSelector},
		{EdxlopPhysicalValuesScan,
		 &spqopt::CTranslatorDXLToPlStmt::TranslateDXLValueScan},
        /* SPQ: for ShareScan */
        {EdxlopPhysicalTableShareScan,
        &spqopt::CTranslatorDXLToPlStmt::TranslateDXLTblShareScan},
        /* SPQ: for shareindexscan */
        {EdxlopPhysicalShareIndexScan,
        &spqopt::CTranslatorDXLToPlStmt::TranslateDXLShareIndexScan},
	};
											  ...
											  bool can_set_tag)
{
	...
	ForEach(lc_rte, m_dxl_to_plstmt_context->GetRTableEntriesList())
	{
		...
		{
			oids_list = spqdb::LAppendOid(oids_list, pRTE->relid);
		}
	}
	...
	// SPQDB_92_MERGE_FIXME: we really *should* be handling intoClause
	...
	/*if (CMD_SELECT == m_cmd_type && NULL != dxlnode->GetDXLDirectDispatchInfo())
	{
		...
		if (plan->directDispatch.isDirectDispatch)
		{
			List *motion_node_list =
				spqdb::ExtractNodesPlan(planned_stmt->planTree, T_Motion,
									   true );
			ListCell *lc = NULL;
			ForEach(lc, motion_node_list)
			{
				Motion *motion = (Motion *) lfirst(lc);
				SPQOS_ASSERT(IsA(motion, Motion));
				SPQOS_ASSERT(spqdb::IsMotionGather(motion));
...
{
	SPQOS_ASSERT(NULL != dxlnode);
	SPQOS_ASSERT(NULL != ctxt_translation_prev_siblings);
...
CTranslatorDXLToPlStmt::SetInitPlanVariables(PlannedStmt *planned_stmt)
{
	...
	List *subplan_list =
		spqdb::ExtractNodesPlan(planned_stmt->planTree, T_SubPlan, true);
	...
	{
		subplan_list =
			spqdb::ExtractNodesPlan((Plan *) lfirst(lc), T_SubPlan, true);
		ListCell *lc2;
...
//
//	@doc:
//		Set the qDispSliceId for a given subplans. In SPQDB once all motion node
...
{
	// TODO SPQ subplans
	/*SPQOS_ASSERT(subplan->is_initplan && "This is processed for initplans only");

	if (subplan->is_initplan)
	{
		SPQOS_ASSERT(0 < m_dxl_to_plstmt_context->GetCurrentMotionId());
...
{
	List *params_node_list = spqdb::ExtractNodesPlan(
	...
	ForEach(lc, params_node_list)
	{
		...
		bitmapset = spqdb::BmsAddMember(bitmapset, param->paramid);
	}
...
// TODO spq need support
		...
		OID oidRel = CMDIdSPQDB::CastMdid(md_rel->MDId())->Oid();
		ExtTableEntry *ext_table_entry = spqdb::GetExternalTableEntry(oidRel);
		bool isMasterOnly;
	...
	Node *node, SContextIndexVarAttno *ctxt_index_var_attno_walker)
{
	...
	if (IsA(node, Var) && ((Var *) node)->varno != OUTER_VAR)
	{
		...
		ULONG index_col_pos_idx_max = spqos::ulong_max;
		...
		if (spqos::ulong_max > index_col_pos_idx_max)
		{
			((Var *) node)->varattno =
	...
	return spqdb::WalkExpressionTree(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	SPQOS_ASSERT(3 == index_scan_dxlnode->Arity());
					   ...
					   CDXLTranslateContextBaseTable *index_context)
{
	...
	for (ULONG ul = 0; ul < md_index->Keys(); ul++)
	{
		...
		Expr *indexvar = (Expr *) spqdb::MakeVar(
			new_varno, col->AttrNum(),
			CMDIdSPQDB::CastMdid(col->MdidType())->Oid(),
		...
		target_list = spqdb::LAppend(target_list, target_entry);
	}
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		quals_list = spqdb::LAppend(quals_list, index_filter_expr);
	}
	...
	List **index_subtype_list)
{
	...
	CIndexQualInfoArray *index_qual_info_array =
		SPQOS_NEW(m_mp) CIndexQualInfoArray(m_mp);
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		Expr *index_cond_expr =
			m_translator_dxl_to_scalar->TranslateDXLToScalar(
				index_cond_dxlnode, &colid_var_mapping);
		SPQOS_ASSERT((IsA(index_cond_expr, OpExpr) ||
			...
			IMDIndex::EmdindBitmap != index->IndexType())
		{
			SPQOS_RAISE(
				...
				SPQOS_WSZ_LIT("ScalarArrayOpExpr condition on index scan"));
		}
		...
		Node *left_arg = (Node *) lfirst(spqdb::ListHead(args_list));
		Node *right_arg = (Node *) lfirst(spqdb::ListTail(args_list));
		...
		SPQOS_ASSERT((IsA(left_arg, Var) || IsA(right_arg, Var)) &&
		...
		if (IsA(left_arg, Var) && ((Var *) left_arg)->varno != OUTER_VAR)
		{
			...
			// SPQDB_92_MERGE_FIXME: helluva hack
		...
		else
		{
			...
			SPQOS_ASSERT(((Var *) right_arg)->varno != OUTER_VAR &&
		...
		SPQOS_ASSERT(InvalidOid != cmp_operator_oid);
		OID op_family_oid = CTranslatorUtils::GetOpFamilyForIndexQual(
			attno, CMDIdSPQDB::CastMdid(index->MDId())->Oid());
		SPQOS_ASSERT(InvalidOid != op_family_oid);
		spqdb::IndexOpProperties(cmp_operator_oid, op_family_oid, &strategy_num,
								&index_subtype_oid);

		// create index qual
		index_qual_info_array->Append(SPQOS_NEW(m_mp) CIndexQualInfo(
	...
	for (ULONG ul = 0; ul < length; ul++)
	{
		...
		*index_cond = spqdb::LAppend(*index_cond, index_qual_info->m_expr);
		*index_orig_cond =
			spqdb::LAppend(*index_orig_cond, index_qual_info->m_original_expr);
		*index_strategy_list = spqdb::LAppendInt(
			*index_strategy_list, index_qual_info->m_index_subtype_oid);
		*index_subtype_list = spqdb::LAppendOid(
	...
	CDXLTranslationContextArray *child_contexts)
{
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		quals_list = spqdb::LAppend(quals_list, assert_contraint_expr);
	}
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	SPQOS_ASSERT(4 == limit_dxlnode->Arity());
...
CTranslatorDXLToPlStmt::TranslateDXLHashJoin(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	SPQOS_ASSERT(hj_dxlnode->GetOperator()->GetDXLOperator() ==
				EdxlopPhysicalHashJoin);
	SPQOS_ASSERT(hj_dxlnode->Arity() == EdxlhjIndexSentinel);
	...
	// set join type
	join->jointype =
		GetSPQDBJoinTypeFromDXLJoinType(hashjoin_dxlop->GetJoinType());
    join->is_set_op_join = hashjoin_dxlop->IsSetOpJoin();
	...
	else
	{
		...
		for (ULONG ul = 0; ul < arity; ul++)
		{
				...
				hash_cond_dxlnode->GetOperator()->GetDXLOperator())
			{
				...
				SPQOS_ASSERT(Edxlnot == CDXLScalarBoolExpr::Cast(
										   hash_cond_dxlnode->GetOperator())
										   ->GetDxlBoolTypeStr());
				hash_cond_dxlnode = (*hash_cond_dxlnode)[0];
				SPQOS_ASSERT(EdxlopScalarDistinct ==
							hash_cond_dxlnode->GetOperator()->GetDXLOperator());
			}
			...
			hash_clauses_list =
				spqdb::LAppend(hash_clauses_list, hash_clause_expr);
		}
	...
	SPQOS_ASSERT(NIL != hashjoin->hashclauses);

    if (join->is_set_op_join) {
        List* join_null_info = nullptr;
        for(int i = 0; i < list_length(hashjoin->hashclauses); i++) {
            join_null_info = lappend_int(join_null_info, i + 1);
        }
        join->nulleqqual = spq_make_null_eq_clause(hashjoin->hashclauses, &join->joinqual, join_null_info);
    }
...
//
//	@doc:
//		Translates a DXL TVF node into a SPQDB Function scan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLTvf(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	SPQOS_ASSERT(rte != NULL);
	//SPQOS_ASSERT(list_length(rte->functions) == 1);
	RangeTblFunction *rtfunc = nullptr;
		//(RangeTblFunction *) spqdb::CopyObject(linitial(rte->functions));
	...
	SPQOS_ASSERT(1 <= tvf_dxlnode->Arity());
	...
	ForEach(lc_target_entry, target_list)
	{
		...
		INT typ_mod = spqdb::ExprTypeMod((Node *) target_entry->expr);
		Oid collation_type_oid = spqdb::TypeCollation(oid_type);

		rtfunc->funccolnames = spqdb::LAppend(
			rtfunc->funccolnames, spqdb::MakeStringValue(target_entry->resname));
		rtfunc->funccoltypes = spqdb::LAppendOid(rtfunc->funccoltypes, oid_type);
		rtfunc->funccoltypmods =
			spqdb::LAppendInt(rtfunc->funccoltypmods, typ_mod);
		// SPQDB_91_MERGE_FIXME: collation
		rtfunc->funccolcollations =
			spqdb::LAppendOid(rtfunc->funccolcollations, collation_type_oid);
	}
	...
	CDXLTranslateContextBaseTable *base_table_context)
{
	...
	for (ULONG ul = 0; ul < num_of_cols; ul++)
	{
		...
		Value *val_colname = spqdb::MakeStringValue(col_name_char_array);
		alias->colnames = spqdb::LAppend(alias->colnames, val_colname);
	...
	if (!dxlop->FuncMdId()->IsValid())
	{
		...
		CDXLDatumGeneric *datum_generic_dxl =
			CDXLDatumGeneric::Cast(const_cast<spqdxl::CDXLDatum *>(datum_dxl));
		const IMDType *type =
		...
		ULONG length =
			(ULONG) spqdb::DatumSize(val, false, const_expr->constlen);
		CHAR *str = (CHAR *) spqdb::SPQDBAlloc(length + 1);
		memcpy(str, datum_generic_dxl->GetByteArray(), length);
		str[length] = '\0';
		const_expr->constvalue = spqdb::DatumFromPointer(str);
	...
	else
	{
		...
		func_expr->funcretset = spqdb::GetFuncRetset(func_expr->funcid);
		...
		for (ULONG ul = 1; ul < num_of_child; ++ul)
		{
			...
			func_expr->args = spqdb::LAppend(func_expr->args, pexprFuncArg);
		}
		...
		ListCell *lc = NULL;
		List *param_exprs = spqdb::ExtractNodesExpression(
			(Node *) func_expr, T_Param, false /*descend_into_subqueries */);
		ForEach(lc, param_exprs)
		{
			Param *param = (Param *) lfirst(lc);
			funcparams = spqdb::BmsAddMember(funcparams, param->paramid);
		}
	...
	CDXLTranslateContextBaseTable *base_table_context)
{
		 ...
		 ulValue++)
	{
		...
		for (ULONG ulCol = 0; ulCol < num_of_cols; ulCol++)
		{
			...
			value = spqdb::LAppend(value, const_expr);
		}
		values_lists = spqdb::LAppend(values_lists, value);
		...
		if (NIL == values_collations)
		{
			...
			for (ULONG ulCol = 0; ulCol < num_of_cols; ulCol++)
			{
				values_collations = spqdb::LAppendOid(
					values_collations, spqdb::ExprCollation((Node *) value));
			}
		}
	}
...
CTranslatorDXLToPlStmt::TranslateDXLNLJoin(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	SPQOS_ASSERT(nl_join_dxlnode->GetOperator()->GetDXLOperator() ==
				EdxlopPhysicalNLJoin);
	SPQOS_ASSERT(nl_join_dxlnode->Arity() == EdxlnljIndexSentinel);
	...
	// set join type
	join->jointype = GetSPQDBJoinTypeFromDXLJoinType(dxl_nlj->GetJoinType());
	...
	if (dxl_nlj->IsIndexNLJ())
	{
		...
		for (ULONG ul = 0; ul < ulLen; ul++)
		{
				...
				right_dxl_translate_ctxt.GetParamIdMappingElement(ulColid))
			{
                ...
                OID iTypeOid = CMDIdSPQDB::CastMdid(pmdid)->Oid();
                m_dxl_to_plstmt_context->SetParamTypes(iTypeOid);
#ifdef SPQOS_DEBUG
				BOOL fInserted =
#endif
...
CTranslatorDXLToPlStmt::TranslateDXLMergeJoin(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	SPQOS_ASSERT(merge_join_dxlnode->GetOperator()->GetDXLOperator() ==
				EdxlopPhysicalMergeJoin);
	SPQOS_ASSERT(merge_join_dxlnode->Arity() == EdxlmjIndexSentinel);
	...
	// set join type
	join->jointype =
		GetSPQDBJoinTypeFromDXLJoinType(merge_join_dxlop->GetJoinType());
	...
	for (ULONG ul = 0; ul < num_join_conds; ul++)
	{
		...
		SPQOS_ASSERT(1 == spqdb::ListLength(merge_condition_list));
		merge_conditions_list =
			spqdb::ListConcat(merge_conditions_list, merge_condition_list);
	}

	SPQOS_ASSERT(NIL != merge_conditions_list);
	...
	merge_join->mergeFamilies =
		(Oid *) spqdb::SPQDBAlloc(sizeof(Oid) * num_join_conds);
	merge_join->mergeStrategies =
		(int *) spqdb::SPQDBAlloc(sizeof(int) * num_join_conds);
	merge_join->mergeCollations =
		(Oid *) spqdb::SPQDBAlloc(sizeof(Oid) * num_join_conds);
	merge_join->mergeNullsFirst =
		(bool *) spqdb::SPQDBAlloc(sizeof(bool) * num_join_conds);
	...
	foreach (lc, merge_join->mergeclauses)
	{
		...
		if (IsA(expr, OpExpr))
		{
			...
			List *mergefamilies = spqdb::GetMergeJoinOpFamilies(opexpr->opno);

			SPQOS_ASSERT(NULL != mergefamilies &&
						spqdb::ListLength(mergefamilies) > 0);

			// Pick the first - it's probably what we want
			merge_join->mergeFamilies[ul] = spqdb::ListNthOid(mergefamilies, 0);

			SPQOS_ASSERT(spqdb::ListLength(opexpr->args) == 2);
			Expr *leftarg = (Expr *) spqdb::ListNth(opexpr->args, 0);

			// TODO SPQ  unused variable ‘rightarg
			//Expr *rightarg = (Expr *) spqdb::ListNth(opexpr->args, 1);
			//SPQOS_ASSERT(spqdb::ExprCollation((Node *) leftarg) ==
						//spqdb::ExprCollation((Node *) rightarg));

			merge_join->mergeCollations[ul] =
				spqdb::ExprCollation((Node *) leftarg);
		...
		else
		{
			SPQOS_RAISE(spqdxl::ExmaDXL, spqdxl::ExmiQuery2DXLUnsupportedFeature,
					   SPQOS_WSZ_LIT("Not an op expression in merge clause"));
			break;
		}
	}
...
//
//	@doc:
//		Translate DXL motion node into SPQDB Motion plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLMotion(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	if (0 < num_sort_cols)
	{
		...
		motion->sortColIdx =
			(AttrNumber *) spqdb::SPQDBAlloc(num_sort_cols * sizeof(AttrNumber));
		motion->sortOperators =
			(Oid *) spqdb::SPQDBAlloc(num_sort_cols * sizeof(Oid));
		motion->collations =
			(Oid *) spqdb::SPQDBAlloc(num_sort_cols * sizeof(Oid));
		motion->nullsFirst =
			(bool *) spqdb::SPQDBAlloc(num_sort_cols * sizeof(bool));
		...
		motion_dxlop->GetDXLOperator() == EdxlopPhysicalMotionRandom)
	{
		...
		numHashExprs = spqdb::ListLength(hash_expr_list);

		int i = 0;
		ListCell *lc, *lcoid;
		Oid *hashFuncs = (Oid *) spqdb::SPQDBAlloc(numHashExprs * sizeof(Oid));

		if (SPQOS_FTRACE(EopttraceConsiderOpfamiliesForDistribution))
		{
			SPQOS_ASSERT(spqdb::ListLength(hash_expr_list) ==
						spqdb::ListLength(hash_expr_opfamilies));
			forboth(lc, hash_expr_list, lcoid, hash_expr_opfamilies)
			{
				Node *expr = (Node *) lfirst(lc);
				Oid typeoid = spqdb::ExprType(expr);
				Oid opfamily = lfirst_oid(lcoid);
				hashFuncs[i] = spqdb::GetHashProcInOpfamily(opfamily, typeoid);
				i++;
			}
		}
		else
...
//		SPQDB result node with hash filters
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLRedistributeMotionToResultHashFilters(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	if (EdxlopPhysicalMotionRedistribute == motion_dxlop->GetDXLOperator())
	{
		...
		result->hashFilterColIdx =
			(AttrNumber *) spqdb::SPQDBAlloc(length * sizeof(AttrNumber));
		result->hashFilterFuncs = (Oid *) spqdb::SPQDBAlloc(length * sizeof(Oid));
		...
		for (ULONG ul = 0; ul < length; ul++)
		{
			...
			else
			{
				...
				// We therefore, create a corresponding SPQDB scalar expression and add it to the project list
				// of the hash filter
				CMappingColIdVarPlStmt colid_var_mapping =
				...
				target_entry = spqdb::MakeTargetEntry(
					expr, spqdb::ListLength(plan->targetlist) + 1,
					CTranslatorUtils::CreateMultiByteCharStringFromWCString(
						str_unnamed_col.GetBuffer()),
					false /* resjunk */);
				plan->targetlist =
					spqdb::LAppend(plan->targetlist, (void *) target_entry);
			...
			result->hashFilterFuncs[ul] =
				m_dxl_to_plstmt_context->GetDistributionHashFuncForType(
					spqdb::ExprType((Node *) target_entry->expr));
		}
	}
	else
	{
		...
		int segment = spqdb::SpqHashRandomSeg(spqdb::GetSPQSegmentCount());

		result->resconstantqual =
			(Node *) ListMake1(spqdb::MakeSegmentFilterExpr(segment));
	}
	...
	if (targetlist_modified)
	{
		...
		ForEach(lc, child_result->targetlist)
		{
			...
			Var *var = spqdb::MakeVar(
				OUTER_VAR, te->resno, spqdb::ExprType((Node *) te->expr),
				spqdb::ExprTypeMod((Node *) te->expr), 0 /* varlevelsup */);
			TargetEntry *new_te =
				spqdb::MakeTargetEntry((Expr *) var, ul, /* resno */
									  te->resname, te->resjunk);
			plan->targetlist = spqdb::LAppend(plan->targetlist, new_te);
		}
...
//
//	@doc:
//		Translate DXL aggregate node into SPQDB Agg plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLAgg(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
    ...
    foreach (lc, plan->targetlist)
    {
        ...
        if (IsA(te->expr, Aggref))
        {
            ...
            agg->aggsplittype = aggref->aggsplittype;
            break;
        }
    }
	...
	switch (dxl_phy_agg_dxlop->GetAggStrategy())
	{
		...
		case EdxlaggstrategyHashed:
			...
			break;
		default:
			SPQOS_ASSERT(!"Invalid aggregation strategy");
	}
	// TODO SPQ
	...
	{
		agg->grpColIdx =
			(AttrNumber *) spqdb::SPQDBAlloc(agg->numCols * sizeof(AttrNumber));
		agg->grpOperators = (Oid *) spqdb::SPQDBAlloc(agg->numCols * sizeof(Oid));
	}
	else
	{
		agg->grpColIdx = NULL;
	...
	for (ULONG ul = 0; ul < length; ul++)
	{
		...
		Oid typeId = spqdb::ExprType((Node *) target_entry_grouping_col->expr);
		agg->grpOperators[ul] = spqdb::GetEqualityOp(typeId);
...
//
//	@doc:
//		Translate DXL window node into SPQDB window plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLWindow(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	{
		window->partColIdx = (AttrNumber *) spqdb::SPQDBAlloc(
			window->partNumCols * sizeof(AttrNumber));
		window->partOperators =
			(Oid *) spqdb::SPQDBAlloc(window->partNumCols * sizeof(Oid));
        window->part_collations = (Oid *) spqdb::SPQDBAlloc(window->partNumCols * sizeof(Oid));
	}
	...
	for (ULONG ul = 0; ul < num_of_part_cols; ul++)
	{
		...
		Oid type_id = spqdb::ExprType((Node *) te_part_colid->expr);
		window->partOperators[ul] = spqdb::GetEqualityOp(type_id);
		Assert(window->partOperators[ul] != 0);
        window->part_collations[ul] = spqdb::ExprCollation((Node *) te_part_colid->expr);
	}
	...
	SPQOS_ASSERT(size <= 1 && "cannot have more than one window key");
	...
	if (size == 1)
	{
		...
		window->ordColIdx =
			(AttrNumber *) spqdb::SPQDBAlloc(num_of_cols * sizeof(AttrNumber));
		window->ordOperators =
			(Oid *) spqdb::SPQDBAlloc(num_of_cols * sizeof(Oid));
        window->ord_collations = (Oid *) spqdb::SPQDBAlloc(num_of_cols * sizeof(Oid));
		bool *is_nulls_first =
			(bool *) spqdb::SPQDBAlloc(num_of_cols * sizeof(bool));
		TranslateSortCols(sort_col_list_dxlnode, &child_context,
						  window->ordColIdx, window->ordOperators, window->ord_collations,
						  is_nulls_first);
		...
		spqdb::SPQDBFree(is_nulls_first);
		...
		for (ULONG i = 0; i < num_of_cols; i++)
		{
			window->ordOperators[i] =
				spqdb::GetEqualityOpForOrderingOp(window->ordOperators[i], NULL);
		}
		...
		if (NULL != window_key->GetWindowFrame())
		{
			...
			{
				SPQOS_RAISE(spqdxl::ExmaDXL,
						   spqdxl::ExmiQuery2DXLUnsupportedFeature,
						   SPQOS_WSZ_LIT("EXCLUDE clause in window frame"));
			}
...
//
//	@doc:
//		Translate DXL sort node into SPQDB Sort plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLSort(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	sort->sortColIdx =
		(AttrNumber *) spqdb::SPQDBAlloc(num_of_cols * sizeof(AttrNumber));
	sort->sortOperators = (Oid *) spqdb::SPQDBAlloc(num_of_cols * sizeof(Oid));
	sort->collations = (Oid *) spqdb::SPQDBAlloc(num_of_cols * sizeof(Oid));
	sort->nullsFirst = (bool *) spqdb::SPQDBAlloc(num_of_cols * sizeof(bool));
...
//
//	@doc:
//		Translate DXL subquery scan node into SPQDB SubqueryScan plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLSubQueryScan(
...
//
//	@doc:
//		Translate DXL result node into SPQDB result plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLResult(
...
//
//	@doc:
//		Translate DXL PartitionSelector into a SPQDB PartitionSelector node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLPartSelector(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	// TODO SPQ diff PartitionSelector struct
	...
	partition_selector->relid =
		CMDIdSPQDB::CastMdid(partition_selector_dxlop->GetRelMdId())->Oid();
	...
	SPQOS_ASSERT(eq_filters_dxlnode->Arity() == num_of_levels);
	...
	SPQOS_ASSERT(filters_dxlnode->Arity() == num_of_levels);
	...
	{
		/*SelectedParts *sp =
			spqdb::RunStaticPartitionSelection(partition_selector);
...
//
//	@doc:
//		Translate DXL filter or filter elem list into SPQDB filter list
//
//---------------------------------------------------------------------------
List *
CTranslatorDXLToPlStmt::TranslateDXLFilterList(
...
{
	SPQOS_ASSERT(EdxlopScalarOpList ==
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		{
			filters_list = spqdb::LAppend(filters_list, NULL /*datum*/);
			continue;
		}
		...
		if (is_eq_filters)
		{
			...
			filters_list = spqdb::LAppend(filters_list, eq_filter_elems);
		}
		else
		{
			Expr *filter_expr =
			...
			filters_list = spqdb::LAppend(filters_list, filter_expr);
		}
	}
...
//
//	@doc:
//		Translate DXL append node into SPQDB Append plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLAppend(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	SPQOS_ASSERT(EdxlappendIndexFirstChild < arity);
	//plan->nMotionNodes = 0;
	...
	for (ULONG ul = 0; ul < length; ++ul)
	{
		...
		CDXLScalarProjElem *sc_proj_elem_dxlop =
			CDXLScalarProjElem::Cast(proj_elem_dxlnode->GetOperator());
		SPQOS_ASSERT(1 == proj_elem_dxlnode->Arity());
		...
		Var *var = spqdb::MakeVar(
			idxVarno, attno,
			CMDIdSPQDB::CastMdid(sc_ident_dxlop->MdidType())->Oid(),
		...
		plan->targetlist = spqdb::LAppend(plan->targetlist, target_entry);
	}
...
//
//	@doc:
//		Translate DXL materialize node into SPQDB Material plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLMaterialize(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	materialize->spq_strict = materialize_dxlop->IsEager();
	// ensure that executor actually materializes results
	materialize->spq_shield_child_from_rescans = true;
...
//
//	@doc:
//		Translate DXL CTE Producer node into SPQDB share input scan plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLCTEProducerToSharedScan(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
    ...
    shared_input_scan->is_producer = true;
	...
	{
		Material *materialize = MakeNode(Material);
		materialize->spq_strict = false;  // eager-free
		...
		ForEach(lc_target_entry, child_plan->targetlist)
		{
			...
			Var *var_new = spqdb::MakeVar(
				OUTER_VAR, te->resno, spqdb::ExprType((Node *) te->expr),
				spqdb::ExprTypeMod((Node *) te->expr), 0 /* varlevelsup */);

			TargetEntry *te_new =
				spqdb::MakeTargetEntry((Expr *) var_new, te->resno, /* resno */
									  te->resname, te->resjunk);
			materialize_plan->targetlist =
				spqdb::LAppend(materialize_plan->targetlist, te_new);
		}

		materialize_plan->lefttree = child_plan;
		//materialize_plan->nMotionNodes = child_plan->nMotionNodes;
		/* SPQ: add exec_nodes for plan */
		inherit_plan_locator_info(materialize_plan, child_plan);
...
CTranslatorDXLToPlStmt::InitializeSpoolingInfo(Plan *plan, ULONG share_id)
{
	...
	SPQOS_ASSERT(NULL != shared_scan_cte_consumer_list);

	Flow *flow = GetFlowCTEConsumer(shared_scan_cte_consumer_list);

	const ULONG num_of_shared_scan =
		spqdb::ListLength(shared_scan_cte_consumer_list);
	...
	if (IsA(plan, Material))
	{
		...
		SPQOS_ASSERT(NULL == (materialize->plan).flow);
		(materialize->plan).flow = flow;
	}
	else
	{
		SPQOS_ASSERT(IsA(plan, Sort));
		Sort *sort = (Sort *) plan;
		...
		SPQOS_ASSERT(NULL == (sort->plan).flow);
		(sort->plan).flow = flow;
	}

	SPQOS_ASSERT(SHARE_NOTSHARED != share_type);
...
CTranslatorDXLToPlStmt::GetFlowCTEConsumer(List *shared_scan_cte_consumer_list)
{
	...
	ForEach(lc_sh_scan_cte_consumer, shared_scan_cte_consumer_list)
	{
		...
		if (NULL != flow_cte)
		{
			if (NULL == flow)
			{
				flow = (Flow *) spqdb::CopyObject(flow_cte);
			}
			else
			{
				SPQOS_ASSERT(flow->flotype == flow_cte->flotype);
			}
		}
	}
...
//
//	@doc:
//		Translate DXL CTE Consumer node into SPQDB share input scan plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLCTEConsumerToSharedScan(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
    ...
    share_input_scan_cte_consumer->is_producer = false;
	...
	SPQOS_ASSERT(num_of_proj_list_elem == output_colids_array->Size());
...
//
//	@doc:
//		Translate DXL sequence node into SPQDB Sequence plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLSequence(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	psequence->subplans = spqdb::LAppend(psequence->subplans, last_child_plan);
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	SPQOS_ASSERT(2 == dyn_tbl_scan_dxlnode->Arity());
...
// TODO Need support
	...
	CMDIdSPQDB *mdid_index =
		CMDIdSPQDB::CastMdid(dyn_index_scan_dxlop->GetDXLIndexDescr()->MDId());
	const IMDIndex *md_index = m_md_accessor->RetrieveIndex(mdid_index);
	Oid index_oid = mdid_index->Oid();
	...
	dyn_idx_scan->logicalIndexInfo =
		spqdb::GetLogicalIndexInfo(rte->relid, index_oid);
	...
	// an index scan node must have 3 children: projection list, filter and index condition list
	SPQOS_ASSERT(3 == dyn_idx_scan_dxlnode->Arity());
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	switch (phy_dml_dxlop->GetDmlOpType())
	{
		...
		case spqdxl::EdxldmlSentinel:
		default:
		{
			SPQOS_RAISE(
				spqdxl::ExmaDXL, spqdxl::ExmiDXL2PlStmtConversion,
				SPQOS_WSZ_LIT("Unexpected error during plan generation."));
			break;
		}
	}
...
{
	if (!u_sess->attr.attr_spq.spq_optimizer_enable_direct_dispatch || NULL == dxl_direct_dispatch_info)
	{
		return NIL;
	}
	...
	SPQOS_ASSERT(0 < dxl_datum_array->Size());
	...
	if (dxl_direct_dispatch_info->FContainsRawValues())
	{
		...
		for (ULONG ul = 0; ul < length; ul++)
		{
			...
			SPQOS_ASSERT(1 == dispatch_identifier_datum_array->Size());
			const_expr =
			...
			{
				segids_list = spqdb::LAppendInt(segids_list, segid);
			}
		}
	...
	ULONG hash_code = GetDXLDatumSPQDBHash(dxl_datum_array);
	for (ULONG ul = 0; ul < length; ul++)
	{
		CDXLDatumArray *dispatch_identifier_datum_array =
			(*dispatch_identifier_datum_arrays)[ul];
		SPQOS_ASSERT(0 < dispatch_identifier_datum_array->Size());
		ULONG hash_code_new =
			GetDXLDatumSPQDBHash(dispatch_identifier_datum_array);
	...
	List *segids_list = spqdb::LAppendInt(NIL, hash_code);
	return segids_list;
}

//---------------------------------------------------------------------------
//	@function:
//		CTranslatorDXLToPlStmt::GetDXLDatumSPQDBHash
//
//	@doc:
//		Hash a DXL datum
//
//---------------------------------------------------------------------------
ULONG
CTranslatorDXLToPlStmt::GetDXLDatumSPQDBHash(CDXLDatumArray *dxl_datum_array)
{
	...
	hashfuncs = (Oid *) spqdb::SPQDBAlloc(length * sizeof(Oid));
	...
	for (ULONG ul = 0; ul < length; ul++)
	{
		...
		Const *const_expr =
			(Const *) m_translator_dxl_to_scalar->TranslateDXLDatumToScalar(
				datum_dxl);
		consts_list = spqdb::LAppend(consts_list, const_expr);
		hashfuncs[ul] = m_dxl_to_plstmt_context->GetDistributionHashFuncForType(
			const_expr->consttype);
	}

	ULONG hash =
		spqdb::CdbHashConstList(consts_list, m_num_of_segments, hashfuncs);

	spqdb::ListFreeDeep(consts_list);
	spqdb::SPQDBFree(hashfuncs);
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	SPQOS_ASSERT(insertion_colid_array->Size() == deletion_colid_array->Size());
...
//
//	@doc:
//		Translate DXL assert node into SPQDB assert plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLAssert(
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	// translate error code into the its internal SPQDB representation
	const CHAR *error_code = assert_dxlop->GetSQLState();
	SPQOS_ASSERT(SPQOS_SQLSTATE_LENGTH == clib::Strlen(error_code));
	...
	SPQOS_ASSERT(spqdb::ListLength(plan->qual) ==
				spqdb::ListLength(assert_node->errmessage));
	SetParamIds(plan);
	inherit_plan_locator_info(plan, plan->lefttree);
	// cleanup
	child_contexts->Release();
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	Oid relid_oid =
		CMDIdSPQDB::CastMdid(phy_row_trigger_dxlop->GetRelMdId())->Oid();
	SPQOS_ASSERT(InvalidOid != relid_oid);
	...
	SPQOS_ASSERT_IMP(NULL != colids_old_array && NULL != colids_new_array,
	...
	CDXLTranslateContextBaseTable *base_table_context)
{
	...
	// get oid for table
	Oid oid = CMDIdSPQDB::CastMdid(table_descr->MDId())->Oid();
	...
	for (ULONG ul = 0; ul < arity; ++ul)
	{
		...
		SPQOS_ASSERT(NULL != dxl_col_descr);
		...
		if (0 < attno)
		{
			...
			// add those to the RTE as they are required by SPQDB
			for (INT dropped_col_attno = last_attno + 1;
				 dropped_col_attno < attno; dropped_col_attno++)
			{
				Value *val_dropped_colname = spqdb::MakeStringValue(PStrDup(""));
				alias->colnames =
					spqdb::LAppend(alias->colnames, val_dropped_colname);
			}
	...
	{
		Value *val_dropped_colname = spqdb::MakeStringValue(PStrDup(""));
		alias->colnames = spqdb::LAppend(alias->colnames, val_dropped_colname);
	}
	...
	for (ULONG ul = 0; ul < arity; ++ul)
	{
		...
		if (IsA(expr, Var))
		{
			...
			else
			{
				...
				SPQOS_ASSERT(NULL != child_contexts);
				SPQOS_ASSERT(0 != child_contexts->Size());
				ULONG colid = CDXLScalarIdent::Cast(expr_dxlnode->GetOperator())
								  ->GetDXLColRef()
								  ->Id();
				...
				const CDXLTranslateContext *translate_ctxt_left =
					(*child_contexts)[0];
				SPQOS_ASSERT(NULL != translate_ctxt_left);
				...
				if (NULL == pteOriginal)
				{
					...
					SPQOS_ASSERT(2 == child_contexts->Size());
					const CDXLTranslateContext *pdxltrctxRight =
						(*child_contexts)[1];

					SPQOS_ASSERT(NULL != pdxltrctxRight);
				...
				{
					SPQOS_RAISE(spqdxl::ExmaDXL,
							   spqdxl::ExmiDXL2PlStmtAttributeNotFound, colid);
				}
	...
	List *target_list, const IMDRelation *md_rel)
{
	...
	SPQOS_ASSERT(spqdb::ListLength(target_list) <= md_rel->ColumnCount());
	...
	for (ULONG ul = 0; ul < num_of_rel_cols; ul++)
	{
		...
		{
			// add a NULL element
			OID oid_type = CMDIdSPQDB::CastMdid(
							   m_md_accessor->PtMDType<IMDTypeInt4>()->MDId())
							   ->Oid();

			expr = (Expr *) spqdb::MakeNULLConst(oid_type);
		}
		else
		{
			TargetEntry *target_entry =
				(TargetEntry *) spqdb::ListNth(target_list, last_tgt_elem);
			expr = (Expr *) spqdb::CopyObject(target_entry->expr);
			last_tgt_elem++;
		}
		...
		TargetEntry *te_new =
			spqdb::MakeTargetEntry(expr, resno, name_str, false /*resjunk*/);
		result_list = spqdb::LAppend(result_list, te_new);
		resno++;
	}
	...
	CDXLTranslateContext *output_context)
{
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		// find column type
		OID oid_type = spqdb::ExprType((Node *) te_child->expr);
		INT type_modifier = spqdb::ExprTypeMod((Node *) te_child->expr);
		...
		Var *var =
			spqdb::MakeVar(OUTER_VAR, te_child->resno, oid_type, type_modifier,
						  0	 // varlevelsup
			);
		...
		TargetEntry *target_entry =
			spqdb::MakeTargetEntry((Expr *) var, (AttrNumber)(ul + 1), resname,
								  false	 // resjunk
			);
	...
	CDXLTranslateContext *output_context)
{
	...
	SPQOS_ASSERT(CTranslatorDXLToScalar::HasBoolResult(filter_cond_dxlnode,
													  m_md_accessor));
	...
	CDXLTranslateContext *output_context)
{
	...
	SPQOS_ASSERT(CTranslatorDXLToScalar::HasBoolResult(
	...
	quals_list = spqdb::LAppend(quals_list, expr);
...
//
//	@doc:
//		Translates DXL plan costs into the SPQDB cost variables
//
//---------------------------------------------------------------------------
void
CTranslatorDXLToPlStmt::TranslatePlanCosts(
...
//
//	@doc:
//		Translates DXL proj list and filter into SPQDB's target and qual lists,
//		respectively
//
//---------------------------------------------------------------------------
void
...
//		SPQDB's hash expression and expression types lists, respectively
//
//---------------------------------------------------------------------------
void
CTranslatorDXLToPlStmt::TranslateHashExprList(
...
{
	SPQOS_ASSERT(NIL == *hash_expr_out_list);
	SPQOS_ASSERT(NIL == *hash_expr_opfamilies_out_list);
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		SPQOS_ASSERT(1 == hash_expr_dxlnode->Arity());
		CDXLNode *expr_dxlnode = (*hash_expr_dxlnode)[0];
		...
		hash_expr_list = spqdb::LAppend(hash_expr_list, expr);

		SPQOS_ASSERT((ULONG) spqdb::ListLength(hash_expr_list) == ul + 1);
	}
	...
	if (SPQOS_FTRACE(EopttraceConsiderOpfamiliesForDistribution))
	{
		for (ULONG ul = 0; ul < arity; ul++)
		{
			...
			hash_expr_opfamilies = spqdb::LAppendOid(
				hash_expr_opfamilies, CMDIdSPQDB::CastMdid(opfamily)->Oid());
		}
	}
...
//
//	@doc:
//		Translates DXL sorting columns list into SPQDB's arrays of sorting attribute numbers,
	...
	Oid *sort_op_oids, Oid *sort_collations_oids, bool *is_nulls_first)
{
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		sort_op_oids[ul] =
			CMDIdSPQDB::CastMdid(sc_sort_col_dxlop->GetMdIdSortOp())->Oid();
		if (sort_collations_oids)
		{
			sort_collations_oids[ul] =
				spqdb::ExprCollation((Node *) te_sort_col->expr);
		}
	...
	BOOL is_resjunk)
{
	...
	TargetEntry *te_new =
		spqdb::MakeTargetEntry((Expr *) var, resno, resname_str, is_resjunk);
...
//---------------------------------------------------------------------------
//	@function:
//		CTranslatorDXLToPlStmt::GetSPQDBJoinTypeFromDXLJoinType
//
//	@doc:
//		Translates the join type from its DXL representation into the SPQDB one
//
//---------------------------------------------------------------------------
JoinType
CTranslatorDXLToPlStmt::GetSPQDBJoinTypeFromDXLJoinType(EdxlJoinType join_type)
{
									 ...
									 List *target_list)
{
	...
	SPQOS_ASSERT(var_type_mod_array->Size() == spqdb::ListLength(target_list));
	...
	const CDXLPhysicalCTAS *phy_ctas_dxlop)
{
	...
	/* SPQDB_91_MERGE_FIXME: what about unlogged? */
	...
	for (ULONG ul = 0; ul < num_of_cols; ++ul)
	{
		...
		col_def->collOid = spqdb::TypeCollation(
			CMDIdSPQDB::CastMdid(dxl_col_descr->MdidType())->Oid());
		into_clause->colNames = spqdb::LAppend(into_clause->colNames, col_def);
	}
	...
	const CDXLPhysicalCTAS *dxlop, List *target_list)
{
	...
	GpPolicy *distr_policy =
		spqdb::MakeGpPolicy(POLICYTYPE_PARTITIONED, num_of_distr_cols_alloc,
						   spqdb::GetSPQSegmentCount());

	SPQOS_ASSERT(IMDRelation::EreldistrHash == dxlop->Ereldistrpolicy() ||
	...
	CDXLCtasStorageOptions::CDXLCtasOptionArray *ctas_storage_options)
{
	...
	for (ULONG ul = 0; ul < num_of_options; ul++)
	{
		...
		if (!pdxlopt->m_is_null)
		{
			...
			SPQOS_ASSERT(T_Integer == arg_type || T_String == arg_type);
			if (T_Integer == arg_type)
			{
				def_elem->arg = (Node *) spqdb::MakeIntegerValue(
					CTranslatorUtils::GetLongFromStr(str_value));
			}
			else
			{
				def_elem->arg = (Node *) spqdb::MakeStringValue(
					CTranslatorUtils::CreateMultiByteCharStringFromWCString(
						str_value->GetBuffer()));
			}
		}

		options = spqdb::LAppend(options, def_elem);
	}
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	if (is_dynamic)
	{
		// TODO SPQ undef DynamicBitmapHeapScan
	...
	SPQOS_ASSERT(4 == bitmapscan_dxlnode->Arity());
	...
	BitmapHeapScan *bitmap_tbl_scan)
{
	...
	SPQOS_ASSERT(EdxlopScalarBitmapBoolOp == dxl_op_id);
...
CTranslatorDXLToPlStmt::TranslateDXLBitmapBoolOp(
	...
	BitmapHeapScan *bitmap_tbl_scan)
{
	SPQOS_ASSERT(NULL != bitmap_boolop_dxlnode);
	SPQOS_ASSERT(EdxlopScalarBitmapBoolOp ==
	...
	BitmapHeapScan *bitmap_tbl_scan)
{
	...
	// TODO SPQ undef DynamicBitmapIndexScan
	...
	// unused variable ‘oidRel’
	//OID oidRel = CMDIdSPQDB::CastMdid(table_descr->MDId())->Oid();
	Plan *plan = &(bitmap_idx_scan->scan.plan);
	plan->plan_node_id = m_dxl_to_plstmt_context->GetNextPlanId();
	//plan->nMotionNodes = 0;

	SPQOS_ASSERT(1 == bitmap_index_probe_dxlnode->Arity());
	...
	if (dyn_bitmap_idx_scan)
	{
		dyn_bitmap_idx_scan->logicalIndexInfo =
			spqdb::GetLogicalIndexInfo(oidRel, index_oid);
	}*/

	return plan;
}

// translates a DXL Value Scan node into a SPQDB Value scan node
Plan *
	...
	CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
	...
	value_scan->values_lists = (List *) spqdb::CopyObject(rte->values_lists);
	...
	SPQOS_ASSERT(2 <= value_scan_dxlnode->Arity());
	...
	CDXLTranslateContext *dxltrctxRight)
{
	...
	for (ULONG ul = 0; ul < pdrgdxlcrOuterRefs->Size(); ul++)
	{
		...
		Var *new_var =
			spqdb::MakeVar(OUTER_VAR, target_entry->resno, old_var->vartype,
		...
		SPQOS_ASSERT(NULL != colid_param_mapping);
		nest_params->paramno = colid_param_mapping->ParamId();
		nest_params->paramval = new_var;
		nest_params_list =
			spqdb::LAppend(nest_params_list, (void *) nest_params);
	}
    ...
    CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
    ...
    CDXLTranslateContextBaseTable base_table_context(m_mp);
    // we will add the new range table entry as the last element of the range table
    Index index = spqdb::ListLength(m_dxl_to_plstmt_context->GetRTableEntriesList()) + 1;
    ...
    CDXLTranslationContextArray *ctxt_translation_prev_siblings)
{
    ...
    //CMDIdSPQDB *mdid = CMDIdSPQDB::CastMdid(md_rel->MDId());
    //SPQOS_RTL_ASSERT(dxl_table_descr->LockMode() != -1);
