...
#ifndef SPQOPT_ICostModelParams_H
#define SPQOPT_ICostModelParams_H
...
public:
	...
	public:
		...
		{
			SPQOS_ASSERT(dVal >= dLowerBound);
			SPQOS_ASSERT(dVal <= dUpperBound);
		}
...
#endif	// !SPQOPT_ICostModelParams_H
