...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CCTEInfo_H
#define SPQOPT_CCTEInfo_H
...
private:
	...
	typedef CHashMap<ULONG, SConsumerCounter, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupDelete<SConsumerCounter> >
		UlongToConsumerCounterMap;

	// map iterator
	typedef CHashMapIter<ULONG, SConsumerCounter, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupDelete<SConsumerCounter> >
	...
	typedef CHashMap<ULONG, UlongToConsumerCounterMap, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
	...
	typedef CHashMap<ULONG, CCTEInfoEntry, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CCTEInfoEntry> >
		UlongToCTEInfoEntryMap;

	// map iterator
	typedef CHashMapIter<ULONG, CCTEInfoEntry, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CCTEInfoEntry> >
...
public:
	...
	void IncrementConsumers(ULONG ulConsumerId,
							ULONG ulParentCTEId = spqos::ulong_max);
