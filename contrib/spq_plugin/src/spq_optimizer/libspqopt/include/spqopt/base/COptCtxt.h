...
//		one optimization
//---------------------------------------------------------------------------
#ifndef SPQOPT_COptCtxt_H
#define SPQOPT_COptCtxt_H
...
public:
	...
	OptimizeDMLQueryWithSingletonSegment() const
	{
		...
		return !SPQOS_FTRACE(EopttraceDisableNonMasterGatherForDML) &&
	...
	void
	SetReqdSystemCols(CColRefArray *pdrspqcrSystemCols)
	{
		SPQOS_ASSERT(NULL != pdrspqcrSystemCols);

		CRefCount::SafeRelease(m_pdrspqcrSystemCols);
		m_pdrspqcrSystemCols = pdrspqcrSystemCols;
	}
