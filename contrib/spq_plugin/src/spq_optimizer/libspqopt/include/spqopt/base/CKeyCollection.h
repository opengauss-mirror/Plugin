...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CKeyCollection_H
#define SPQOPT_CKeyCollection_H
...
public:
	...
	CColRefArray *PdrspqcrTrim(CMemoryPool *mp,
							  const CColRefArray *colref_array) const;

	// extract a key
	CColRefArray *PdrspqcrKey(CMemoryPool *mp) const;

	// extract a hashable key
	CColRefArray *PdrspqcrHashableKey(CMemoryPool *mp) const;

	// extract key at given position
	CColRefArray *PdrspqcrKey(CMemoryPool *mp, ULONG ul) const;
