...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPartKeys_H
#define SPQOPT_CPartKeys_H
...
public:
	// ctor
	explicit CPartKeys(CColRef2dArray *pdrspqdrspqcr);
	...
	static CPartKeysArray *PdrspqpartkeysCopy(
		CMemoryPool *mp, const CPartKeysArray *pdrspqpartkeys);
