...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPartIndexMap_H
#define SPQOPT_CPartIndexMap_H
...
private:
	...
	typedef CHashMap<ULONG, CPartTableInfo, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CPartTableInfo> >
		ScanIdToPartTableInfoMap;

	// map iterator
	typedef CHashMapIter<ULONG, CPartTableInfo, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CPartTableInfo> >
...
public:
	...
	ULongPtrArray *PdrspqulScanIds(CMemoryPool *mp,
	...
	CPartKeysArray *Pdrspqpartkeys(ULONG scan_id) const;
	...
	void AddRequiredPartPropagation(CPartIndexMap *ppimSource, ULONG scan_id,
									...
									CPartKeysArray *pdrspqpartkeys = NULL);
