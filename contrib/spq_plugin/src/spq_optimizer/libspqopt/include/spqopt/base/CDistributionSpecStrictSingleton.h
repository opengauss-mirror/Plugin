...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CDistributionSpecStrictSingleton_H
#define SPQOPT_CDistributionSpecStrictSingleton_H
...
public:
	...
	{
		SPQOS_ASSERT(!"attempt to enforce strict SINGLETON distribution");
	}
	...
	PdssConvert(CDistributionSpec *pds)
	{
		...
		SPQOS_ASSERT(EdtStrictSingleton == pds->Edt());
...
#endif	// !SPQOPT_CDistributionSpecStrictSingleton_H
