...
//---------------------------------------------------------------------------
#ifndef SPQOPT_COptimizationContext_H
#define SPQOPT_COptimizationContext_H
...
#define SPQOPT_INVALID_OPTCTXT_ID spqos::ulong_max
...
private:
	...
	IStatisticsArray *m_pdrspqstatCtxt;
	...
	COptimizationContext()
		: pgexprOrigin_ID(SPQOPT_INVALID_OPTCTXT_ID), /* SPQ begin: print cost*/
		  m_mp(NULL),
		  m_id(SPQOPT_INVALID_OPTCTXT_ID),
		  m_pgroup(NULL),
		  m_prpp(NULL),
		  m_prprel(NULL),
		  m_pdrspqstatCtxt(NULL),
...
public:
	...
	SetId(ULONG id)
	{
		SPQOS_ASSERT(m_id == SPQOPT_INVALID_OPTCTXT_ID);
	...
	static BOOL FEqualContextIds(COptimizationContextArray *pdrspqocFst,
...
#endif	// !SPQOPT_COptimizationContext_H
