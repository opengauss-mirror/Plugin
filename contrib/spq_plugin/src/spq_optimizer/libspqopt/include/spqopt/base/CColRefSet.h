...
//---------------------------------------------------------------------------
#ifndef SPQOS_CColRefSet_H
#define SPQOS_CColRefSet_H
...
#define SPQOPT_COLREFSET_SIZE 1024
...
typedef CHashMap<INT, CColRef, spqos::HashValue<INT>, spqos::Equals<INT>,
...
public:
	...
	explicit CColRefSet(CMemoryPool *mp,
						ULONG ulSizeBits = SPQOPT_COLREFSET_SIZE);
	...
	static BOOL FCovered(CColRefSetArray *pdrspqcrs, CColRefSet *pcrs);
