...
//		operator
//---------------------------------------------------------------------------
#ifndef SPQOPT_CCTEMap_H
#define SPQOPT_CCTEMap_H
...
typedef CHashMap<ULONG, CDrvdPropPlan, spqos::HashValue<ULONG>,
				 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
				 CleanupRelease<CDrvdPropPlan> >
	UlongToDrvdPropPlanMap;

// iterator for plan properties map
typedef CHashMapIter<ULONG, CDrvdPropPlan, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CDrvdPropPlan> >
...
private:
	...
	public:
			...
			: m_id(id), m_ect(ect), m_pdpplan(pdpplan)
		{
			...
			SPQOS_ASSERT_IMP(EctProducer == ect, NULL != pdpplan);
		}
	...
	typedef CHashMap<ULONG, CCTEMapEntry, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CCTEMapEntry> >
		UlongToCTEMapEntryMap;

	// map iterator
	typedef CHashMapIter<ULONG, CCTEMapEntry, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CCTEMapEntry> >
...
public:
	...
	ULongPtrArray *PdrspqulAdditionalProducers(CMemoryPool *mp,
