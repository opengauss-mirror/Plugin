...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CDistributionSpecHashed_H
#define SPQOPT_CDistributionSpecHashed_H
...
private:
	...
	// at position n in m_pdrspqexpr array.
...
public:
	// ctor
	CDistributionSpecHashed(CExpressionArray *pdrspqexpr, BOOL fNullsColocated,
...
#endif	// !SPQOPT_CDistributionSpecHashed_H
