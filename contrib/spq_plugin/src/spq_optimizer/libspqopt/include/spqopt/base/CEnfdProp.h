...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CEnfdProp_H
#define SPQOPT_CEnfdProp_H
...
public:
	...
	AppendEnforcers(
		...
		CExpressionArray *pdrspqexpr,  // array of enforcer expressions
		CExpression *
		...
		CEnfdProp::EPropEnforcingType epet, CExpressionHandle &exprhdl)
	{
		if (FEnforce(epet))
		{
			Pps()->AppendEnforcers(mp, exprhdl, prpp, pdrspqexpr, pexprChild);
		}
	}
