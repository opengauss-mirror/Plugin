...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CDistributionSpecRandom_H
#define SPQOPT_CDistributionSpecRandom_H
...
protected:
	...
	CColRef *m_spq_segment_id;

public:
	//ctor
	CDistributionSpecRandom();

	CDistributionSpecRandom(CColRef *spq_segment_id_);
	...
	{
		SPQOS_ASSERT(!m_is_duplicate_sensitive);
	...
	{
		SPQOS_ASSERT(m_fSatisfiedBySingleton);
	...
	PdsConvert(CDistributionSpec *pds)
	{
		...
		SPQOS_ASSERT(EdtRandom == pds->Edt());
...
#endif	// !SPQOPT_CDistributionSpecRandom_H
