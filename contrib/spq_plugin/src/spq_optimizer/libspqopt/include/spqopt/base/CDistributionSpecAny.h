...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CDistributionSpecAny_H
#define SPQOPT_CDistributionSpecAny_H
...
public:
	...
	{
		SPQOS_ASSERT(!"attempt to enforce ANY distribution");
	}
...
#endif	// !SPQOPT_CDistributionSpecAny_H
