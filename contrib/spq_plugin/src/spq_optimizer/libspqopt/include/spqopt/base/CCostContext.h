...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CCostContext_H
#define SPQOPT_CCostContext_H
...
// infinite plan cost
#define SPQOPT_INFINITE_COST CCost(1e+100)

// invalid cost value
#define SPQOPT_INVALID_COST CCost(-0.5)
...
private:
	...
	COptimizationContextArray *m_pdrspqoc;
...
public:
	...
	SetCost(CCost cost)
	{
		SPQOS_ASSERT(cost > SPQOPT_INVALID_COST);
		m_cost = cost;
	}
	...
	// set child contexts
	void
	SetChildContexts(COptimizationContextArray *pdrspqoc)
	{
	...
	// compute cost
	CCost CostCompute(CMemoryPool *mp, CCostArray *pdrspqcostChildren);
    ...
    IOstream &OsCostPrint(IOstream &os, CHAR *ppfx, BOOL fLast = true) const;
    IOstream &OsCostPrint(IOstream &os, const CPrintPrefix *ppfx, BOOL fLast = true) const;
    /* SPQ end: print cost*/
