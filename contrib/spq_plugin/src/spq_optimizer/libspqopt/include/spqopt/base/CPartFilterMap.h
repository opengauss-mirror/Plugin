...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPartFilterMap_H
#define SPQOPT_CPartFilterMap_H
...
using spqnaucrates::IStatistics;
...
private:
	...
	typedef CHashMap<ULONG, CPartFilter, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CPartFilter> >
		UlongToPartFilterMap;

	// map iterator
	typedef CHashMapIter<ULONG, CPartFilter, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CPartFilter> >
...
public:
	...
	ULongPtrArray *PdrspqulScanIds(CMemoryPool *mp) const;
