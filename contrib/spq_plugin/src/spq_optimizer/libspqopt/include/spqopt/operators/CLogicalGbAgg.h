...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalGbAgg_H
#define SPQOS_CLogicalGbAgg_H
...
public:
	...
	// array of columns used in distinct qualified aggregates (DQA)
	CColRefArray *
	PdrspqcrArgDQA() const
	{
		return m_pdrspqcrArgDQA;
	}
	...
	CColRefArray *
	PdrspqcrMinimal() const
	{
		return m_pdrspqcrMinimal;
	}
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalGbAgg == pop->Eopid() ||
	...
	static IStatistics *PstatsDerive(CMemoryPool *mp, IStatistics *child_stats,
									 ...
									 ULongPtrArray *pdrspqulComputedCols,
									 CBitSet *keys);
...
private:
	...
	CColRefArray *m_pdrspqcrMinimal;
