...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CExpression_H
#define SPQOPT_CExpression_H
...
//
//---------------------------------------------------------------------------
class CExpression : public CRefCount, public spqos::DbgPrintMixin<CExpression>
{
...
public:
	...
	CExpression(CMemoryPool *mp, COperator *pop, CExpressionArray *pdrspqexpr);

	// ctor for n-ary expression with origin group expression
	CExpression(CMemoryPool *mp, COperator *pop, CGroupExpression *pgexpr,
				CExpressionArray *pdrspqexpr, IStatistics *input_stats,
	...
	{
		SPQOS_ASSERT(NULL != m_pdrspqexpr);
		return (*m_pdrspqexpr)[ulPos];
	};
	...
	Arity() const
	{
		return m_pdrspqexpr == NULL ? 0 : m_pdrspqexpr->Size();
	}
...
typedef CHashMap<ULONG, CExpression, spqos::HashValue<ULONG>,
				 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
				 CleanupRelease<CExpression> >
	UlongToExprMap;

// map iterator
typedef CHashMapIter<ULONG, CExpression, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CExpression> >
	UlongToExprMapIter;
