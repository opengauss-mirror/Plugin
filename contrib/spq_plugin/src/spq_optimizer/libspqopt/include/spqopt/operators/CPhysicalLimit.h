...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalLimit_H
#define SPQOPT_CPhysicalLimit_H
...
public:
	...
	HashValue() const
	{
		return spqos::CombineHashes(
			spqos::CombineHashes(COperator::HashValue(), m_pos->HashValue()),
			spqos::CombineHashes(spqos::HashValue<BOOL>(&m_fGlobal),
								spqos::HashValue<BOOL>(&m_fHasCount)));
	}
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalLimit == pop->Eopid());
