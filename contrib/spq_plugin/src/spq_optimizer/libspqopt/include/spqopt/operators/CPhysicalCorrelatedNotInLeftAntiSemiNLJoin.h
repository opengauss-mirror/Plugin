...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalCorrelatedNotInLeftAntiSemiNLJoin_H
#define SPQOPT_CPhysicalCorrelatedNotInLeftAntiSemiNLJoin_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalCorrelatedNotInLeftAntiSemiNLJoin ==
					pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalCorrelatedNotInLeftAntiSemiNLJoin_H
