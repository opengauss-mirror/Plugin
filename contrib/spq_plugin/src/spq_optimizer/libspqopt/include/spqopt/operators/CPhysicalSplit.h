...
//---------------------------------------------------------------------------
#ifndef SPQOS_CPhysicalSplit_H
#define SPQOS_CPhysicalSplit_H
...
public:
	// ctor
	CPhysicalSplit(CMemoryPool *mp, CColRefArray *pdrspqcrDelete,
	...
	{
		SPQOS_ASSERT(COperator::EopPhysicalSplit == pop->Eopid());
