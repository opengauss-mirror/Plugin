...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalCorrelatedInnerNLJoin_H
#define SPQOPT_CPhysicalCorrelatedInnerNLJoin_H
...
public:
	// ctor
	CPhysicalCorrelatedInnerNLJoin(CMemoryPool *mp, CColRefArray *pdrspqcrInner,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalCorrelatedInnerNLJoin == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalCorrelatedInnerNLJoin_H
