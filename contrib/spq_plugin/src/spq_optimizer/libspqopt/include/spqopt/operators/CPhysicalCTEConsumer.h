...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalCTEConsumer_H
#define SPQOPT_CPhysicalCTEConsumer_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalCTEConsumer == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalCTEConsumer_H
