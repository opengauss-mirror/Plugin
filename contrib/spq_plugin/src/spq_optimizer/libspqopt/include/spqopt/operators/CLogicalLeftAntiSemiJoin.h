...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalLeftAntiSemiJoin_H
#define SPQOS_CLogicalLeftAntiSemiJoin_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalLeftAntiSemiJoin == pop->Eopid());
...
#endif	// !SPQOS_CLogicalLeftAntiSemiJoin_H
