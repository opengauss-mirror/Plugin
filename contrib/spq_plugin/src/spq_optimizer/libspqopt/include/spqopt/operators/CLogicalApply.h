...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalApply_H
#define SPQOPT_CLogicalApply_H
...
protected:
	...
	// ctor
	CLogicalApply(CMemoryPool *mp, CColRefArray *pdrspqcrInner,
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(CUtils::FApply(pop));
