...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalIndexGet_H
#define SPQOPT_CLogicalIndexGet_H
...
public:
	...
	CLogicalIndexGet(CMemoryPool *mp, const IMDIndex *pmdindex,
					 ...
					 const CName *pnameAlias, CColRefArray *pdrspqcrOutput);
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalIndexGet == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalIndexGet_H
