...
//---------------------------------------------------------------------------
#ifndef SPQOS_CPhysicalAgg_H
#define SPQOS_CPhysicalAgg_H
...
protected:
	...
	CDistributionSpec *PdsRequiredAgg(CMemoryPool *mp,
									  ...
									  CColRefArray *pdrspqcgGrp,
									  CColRefArray *pdrspqcrGrpMinimal) const;

public:
	// ctor
	CPhysicalAgg(CMemoryPool *mp, CColRefArray *colref_array,
				 CColRefArray *pdrspqcrMinimal,	// FD's on grouping columns
				 COperator::EGbAggType egbaggtype, BOOL fGeneratesDuplicates,
				 CColRefArray *pdrspqcrArgDQA, BOOL fMultiStage,
	...
	{
		SPQOS_ASSERT(CUtils::FPhysicalAgg(pop));
