...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalLeftOuterJoin_H
#define SPQOS_CLogicalLeftOuterJoin_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalLeftOuterJoin == pop->Eopid());
...
#endif	// !SPQOS_CLogicalLeftOuterJoin_H
