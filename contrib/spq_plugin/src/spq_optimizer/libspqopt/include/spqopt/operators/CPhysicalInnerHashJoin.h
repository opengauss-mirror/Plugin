...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalInnerHashJoin_H
#define SPQOPT_CPhysicalInnerHashJoin_H
...
public:
	...
	{
		SPQOS_ASSERT(EopPhysicalInnerHashJoin == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalInnerHashJoin_H
