...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalLeftSemiApply_H
#define SPQOPT_CLogicalLeftSemiApply_H
...
public:
	...
	{
		m_pdrspqcrInner = SPQOS_NEW(mp) CColRefArray(mp);
	}

	// ctor
	CLogicalLeftSemiApply(CMemoryPool *mp, CColRefArray *pdrspqcrInner,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(CUtils::FLeftSemiApply(pop));
...
#endif	// !SPQOPT_CLogicalLeftSemiApply_H
