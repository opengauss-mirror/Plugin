...
//---------------------------------------------------------------------------
#ifndef SPQOS_CPhysicalHashAgg_H
#define SPQOS_CPhysicalHashAgg_H
...
public:
	...
	CPhysicalHashAgg(CMemoryPool *mp, CColRefArray *colref_array,
					 ...
					 BOOL fGeneratesDuplicates, CColRefArray *pdrspqcrArgDQA,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalHashAgg == pop->Eopid() ||
...
#endif	// !SPQOS_CPhysicalHashAgg_H
