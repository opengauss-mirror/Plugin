...
//                  +--CScalarConst (0)
//---------------------------------------------------------------------------
#ifndef SPQOPT_CScalarAssertConstraint_H
#define SPQOPT_CScalarAssertConstraint_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopScalarAssertConstraint == pop->Eopid());
...
#endif	// !SPQOPT_CScalarAssertConstraint_H
