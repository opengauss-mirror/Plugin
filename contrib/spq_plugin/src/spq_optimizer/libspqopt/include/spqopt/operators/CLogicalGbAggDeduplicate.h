...
//				+-- A.a1 <> B.b1
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalGbAggDeduplicate_H
#define SPQOS_CLogicalGbAggDeduplicate_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalGbAggDeduplicate == pop->Eopid());
...
#endif	// !SPQOS_CLogicalGbAggDeduplicate_H
