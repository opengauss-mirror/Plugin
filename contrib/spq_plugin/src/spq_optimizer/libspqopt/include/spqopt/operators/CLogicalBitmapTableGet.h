...
#ifndef SPQOPT_CLogicalBitmapTableGet_H
#define SPQOPT_CLogicalBitmapTableGet_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalBitmapTableGet == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalBitmapTableGet_H
