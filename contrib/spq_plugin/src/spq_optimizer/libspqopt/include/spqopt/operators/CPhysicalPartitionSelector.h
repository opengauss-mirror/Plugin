...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalPartitionSelector_H
#define SPQOPT_CPhysicalPartitionSelector_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalPartitionSelector == pop->Eopid() ||
...
#endif	// !SPQOPT_CPhysicalPartitionSelector_H
