...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalDifference_H
#define SPQOPT_CLogicalDifference_H
...
public:
	...
	CLogicalDifference(CMemoryPool *mp, CColRefArray *pdrspqcrOutput,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalDifference == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalDifference_H
