...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalIndexApply_H
#define SPQOPT_CLogicalIndexApply_H
...
public:
	// ctor
	CLogicalIndexApply(CMemoryPool *mp, CColRefArray *pdrspqcrOuterRefs,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalIndexApply == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalIndexApply_H
