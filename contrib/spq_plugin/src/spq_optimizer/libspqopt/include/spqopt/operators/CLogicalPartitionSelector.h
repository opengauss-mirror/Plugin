...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalPartitionSelector_H
#define SPQOPT_CLogicalPartitionSelector_H
...
private:
	...
	CExpressionArray *m_pdrspqexprFilters;
...
public:
	...
	UlPartLevels() const
	{
		return m_pdrspqexprFilters->Size();
	}
	...
	{
		return (*m_pdrspqexprFilters)[ulLevel];
	}
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalPartitionSelector == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalPartitionSelector_H
