...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalNLJoin_H
#define SPQOPT_CPhysicalNLJoin_H
...
public:
	...
	PppsRequired(CMemoryPool *mp, CExpressionHandle &exprhdl,
				 ...
				 CDrvdPropArray *pdrspqdpCtxt, ULONG ulOptReq)
	{
		SPQOS_ASSERT(ulOptReq < UlPartPropagateRequests());
	...
	{
		SPQOS_ASSERT(CUtils::FNLJoin(pop));
...
#endif	// !SPQOPT_CPhysicalNLJoin_H
