...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalLeftAntiSemiJoinNotIn_H
#define SPQOS_CLogicalLeftAntiSemiJoinNotIn_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalLeftAntiSemiJoinNotIn == pop->Eopid());
...
#endif	// !SPQOS_CLogicalLeftAntiSemiJoinNotIn_H
