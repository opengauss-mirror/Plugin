...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalLeftOuterApply_H
#define SPQOPT_CLogicalLeftOuterApply_H
...
public:
	...
	// ctor
	CLogicalLeftOuterApply(CMemoryPool *mp, CColRefArray *pdrspqcrInner,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalLeftOuterApply == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalLeftOuterApply_H
