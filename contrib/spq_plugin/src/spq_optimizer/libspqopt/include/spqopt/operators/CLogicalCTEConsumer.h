...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalCTEConsumer_H
#define SPQOPT_CLogicalCTEConsumer_H
...
public:
	...
	{
		SPQOS_ASSERT(!"CLogicalCTEConsumer has no children");
		return NULL;
	}
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalCTEConsumer == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalCTEConsumer_H
