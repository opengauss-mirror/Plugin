...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPredicateUtils_H
#define SPQOPT_CPredicateUtils_H
...
public:
	...
	static BOOL FContainsVolatileFunction(CExpressionArray *pdrspqexpr);
	...
	static CExpressionArray *PdrspqexprConjuncts(CMemoryPool *mp,
												CExpression *pexpr);

	// extract disjuncts from a scalar tree
	static CExpressionArray *PdrspqexprDisjuncts(CMemoryPool *mp,
												CExpression *pexpr);

	// extract equality predicates on scalar identifier from a list of scalar expressions
	static CExpressionArray *PdrspqexprPlainEqualities(
		CMemoryPool *mp, CExpressionArray *pdrspqexpr);
	...
	static CExpressionArray *PdrspqexprExpandDisjuncts(
		CMemoryPool *mp, CExpressionArray *pdrspqexprDisjuncts);

	// expand conjuncts in the given array by converting ArrayComparison to AND/OR tree and deduplicating resulting conjuncts
	static CExpressionArray *PdrspqexprExpandConjuncts(
		CMemoryPool *mp, CExpressionArray *pdrspqexprConjuncts);
	...
	static CExpressionArray *PdrspqexprAppendConjunctsDedup(
		CMemoryPool *mp, CExpressionArray *pdrspqexpr, CExpression *pexpr);
	...
	static CExpression *PexprIndexLookup(
		...
		const IMDIndex *pmdindex, CColRefArray *pdrspqcrIndex,
	...
	static BOOL FCompatiblePredicates(CExpressionArray *pdrspqexprPred,
									  const IMDIndex *pmdindex,
									  CColRefArray *pdrspqcrIndex,
									  CMDAccessor *md_accessor);
...
#endif	// !SPQOPT_CPredicateUtils_H
