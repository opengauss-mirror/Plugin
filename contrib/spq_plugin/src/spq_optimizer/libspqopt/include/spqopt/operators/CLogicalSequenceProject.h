...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalSequenceProject_H
#define SPQOS_CLogicalSequenceProject_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalSequenceProject == pop->Eopid());
...
#endif	// !SPQOS_CLogicalSequenceProject_H
