...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalInnerApply_H
#define SPQOPT_CLogicalInnerApply_H
...
public:
	...
	// ctor
	CLogicalInnerApply(CMemoryPool *mp, CColRefArray *pdrspqcrInner,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalInnerApply == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalInnerApply_H
