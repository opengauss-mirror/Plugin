...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CNormalizer_H
#define SPQOPT_CNormalizer_H
...
private:
	...
	// array of mappings
	static const SPushThru m_rspqt[];
	...
	static CExpression *PexprPullUpProjectElements(
		...
		CColRefSet *pcrsOutput, CExpressionArray **ppdrspqexprPrElPullUp);
