...
#ifndef SPQOPT_CScalarBitmapIndexProbe_H
#define SPQOPT_CScalarBitmapIndexProbe_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopScalarBitmapIndexProbe == pop->Eopid());
...
#endif	// !SPQOPT_CScalarBitmapIndexProbe_H
