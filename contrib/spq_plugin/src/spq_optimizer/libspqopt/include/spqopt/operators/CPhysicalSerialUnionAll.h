...
#ifndef SPQOPT_CPhysicalSerialUnionAll_H
#define SPQOPT_CPhysicalSerialUnionAll_H
...
public:
	// ctor
	CPhysicalSerialUnionAll(CMemoryPool *mp, CColRefArray *pdrspqcrOutput,
...
#endif	// !SPQOPT_CPhysicalSerialUnionAll_H
