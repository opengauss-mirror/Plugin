...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalComputeScalar_H
#define SPQOPT_CPhysicalComputeScalar_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalComputeScalar == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalComputeScalar_H
