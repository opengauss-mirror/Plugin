...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalRowTrigger_H
#define SPQOPT_CPhysicalRowTrigger_H
...
private:
	...
	// old columns
	CColRefArray *m_pdrspqcrOld;

	// new columns
	CColRefArray *m_pdrspqcrNew;
...
public:
	...
	CPhysicalRowTrigger(CMemoryPool *mp, IMDId *rel_mdid, INT type,
						CColRefArray *pdrspqcrOld, CColRefArray *pdrspqcrNew);
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalRowTrigger == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalRowTrigger_H
