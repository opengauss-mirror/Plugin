...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalLeftAntiSemiCorrelatedApply_H
#define SPQOPT_CLogicalLeftAntiSemiCorrelatedApply_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalLeftAntiSemiCorrelatedApply == pop->Eopid());
...
#endif	// !SPQOPT_CLogicalLeftAntiSemiCorrelatedApply_H
