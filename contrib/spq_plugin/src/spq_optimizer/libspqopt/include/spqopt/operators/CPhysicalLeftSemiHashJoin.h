...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalLeftSemiHashJoin_H
#define SPQOPT_CPhysicalLeftSemiHashJoin_H
...
public:
	...
	{
		SPQOS_ASSERT(EopPhysicalLeftSemiHashJoin == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalLeftSemiHashJoin_H
