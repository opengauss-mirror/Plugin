...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CExpressionHandle_H
#define SPQOPT_CExpressionHandle_H
...
private:
	...
	IStatisticsArray *m_pdrspqstat;

	// array of children's required properties
	CReqdPropArray *m_pdrspqrp;
	...
	IStatisticsArray *PdrspqstatOuterRefs(IStatisticsArray *statistics_array,
										 ULONG child_index);
...
public:
	...
	void ComputeChildReqdProps(ULONG child_index, CDrvdPropArray *pdrspqdpCtxt,
							   ULONG ulOptReq);
	...
	void ComputeChildReqdCols(ULONG child_index, CDrvdPropArray *pdrspqdpCtxt);
	...
	CFunctionalDependencyArray *Pdrspqfd(ULONG child_index);
...
#endif	// !SPQOPT_CExpressionHandle_H
