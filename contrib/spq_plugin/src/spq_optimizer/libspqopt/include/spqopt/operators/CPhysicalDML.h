...
//---------------------------------------------------------------------------
#ifndef SPQOS_CPhysicalDML_H
#define SPQOS_CPhysicalDML_H
...
public:
	...
	CPhysicalDML(CMemoryPool *mp, CLogicalDML::EDMLOperator edmlop,
				 CTableDescriptor *ptabdesc, CColRefArray *pdrspqcrSource,
	...
	PdrspqcrSource() const
	{
		return m_pdrspqcrSource;
	}
	...
	{
		SPQOS_ASSERT(COperator::EopPhysicalDML == pop->Eopid());
