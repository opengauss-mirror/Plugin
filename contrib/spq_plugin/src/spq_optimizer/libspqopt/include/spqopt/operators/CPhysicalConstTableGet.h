...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalConstTableGet_H
#define SPQOPT_CPhysicalConstTableGet_H
...
public:
	...
	CPhysicalConstTableGet(CMemoryPool *mp,
						   ...
						   IDatum2dArray *pdrspqdrspqconst,
	...
	{
		SPQOS_ASSERT(!"CPhysicalConstTableGet has no relational children");
		return NULL;
	}
	...
	) const
	{
		...
		return SPQOS_NEW(mp) CPartFilterMap(mp);
	}
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalConstTableGet == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalConstTableGet_H
