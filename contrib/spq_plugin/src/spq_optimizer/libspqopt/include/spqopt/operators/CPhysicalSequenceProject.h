...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalSequenceProject_H
#define SPQOPT_CPhysicalSequenceProject_H
...
private:
	...
	COrderSpecArray *m_pdrspqos;

	// frames of child window functions
	CWindowFrameArray *m_pdrspqwf;
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalSequenceProject == pop->Eopid());
...
#endif	// !SPQOPT_CPhysicalSequenceProject_H
