...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPhysicalTVF_H
#define SPQOPT_CPhysicalTVF_H
...
public:
	...
	CPhysicalTVF(CMemoryPool *mp, IMDId *mdid_func, IMDId *mdid_return_type,
				 CWStringConst *str, CColumnDescriptorArray *pdrspqcoldesc,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopPhysicalTVF == pop->Eopid());
