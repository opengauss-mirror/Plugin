...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CLogicalUpdate_H
#define SPQOPT_CLogicalUpdate_H
...
public:
	...
	CLogicalUpdate(CMemoryPool *mp, CTableDescriptor *ptabdesc,
				   CColRefArray *pdrspqcrDelete, CColRefArray *pdrspqcrInsert,
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalUpdate == pop->Eopid());
