...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalNAryJoin_H
#define SPQOS_CLogicalNAryJoin_H
...
private:
	...
	// (*m_lojChildPredIndexes)[i] in this array is 0 (SPQOPT_ZERO_INNER_JOIN_PRED_INDEX).
...
public:
	...
	{
		SPQOS_ASSERT(nary_join_expr->Pop() == this);
	...
	{
		SPQOS_ASSERT(nary_join_expr->Pop() == this);
		SPQOS_ASSERT(0 < *(*m_lojChildPredIndexes)[child_num]);
...
#endif	// !SPQOS_CLogicalNAryJoin_H
