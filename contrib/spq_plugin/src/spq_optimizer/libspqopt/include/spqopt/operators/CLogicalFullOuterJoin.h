...
//---------------------------------------------------------------------------
#ifndef SPQOS_CLogicalFullOuterJoin_H
#define SPQOS_CLogicalFullOuterJoin_H
...
public:
	...
	PopConvert(COperator *pop)
	{
		...
		SPQOS_ASSERT(EopLogicalFullOuterJoin == pop->Eopid());
...
#endif	// !SPQOS_CLogicalFullOuterJoin_H
