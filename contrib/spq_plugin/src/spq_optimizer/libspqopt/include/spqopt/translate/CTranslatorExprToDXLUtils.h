...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CTranslatorExprToDXLUtils_H
#define SPQOPT_CTranslatorExprToDXLUtils_H
...
private:
	...
	static CDXLNode *PdxlnPartialScanTestConjunction(
		CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory,
		CConstraint *pcnstr, CColRef2dArray *pdrspqdrspqcrPartKeys,
		BOOL fRangePart);
	...
	static CDXLDatum2dArray *PdrspqdrspqdxldatumFromDisjPointConstraint(
...
public:
	...
	static IDatumArray *PdrspqdatumNulls(CMemoryPool *mp,
										CColRefArray *colref_array);

	// map an array of columns to a new array of columns
	static CColRefArray *PdrspqcrMapColumns(CMemoryPool *mp,
...
#endif	// !SPQOPT_CTranslatorExprToDXLUtils_H
