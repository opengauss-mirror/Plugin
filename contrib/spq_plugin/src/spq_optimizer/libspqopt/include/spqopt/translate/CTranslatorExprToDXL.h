...
#ifndef SPQOPT_CTranslatorExprToDXL_H
#define SPQOPT_CTranslatorExprToDXL_H
...
private:
	...
	typedef CDXLNode *(CTranslatorExprToDXL::*PfPdxlnPhysical)(
		...
		CDistributionSpecArray *
			pdrspqdsBaseTables,	// output: array of base table hash distributions
		ULONG
	...
	IntPtrArray *m_pdrspqiSegments;

	// id of master node
	INT m_iMasterId;

	// scalar expression translators indexed by the operator id
	PfPdxlnScalar m_rspqfScalarTranslators[COperator::EopSentinel];

	// physical expression translators indexed by the operator id
	PfPdxlnPhysical m_rspqfPhysicalTranslators[COperator::EopSentinel];
    ...
    /* SPQ: for ShareScan */
    CDXLNode *PdxlnTblShareScan(CExpression *pexprTblScan,
                                CColRefSet *pcrsOutput,
                                CColRefArray *colref_array,
                                CDistributionSpecArray *pdrspqdsBaseTables,
                                CExpression *pexprScalarCond,
                                CDXLPhysicalProperties *dxl_properties);
    CDXLNode *PdxlnTblShareScanFromNLJoinOuter(CExpression *pexprRelational,
	...
	CDXLNode *PdxlnPartitionSelectorDML(
		CExpression *pexpr, CColRefArray *pdrspqc,
		CDistributionSpecArray *pdrspqdsBaseTables, ULONG *pulNonGatherMotions,
		BOOL *pfDMLr);
	...
	CDXLNode *PdxlnProjListFromConstTableGet(CColRefArray *pdrspqcrReqOutput,
											 CColRefArray *pdrspqcrCTGOutput,
	...
	CDXLNode *PdxlnHashExprList(const CExpressionArray *pdrspqexpr,
	...
	CColRefArray *PdrspqcrMerge(CMemoryPool *mp, CColRefArray *pdrspqcrOrder,
							   CColRefArray *pdrspqcrRequired);
	...
	// in subplan map
	void BuildScalarSubplans(CColRefArray *pdrspqcrInner,
	...
	CDXLNode *PdxlnQuantifiedSubplan(CColRefArray *pdrspqcrInner,
	...
	CDXLNode *PdxlnExistentialSubplan(CColRefArray *pdrspqcrInner,
									  CExpression *pexprCorrelatedNLJoin,
									  CDXLColRefArray *dxl_colref_array,
									  CDistributionSpecArray *pdrspqdsBaseTables,
									  ULONG *pulNonGatherMotions, BOOL *pfDML);
...
#endif	// !SPQOPT_CTranslatorExprToDXL_H
