...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CEnumeratorConfig_H
#define SPQOPT_CEnumeratorConfig_H
...
#define SPQOPT_UNBOUNDED_COST_THRESHOLD 0.0
...
public:
	...
	CEnumeratorConfig(CMemoryPool *mp, ULLONG plan_id, ULLONG ullSamples,
					  CDouble cost_threshold = SPQOPT_UNBOUNDED_COST_THRESHOLD);
	...
	{
		return (*m_pdrspqsp)[ulPos]->GetPlanId();
	}
	...
	FEnumerate() const
	{
		return SPQOS_FTRACE(EopttraceEnumeratePlans);
	}
	...
	FSample() const
	{
		return SPQOS_FTRACE(EopttraceSamplePlans);
	}
	...
	{
		return SPQOS_NEW(mp) CEnumeratorConfig(mp, plan_id, 0 /*ullSamples*/);
	}
...
#endif	// !SPQOPT_CEnumeratorConfig_H
