...
//		index gets
//---------------------------------------------------------------------------
#ifndef SPQOPT_CXformSelect2PartialDynamicIndexGet_H
#define SPQOPT_CXformSelect2PartialDynamicIndexGet_H
...
private:
	...
	CColRefSet *GetColRefSet(CMemoryPool *mp, spqopt::CLogicalGet *popGet,
...
#endif	// !SPQOPT_CXformSelect2PartialDynamicIndexGet_H
