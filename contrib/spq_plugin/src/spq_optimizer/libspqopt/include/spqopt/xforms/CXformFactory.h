...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CXformFactory_H
#define SPQOPT_CXformFactory_H
...
private:
	...
	typedef CHashMap<CHAR, CXform, spqos::HashValue<CHAR>, CXform::FEqualIds,
	...
	// range of all xforms
	CXform *m_rspqxf[CXform::ExfSentinel];
