...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CJoinOrder_H
#define SPQOPT_CJoinOrder_H
...
public:
	...
	struct SComponent : public CRefCount, public DbgPrintMixin<SComponent>
	{
		...
		// set of edges associated with this component (stored as indexes into m_rspqedge array)
		CBitSet *m_edge_set;
...
public:
	...
	CJoinOrder(CMemoryPool *mp, CExpressionArray *pdrspqexprComponents,
