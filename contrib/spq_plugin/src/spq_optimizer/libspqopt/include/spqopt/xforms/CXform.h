...
//		and implementation
//---------------------------------------------------------------------------
#ifndef SPQOPT_CXform_H
#define SPQOPT_CXform_H
...
#define SPQOPT_DISABLE_XFORM_TF(x) EopttraceDisableXformBase + x
#define SPQOPT_ENABLE_XFORM(x) SPQOS_UNSET_TRACE(SPQOPT_DISABLE_XFORM_TF(x))
#define SPQOPT_DISABLE_XFORM(x) SPQOS_SET_TRACE(SPQOPT_DISABLE_XFORM_TF(x))
#define SPQOPT_FENABLED_XFORM(x) !SPQOS_FTRACE(SPQOPT_DISABLE_XFORM_TF(x))
#define SPQOPT_FDISABLED_XFORM(x) SPQOS_FTRACE(SPQOPT_DISABLE_XFORM_TF(x))
...
public:
	...
	enum EXformId
	{
		...
		ExfExpandNAryJoinDP,
		ExfGet2TableScan,
        ExfGet2TableShareScan,  /* SPQ: for ShareScan */
        ...
        ExfIndexGet2ShareIndexScan, /* SPQ: for shareindexscan */
