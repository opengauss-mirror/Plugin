...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CXformJoin2IndexApplyGeneric_H
#define SPQOPT_CXformJoin2IndexApplyGeneric_H
	...
	explicit CXformJoin2IndexApplyGeneric(CMemoryPool *mp,
		...
		:  // pattern
		  CXformJoin2IndexApply(SPQOS_NEW(mp) CExpression(
			  ...
			  SPQOS_NEW(mp) CExpression(mp, SPQOS_NEW(mp) CPatternTree(
...
#endif	// !SPQOPT_CXformJoin2IndexApplyGeneric_H
