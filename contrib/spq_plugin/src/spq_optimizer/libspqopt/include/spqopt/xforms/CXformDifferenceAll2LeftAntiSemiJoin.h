...
//
//---------------------------------------------------------------------------
#ifndef SPQOPT_CXformDifferenceAll2LeftAntiSemiJoin_H
#define SPQOPT_CXformDifferenceAll2LeftAntiSemiJoin_H
...
#endif	// !SPQOPT_CXformDifferenceAll2LeftAntiSemiJoin_H
