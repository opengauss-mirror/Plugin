...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CXformLeftAntiSemiJoin2CrossProduct_H
#define SPQOPT_CXformLeftAntiSemiJoin2CrossProduct_H
...
#endif	// !SPQOPT_CXformLeftAntiSemiJoin2CrossProduct_H
