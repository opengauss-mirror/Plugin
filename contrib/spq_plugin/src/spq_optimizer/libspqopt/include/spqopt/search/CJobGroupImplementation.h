...
//		Implement group job
//---------------------------------------------------------------------------
#ifndef SPQOPT_CJobGroupImplementation_H
#define SPQOPT_CJobGroupImplementation_H
...
public:
	...
	PjConvert(CJob *pj)
	{
		...
		SPQOS_ASSERT(EjtGroupImplementation == pj->Ejt());
...
#endif	// !SPQOPT_CJobGroupImplementation_H
