...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CJob_H
#define SPQOPT_CJob_H
...
private:
	...
	UlpDecrRefs()
	{
		SPQOS_ASSERT(0 < m_ulpRefs && "Decrement counter from 0");
		return m_ulpRefs--;
	}
...
protected:
	...
	virtual ~CJob()
	{
		SPQOS_ASSERT_IMP(!ITask::Self()->HasPendingExceptions(), 0 == m_ulpRefs);
	}
