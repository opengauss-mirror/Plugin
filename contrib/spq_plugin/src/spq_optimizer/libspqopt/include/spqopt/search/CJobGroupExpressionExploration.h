...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CJobGroupExpressionExploration_H
#define SPQOPT_CJobGroupExpressionExploration_H
...
public:
	...
	PjConvert(CJob *pj)
	{
		...
		SPQOS_ASSERT(EjtGroupExpressionExploration == pj->Ejt());
...
#endif	// !SPQOPT_CJobGroupExpressionExploration_H
