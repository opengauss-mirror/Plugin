...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CJobGroupExpressionImplementation_H
#define SPQOPT_CJobGroupExpressionImplementation_H
...
public:
	...
	PjConvert(CJob *pj)
	{
		...
		SPQOS_ASSERT(EjtGroupExpressionImplementation == pj->Ejt());
...
#endif	// !SPQOPT_CJobGroupExpressionImplementation_H
