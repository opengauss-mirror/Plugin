...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CJobGroupExpressionOptimization_H
#define SPQOPT_CJobGroupExpressionOptimization_H
...
public:
	...
	PjConvert(CJob *pj)
	{
		...
		SPQOS_ASSERT(EjtGroupExpressionOptimization == pj->Ejt());
...
#endif	// !SPQOPT_CJobGroupExpressionOptimization_H
