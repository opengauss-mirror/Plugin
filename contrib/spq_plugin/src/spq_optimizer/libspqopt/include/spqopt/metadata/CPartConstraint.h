...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CPartConstraint_H
#define SPQOPT_CPartConstraint_H
...
typedef CHashMap<ULONG, CPartConstraint, spqos::HashValue<ULONG>,
				 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
				 CleanupRelease<CPartConstraint> >
	UlongToPartConstraintMap;

// map iterator
typedef CHashMapIter<ULONG, CPartConstraint, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CPartConstraint> >
...
private:
	...
	// partition keys
	CColRef2dArray *m_pdrspqdrspqcr;
...
#endif	// !SPQOPT_CPartConstraint_H
