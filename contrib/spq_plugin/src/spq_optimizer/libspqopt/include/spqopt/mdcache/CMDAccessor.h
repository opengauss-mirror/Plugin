...
#ifndef SPQOPT_CMDAccessor_H
#define SPQOPT_CMDAccessor_H
...
//		is available in the cache, it goes to a CMDProvider (e.g., SPQDB
...
public:
	...
	void RegisterProviders(const CSystemIdArray *pdrspqsysid,
						   const CMDProviderArray *pdrspqmdp);
