...
//
//	@filename:
//		CCostModelParamsSPQDB.h
//
//	@doc:
//		Parameters in SPQDB cost model
//---------------------------------------------------------------------------
#ifndef SPQDBCOST_CCostModelParamsSPQDB_H
#define SPQDBCOST_CCostModelParamsSPQDB_H
...
//---------------------------------------------------------------------------
//	@class:
//		CCostModelParamsSPQDB
//
//	@doc:
//		Parameters in SPQDB cost model
//
//---------------------------------------------------------------------------
class CCostModelParamsSPQDB : public ICostModelParams,
							 public DbgPrintMixin<CCostModelParamsSPQDB>
{
public:
	...
	enum ECostParam
	{
        ...
        EcpSPQTableShareScanFactor, /* SPQ: for ShareScan */
        EcpSPQShareIndexScanFactor, /* SPQ: for shareindexscan */

        EcpHJInnerCostFactor, /* SPQ: for HashJoin InnerCost*/
		EcpSentinel
	};
...
private:
    ...
    /* SPQ: for ShareScan */
    static const CDouble DSPQTableShareScanFactor;
    /* SPQ: for shareindexscan */
    static const CDouble DSPQShareIndexScanFactor;
    /* SPQ: for HashJoin InnerCost*/
    static const CDouble DSPQHJInnerCostFactor;
...
public:
	// ctor
	explicit CCostModelParamsSPQDB(CMemoryPool *mp);

	// dtor
	virtual ~CCostModelParamsSPQDB();
...
};	// class CCostModelParamsSPQDB

}  // namespace spqopt

#endif	// !SPQDBCOST_CCostModelParamsSPQDB_H
