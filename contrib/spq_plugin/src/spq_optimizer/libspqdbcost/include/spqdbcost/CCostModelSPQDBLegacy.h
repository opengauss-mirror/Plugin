...
//
//	@filename:
//		CCostModelSPQDBLegacy.h
//
//	@doc:
//		SPQDB's legacy (uncalibrated) cost model
//---------------------------------------------------------------------------
#ifndef SPQDBCOST_CCostModelSPQDBLegacy_H
#define SPQDBCOST_CCostModelSPQDBLegacy_H
...
//---------------------------------------------------------------------------
//	@class:
//		CCostModelSPQDBLegacy
//
//	@doc:
//		SPQDB's legacy cost model
//
//---------------------------------------------------------------------------
class CCostModelSPQDBLegacy : public ICostModel
{
private:
	// definition of operator processor
	typedef CCost(FnCost)(CMemoryPool *, CExpressionHandle &,
						  const CCostModelSPQDBLegacy *, const SCostingInfo *);
	...
	CCostModelParamsSPQDBLegacy *m_cost_model_params;
...
public:
	// ctor
	CCostModelSPQDBLegacy(CMemoryPool *mp, ULONG ulSegments,
						 ICostModelParamsArray *pdrspqcp = NULL);

	// dtor
	virtual ~CCostModelSPQDBLegacy();
	...
	Ecmt() const
	{
		return ICostModel::EcmtSPQDBLegacy;
	}

};	// class CCostModelSPQDBLegacy

}  // namespace spqdbcost

#endif	// !SPQDBCOST_CCostModelSPQDBLegacy_H
