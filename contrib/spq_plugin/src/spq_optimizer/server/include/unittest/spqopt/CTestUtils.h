...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CTestUtils_H
#define SPQOPT_CTestUtils_H
...
#define SPQOPT_MDCACHE_TEST_OID 1234
#define SPQOPT_MDCACHE_TEST_OID_PARTITIONED 5678
#define SPQOPT_MDCACHE_TEST_OID_PARTITIONED_WITH_INDEXES 5369655
#define SPQOPT_TEST_REL_WIDTH 3	// number of columns in generated test relations
#define SPQOPT_TEST_PART_INDEX 1234567

#define SPQOPT_TEST_REL_OID1 OID(11111)
#define SPQOPT_TEST_REL_OID2 OID(22222)
#define SPQOPT_TEST_REL_OID3 OID(33333)
#define SPQOPT_TEST_REL_OID4 OID(44444)
#define SPQOPT_TEST_REL_OID5 OID(55555)
#define SPQOPT_TEST_REL_OID6 OID(66666)
#define SPQOPT_TEST_REL_OID7 OID(77777)
#define SPQOPT_TEST_REL_OID8 OID(88888)
#define SPQOPT_TEST_REL_OID9 OID(99999)
#define SPQOPT_TEST_REL_OID10 OID(10000)
#define SPQOPT_TEST_REL_OID11 OID(10111)
#define SPQOPT_TEST_REL_OID12 OID(10222)
#define SPQOPT_TEST_REL_OID13 OID(10333)
#define SPQOPT_TEST_REL_OID14 OID(10444)
#define SPQOPT_TEST_REL_OID15 OID(10555)
#define SPQOPT_TEST_REL_OID16 OID(10666)
#define SPQOPT_TEST_REL_OID17 OID(10777)
#define SPQOPT_TEST_REL_OID18 OID(10888)
#define SPQOPT_TEST_REL_OID19 OID(10999)
#define SPQOPT_TEST_REL_OID20 OID(10200)
#define SPQOPT_TEST_REL_OID21 OID(10311)
#define SPQOPT_TEST_REL_OID22 OID(27118)

#define SPQDB_INT4_LT_OP OID(97)
#define SPQDB_INT4_EQ_OP OID(96)
#define SPQDB_INT4_NEQ_OP OID(518)
#define SPQDB_INT4_SUM_AGG OID(2114)
#define SPQDB_INT8_GENERATE_SERIES OID(1067)
...
private:
	...
	static spqdxl::IntPtrArray *PdrspqiSegments(CMemoryPool *mp);
...
public:
	...
	static CExpression *PexprLogicalSelectArrayCmp(
		CMemoryPool *mp, CScalarArrayCmp::EArrCmpType earrcmptype,
		IMDType::ECmpType ecmptype, const IntPtrArray *pdrspqiVals);
	...
	static CExpressionJoinsArray *PdrspqexprJoins(CMemoryPool *mp,
												 CWStringConst *pstrRel,
												 ULONG *pulRel, ULONG ulRels,
												 BOOL fCrossProduct);
	...
	static SPQOS_RESULT EresTranslate(CMemoryPool *mp,
	...
	static SPQOS_RESULT EresCompare(IOstream &os, CWStringDynamic *pstrActual,
	...
	static SPQOS_RESULT EresRunMinidumps(
	...
	static SPQOS_RESULT EresRunMinidumpsUsingOneMDFile(
	...
	static SPQOS_RESULT EresRunMinidump(
	...
	// test plan sampling
	static SPQOS_RESULT EresSamplePlans(const CHAR *rgszFileNames[],
	...
	static SPQOS_RESULT EresCheckPlans(const CHAR *rgszFileNames[],
									  ULONG ulTests, ULONG *pulTestCounter,
									  ULONG ulSessionId, ULONG ulCmdId,
									  FnPlanChecker *pfpc);
	...
	// does not take ownership of pdrspqcp
	static SPQOS_RESULT EresCheckOptimizedPlan(const CHAR *rgszFileNames[],
											  ULONG ulTests,
	...
	{
		return SPQOS_NEW(mp) CCostModelSPQDB(mp, SPQOPT_TEST_SEGMENTS);
	}
	...
	static CConstraintInterval *PciGenericInterval(
		CMemoryPool *mp, CMDAccessor *md_accessor, const CMDIdSPQDB &mdidType,
	...
	static SPQOS_RESULT EresUnittest_RunTests(const CHAR **rgszFileNames,
											 ULONG *pulTestCounter,
											 ULONG ulTests);
...
CTestUtils::PexprJoinPartitioned(CMemoryPool *mp, BOOL fOuterPartitioned)
{
	...
	const CColRef2dArray *pdrspqdrspqcr =
		popGetPartitioned->PdrspqdrspqcrPartColumns();
...
CTestUtils::PexprLogicalApply(CMemoryPool *mp)
{
	...
	COperator *pop = SPQOS_NEW(mp) T(mp);
	return SPQOS_NEW(mp)
