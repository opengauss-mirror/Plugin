...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CFilterCardinalityTest_H
#define SPQNAUCRATES_CFilterCardinalityTest_H
...
private:
	...
	static SPQOS_RESULT EresUnittest_CStatistics(
	...
	static CStatsPredPtrArry *PdrspqstatspredInteger(
	...
	static CStatsPredPtrArry *PdrspqpredfilterNumeric(
	...
	static SPQOS_RESULT EresUnittest_CStatisticsCompare(
...
public:
	...
	static SPQOS_RESULT EresUnittest_CStatisticsFilter();

	// testing ArryCmpAny predicates
	static SPQOS_RESULT EresUnittest_CStatisticsFilterArrayCmpAny();

	// testing nested AND / OR predicates
	static SPQOS_RESULT EresUnittest_CStatisticsNestedPred();

	// test disjunctive filter
	static SPQOS_RESULT EresUnittest_CStatisticsFilterDisj();

	// test conjunctive filter
	static SPQOS_RESULT EresUnittest_CStatisticsFilterConj();

	// DXL based test on numeric data types
	static SPQOS_RESULT EresUnittest_CStatisticsBasicsFromDXLNumeric();

	// basic statistics parsing
	static SPQOS_RESULT EresUnittest_CStatisticsBasicsFromDXL();

	// test for accumulating cardinality in disjunctive and conjunctive predicates
	static SPQOS_RESULT EresUnittest_CStatisticsAccumulateCard();

};	// class CFilterCardinalityTest
}  // namespace spqnaucrates

#endif	// !SPQNAUCRATES_CFilterCardinalityTest_H
