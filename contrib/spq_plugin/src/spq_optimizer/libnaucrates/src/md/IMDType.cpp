...
IMDType::GetCmpTypeStr(IMDType::ECmpType cmp_type)
{
	...
	SPQOS_ASSERT(IMDType::EcmptOther + 1 == SPQOS_ARRAY_SIZE(dxl_token_array));
...
{
	SPQOS_ASSERT(NULL != mdtype_first);
	SPQOS_ASSERT(NULL != mdtype_second);
...
{
	SPQOS_ASSERT(NULL != mdtype_first);
	SPQOS_ASSERT(NULL != datum_second);
