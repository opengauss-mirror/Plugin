...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::CMDRelationSPQDB
//
//	@doc:
//		Ctor
//
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		else
		{
			...
			(void) m_colpos_nondrop_colpos_map->Insert(
				...
				SPQOS_NEW(m_mp) ULONG(non_dropped_col_pos));
			non_dropped_col_pos++;
		}
...
//---------------------------------------------------------------------------
BOOL
CMDRelationSPQDB::IsTemporary() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::RetrieveRelStorageType
//
//	@doc:
...
CMDRelationSPQDB::RetrieveRelStorageType() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::GetRelDistribution
//
//	@doc:
...
CMDRelationSPQDB::GetRelDistribution() const
{
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::ColumnCount() const
{
...
DOUBLE
CMDRelationSPQDB::ColWidth(ULONG pos) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::HasDroppedColumns
//
//	@doc:
...
//---------------------------------------------------------------------------
BOOL
CMDRelationSPQDB::HasDroppedColumns() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::NonDroppedColsCount
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::NonDroppedColsCount() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::NonDroppedColAt
//
//	@doc:
//		Return the absolute position of the given attribute position excluding
//		dropped columns
//
//		If pos is a dropped column then return spqos::ulong_max.
//
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::NonDroppedColAt(ULONG pos) const
{
	...
	return colid ? *colid : spqos::ulong_max;
}

//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::GetPosFromAttno
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::GetPosFromAttno(INT attno) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::NonDroppedColsArray
//
//	@doc:
...
//---------------------------------------------------------------------------
ULongPtrArray *
CMDRelationSPQDB::NonDroppedColsArray() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::SystemColumnsCount
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::SystemColumnsCount() const
{
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::KeySetCount() const
{
...
//---------------------------------------------------------------------------
const ULongPtrArray *
CMDRelationSPQDB::KeySetAt(ULONG pos) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::DistrColumnCount
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::DistrColumnCount() const
{
...
//---------------------------------------------------------------------------
BOOL
CMDRelationSPQDB::HasOids() const
{
	return m_has_oids;
}
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::IsPartitioned
//
//	@doc:
...
//---------------------------------------------------------------------------
BOOL
CMDRelationSPQDB::IsPartitioned() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::PartitionCount
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::PartitionCount() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::PartColumnCount
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::PartColumnCount() const
{
...
CharPtrArray *
CMDRelationSPQDB::GetPartitionTypes() const
{
...
CHAR
CMDRelationSPQDB::PartTypeAtLevel(ULONG ulLevel) const
{
...
//---------------------------------------------------------------------------
const IMDColumn *
CMDRelationSPQDB::PartColAt(ULONG pos) const
{
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::IndexCount() const
{
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::TriggerCount() const
{
...
//---------------------------------------------------------------------------
const IMDColumn *
CMDRelationSPQDB::GetMdCol(ULONG pos) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::GetDistrColAt
//
//	@doc:
...
//---------------------------------------------------------------------------
const IMDColumn *
CMDRelationSPQDB::GetDistrColAt(ULONG pos) const
{
...
IMDId *
CMDRelationSPQDB::GetDistrOpfamilyAt(ULONG pos) const
{
...
//---------------------------------------------------------------------------
IMDId *
CMDRelationSPQDB::IndexMDidAt(ULONG pos) const
{
...
BOOL
CMDRelationSPQDB::IsPartialIndex(IMDId *mdid) const
{
	...
	{
		if (CMDIdSPQDB::MDIdCompare(IndexMDidAt(ul), mdid))
		{
	...
	// Not found
	SPQOS_RAISE(ExmaMD, ExmiMDCacheEntryNotFound, mdid->GetBuffer());
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::TriggerMDidAt
//
//	@doc:
...
//---------------------------------------------------------------------------
IMDId *
CMDRelationSPQDB::TriggerMDidAt(ULONG pos) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::CheckConstraintCount
//
//	@doc:
...
//---------------------------------------------------------------------------
ULONG
CMDRelationSPQDB::CheckConstraintCount() const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::CheckConstraintMDidAt
//
//	@doc:
...
//---------------------------------------------------------------------------
IMDId *
CMDRelationSPQDB::CheckConstraintMDidAt(ULONG pos) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CMDRelationSPQDB::MDPartConstraint
//
//	@doc:
...
//---------------------------------------------------------------------------
IMDPartConstraint *
CMDRelationSPQDB::MDPartConstraint() const
{
...
IMdIdArray *
CMDRelationSPQDB::GetExternalPartitions() const
{
...
//---------------------------------------------------------------------------
void
CMDRelationSPQDB::Serialize(CXMLSerializer *xml_serializer) const
{
	SPQOS_CHECK_ABORT;
	...
	if (EreldistrHash == m_rel_distr_policy)
	{
		...
		xml_serializer->AddAttribute(
			...
			distr_col_str_array);
		SPQOS_DELETE(distr_col_str_array);
	}
	...
	if (IsPartitioned())
	{
		...
		SPQOS_DELETE(part_keys_str_array);
	}
	...
	if (m_str_part_types_array)
	{
		...
		SPQOS_DELETE(part_types_str_array);
	}
...
//---------------------------------------------------------------------------
void
CMDRelationSPQDB::DebugPrint(IOstream &os) const
{
	os << "Relation id: ";
	MDId()->OsPrint(os);
	os << std::endl;
