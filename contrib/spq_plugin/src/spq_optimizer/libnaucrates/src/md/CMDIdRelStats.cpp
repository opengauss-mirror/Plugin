...
//
//---------------------------------------------------------------------------
CMDIdRelStats::CMDIdRelStats(CMDIdSPQDB *rel_mdid)
	: m_rel_mdid(rel_mdid), m_str(m_mdid_array, SPQOS_ARRAY_SIZE(m_mdid_array))
{
...
CMDIdRelStats::Serialize()
{
	...
	m_str.AppendFormat(SPQOS_WSZ_LIT("%d.%d.%d.%d"), MdidType(),
