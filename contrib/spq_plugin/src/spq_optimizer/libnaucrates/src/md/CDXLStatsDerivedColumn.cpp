...
{
	SPQOS_ASSERT(0 <= m_width);
	SPQOS_ASSERT(0 <= m_null_freq);
	SPQOS_ASSERT(0 <= m_distinct_remaining);
	SPQOS_ASSERT(0 <= m_freq_remaining);
	SPQOS_ASSERT(NULL != m_dxl_stats_bucket_array);
}
