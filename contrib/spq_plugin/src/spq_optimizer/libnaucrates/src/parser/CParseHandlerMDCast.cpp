...
{
	if (0 !=
		XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenSPQDBCast),
								 element_local_name))
	{
	...
	const XMLCh *xml_str_func_name = CDXLOperatorFactory::ExtractAttrValue(
		attrs, EdxltokenName, EdxltokenSPQDBCast);
