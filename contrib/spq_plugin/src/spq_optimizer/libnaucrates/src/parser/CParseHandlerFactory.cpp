...
CParseHandlerFactory::Init(CMemoryPool *mp)
{
	...
	SParseHandlerMapping token_parse_handler_map[] = {
		...
		{EdxltokenSPQDBScalarOp, &CreateMDScalarOpParseHandler},
		{EdxltokenSPQDBFunc, &CreateMDFuncParseHandler},
		{EdxltokenSPQDBAgg, &CreateMDAggParseHandler},
		{EdxltokenSPQDBTrigger, &CreateMDTriggerParseHandler},
		...
		{EdxltokenSPQDBCast, &CreateMDCastParseHandler},
		{EdxltokenSPQDBMDScCmp, &CreateMDScCmpParseHandler},
		{EdxltokenSPQDBArrayCoerceCast, &CreateMDArrayCoerceCastParseHandler},
	...
	const ULONG num_of_parse_handlers =
		SPQOS_ARRAY_SIZE(token_parse_handler_map);
									  ...
									  CParseHandlerBase *parse_handler_root)
{
	...
	SPQOS_RAISE(spqdxl::ExmaDXL, spqdxl::ExmiDXLUnrecognizedOperator,
			   str->GetBuffer());
...
{
	return SPQOS_NEW(mp) CParseHandlerDXL(mp, parse_handler_mgr);
}
...
CParseHandlerFactory::CreateEnumeratorCfgParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerEnumeratorConfig(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateStatisticsCfgParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerStatisticsConfig(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateMDRelationExtParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerMDRelationExternal(mp, parse_handler_mgr,
														parse_handler_root);
}
...
// creates a parse handler for parsing SPQDB type metadata
CParseHandlerBase *
...
// creates a parse handler for parsing SPQDB-specific operator metadata
CParseHandlerBase *
...
{
	return SPQOS_NEW(mp)
		CParseHandlerMDSPQDBScalarOp(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing SPQDB-specific function metadata
CParseHandlerBase *
...
{
	return SPQOS_NEW(mp)
		CParseHandlerMDSPQDBFunc(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing SPQDB-specific aggregate metadata
CParseHandlerBase *
...
{
	return SPQOS_NEW(mp)
		CParseHandlerMDSPQDBAgg(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing SPQDB-specific trigger metadata
CParseHandlerBase *
...
{
	return SPQOS_NEW(mp)
		CParseHandlerMDSPQDBTrigger(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing SPQDB-specific cast metadata
CParseHandlerBase *
...
// creates a parse handler for parsing SPQDB-specific scalar comparison metadata
CParseHandlerBase *
...
CParseHandlerFactory::CreateColDefaultValExprParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerDefaultValueExpr(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateBitmapTableScanParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerPhysicalBitmapTableScan(
...
CParseHandlerFactory::CreateDynBitmapTableScanParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerPhysicalDynamicBitmapTableScan(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateDTSParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerDynamicTableScan(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateDynamicIdxScanParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerDynamicIndexScan(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreatePartitionSelectorParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerPartitionSelector(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateLimitCountParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarLimitCount(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateScBitmapBoolOpParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarBitmapBoolOp(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateScArrayRefIdxListParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarArrayRefIndexList(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScAssertConstraintListParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarAssertConstraintList(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScPartDefaultParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarPartDefault(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateScPartBoundInclParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarPartBoundInclusion(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScPartBoundOpenParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarPartBoundOpen(mp, parse_handler_mgr,
														 parse_handler_root);
}
...
CParseHandlerFactory::CreateScPartListValuesParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarPartListValues(mp, parse_handler_mgr,
														  parse_handler_root);
}
...
CParseHandlerFactory::CreateScPartListNullTestParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarPartListNullTest(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateDirectDispatchParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerDirectDispatchInfo(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateLimitOffsetParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarLimitOffset(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateRedistributeMotionParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerRedistributeMotion(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateBooleanTestParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarBooleanTest(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateScCoerceToDomainParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarCoerceToDomain(mp, parse_handler_mgr,
														  parse_handler_root);
}
...
CParseHandlerFactory::CreateScCoerceViaIOParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarCoerceViaIO(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateScArrayCoerceExprParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarArrayCoerceExpr(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScSubPlanTestExprParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSubPlanTestExpr(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScSubPlanParamListParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSubPlanParamList(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScSubPlanParamParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSubPlanParam(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateScSwitchCaseParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSwitchCase(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateScConstValueParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarConstValue(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateBitmapIdxProbeParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarBitmapIndexProbe(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateLogicalExtGetParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerLogicalExternalGet(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateLogicalCTEProdParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerLogicalCTEProducer(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateLogicalCTEConsParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerLogicalCTEConsumer(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateLogicalCTEAnchorParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerLogicalCTEAnchor(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateLogicalConstTableParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerLogicalConstTable(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateScScalarSubqueryQuantifiedParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSubqueryQuantified(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScScalarSubqueryExistsParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSubqueryExists(mp, parse_handler_mgr,
														  parse_handler_root);
}
...
CParseHandlerFactory::CreateStatsDrvdRelParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerStatsDerivedRelation(mp, parse_handler_mgr,
														  parse_handler_root);
}
...
CParseHandlerFactory::CreateStatsDrvdColParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerStatsDerivedColumn(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateCTASOptionsParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerCtasStorageOptions(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreatePhysicalCTEProdParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerPhysicalCTEProducer(mp, parse_handler_mgr,
														 parse_handler_root);
}
...
CParseHandlerFactory::CreatePhysicalCTEConsParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerPhysicalCTEConsumer(mp, parse_handler_mgr,
														 parse_handler_root);
}
...
CParseHandlerFactory::CreatePhysicalRowTriggerParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerPhysicalRowTrigger(mp, parse_handler_mgr,
														parse_handler_root);
}
...
CParseHandlerFactory::CreateFrameTrailingEdgeParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarWindowFrameEdge(
...
// creates a parse handler for parsing SPQDB-specific check constraint
CParseHandlerBase *
CParseHandlerFactory::CreateMDChkConstraintParseHandler(
	CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerMDSPQDBCheckConstraint(
		mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerFactory::CreateScValuesListParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarValuesList(mp, parse_handler_mgr,
													  parse_handler_root);
}
...
CParseHandlerFactory::CreateScSortGroupClauseParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerScalarSortGroupClause(
		mp, parse_handler_mgr, parse_handler_root);
}
...
// creates a parse handler for parsing SPQDB-specific array coerce cast metadata
CParseHandlerBase *
CParseHandlerFactory::CreateMDArrayCoerceCastParseHandler(
	CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerMDArrayCoerceCast(mp, parse_handler_mgr,
													   parse_handler_root);
}
...
CParseHandlerFactory::CreateNLJIndexParamListParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerNLJIndexParamList(
...
CParseHandlerFactory::CreateNLJIndexParamParseHandler(
	...
	CParseHandlerBase *parse_handler_root)
{
	return SPQOS_NEW(mp) CParseHandlerNLJIndexParam(mp, parse_handler_manager,
												   parse_handler_root);
}
...
CParseHandlerFactory::CreateTableShareScanParseHandler(
    ...
    CParseHandlerBase *parse_handler_root)
{
    return SPQOS_NEW(mp) CParseHandlerTableShareScan(mp, parse_handler_mgr, parse_handler_root);
}
/* SPQ: for shareindexscan */
CParseHandlerBase *
CParseHandlerFactory::CreateShareIndexScanParseHandler(
    ...
    CParseHandlerBase *parse_handler_root)
{
    return SPQOS_NEW(mp) CParseHandlerShareIndexScan(mp, parse_handler_mgr, parse_handler_root);
}
// EOF
