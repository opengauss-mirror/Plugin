									   ...
									   const Attributes &attrs)
{
	...
	SPQOS_ASSERT(IMDId::EmdidSPQDBCtas == m_mdid->MdidType());
...
)
{
	...
	SPQOS_ASSERT(NULL != opfamilies_parse_handler->GetMdIdArray());
	...
	m_dxl_node = SPQOS_NEW(m_mp) CDXLNode(
		m_mp,
		SPQOS_NEW(m_mp) CDXLLogicalCTAS(
