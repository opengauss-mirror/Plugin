									 ...
									 Edxltoken token_type)
{
	...
	{
		m_dxl_op = SPQOS_NEW(m_mp) CDXLPhysicalTableScan(m_mp);
	}
	else
	{
		SPQOS_ASSERT(EdxltokenPhysicalExternalScan == token_type);
		m_dxl_op = SPQOS_NEW(m_mp) CDXLPhysicalExternalScan(m_mp);
	}
