										 ...
										 const Attributes &attrs)
{
	...
	m_pdrspqul = CDXLOperatorFactory::ExtractIntsToUlongArray(
...
)
{
	...
	SPQOS_ASSERT(NULL != pphTabDesc->GetDXLTableDescr());
	...
	m_dxl_node = SPQOS_NEW(m_mp) CDXLNode(
		m_mp, SPQOS_NEW(m_mp) CDXLLogicalInsert(m_mp, table_descr, m_pdrspqul));
