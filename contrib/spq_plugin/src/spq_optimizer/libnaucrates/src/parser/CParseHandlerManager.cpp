...
#define SPQDXL_PARSE_CFA_FREQUENCY 50
...
{
	m_parse_handler_stack = SPQOS_NEW(dxl_memory_manager->Pmp())
...
CParseHandlerManager::~CParseHandlerManager()
{
	SPQOS_DELETE(m_parse_handler_stack);
}
	...
	CParseHandlerBase *parse_handler_base)
{
	...
	SPQOS_ASSERT(NULL != parse_handler_base);
									 ...
									 CParseHandlerBase *parse_handler_root)
{
	...
	SPQOS_ASSERT(NULL != m_curr_parse_handler);
	SPQOS_ASSERT(NULL != parse_handler_base);
...
CParseHandlerManager::CheckForAborts()
{
	...
	if (SPQDXL_PARSE_CFA_FREQUENCY < m_iteration_since_last_abortcheck)
	{
		SPQOS_CHECK_ABORT;
		m_iteration_since_last_abortcheck = 0;
	}
