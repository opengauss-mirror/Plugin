								   ...
								   BOOL validate_children) const
{
	...
	SPQOS_ASSERT(EdxlmjIndexSentinel == dxlnode->Arity());
	SPQOS_ASSERT(EdxljtSentinel > GetJoinType());
	...
	SPQOS_ASSERT(EdxlopScalarJoinFilter ==
				dxlnode_join_filter->GetOperator()->GetDXLOperator());
	SPQOS_ASSERT(EdxlopScalarMergeCondList ==
