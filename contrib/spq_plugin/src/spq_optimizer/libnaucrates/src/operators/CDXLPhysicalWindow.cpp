	  ...
	  m_dxl_window_key_array(window_key_array)
{
	...
	SPQOS_ASSERT(NULL != m_dxl_window_key_array);
}
...
{
	SPQOS_ASSERT(position <= m_dxl_window_key_array->Size());
								...
								BOOL validate_children) const
{
	...
	SPQOS_ASSERT(NULL != m_part_by_colid_array);
	SPQOS_ASSERT(NULL != m_dxl_window_key_array);
	SPQOS_ASSERT(EdxlwindowIndexSentinel == dxlnode->Arity());
