...
{
	m_dxl_array = SPQOS_NEW(mp) CDXLNodeArray(mp);
}
...
{
	SPQOS_ASSERT(NULL != dxl_op);
	SPQOS_ASSERT(NULL != child_dxlnode);
...
{
	SPQOS_ASSERT(NULL != dxl_op);
	SPQOS_ASSERT(NULL != first_child_dxlnode);
	SPQOS_ASSERT(NULL != second_child_dxlnode);
	  ...
	  m_direct_dispatch_info(NULL)
{
	...
	SPQOS_ASSERT(NULL != first_child_dxlnode);
	SPQOS_ASSERT(NULL != second_child_dxlnode);
	SPQOS_ASSERT(NULL != third_child_dxlnode);
...
CDXLNode::SetProperties(CDXLProperties *dxl_properties)
{
	...
	SPQOS_ASSERT(NULL == m_dxl_properties);
	...
	CDXLDirectDispatchInfo *dxl_direct_dispatch_info)
{
	...
	SPQOS_ASSERT(NULL == m_direct_dispatch_info);
	SPQOS_ASSERT(NULL != dxl_direct_dispatch_info);
