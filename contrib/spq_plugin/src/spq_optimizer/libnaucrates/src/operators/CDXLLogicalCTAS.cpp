...
{
	SPQOS_ASSERT(NULL != mdid && mdid->IsValid());
	SPQOS_ASSERT(NULL != mdname_rel);
	SPQOS_ASSERT(NULL != dxl_col_descr_array);
	SPQOS_ASSERT(NULL != dxl_ctas_storage_options);
	SPQOS_ASSERT_IFF(IMDRelation::EreldistrHash == rel_distr_policy,
					NULL != distr_column_pos_array);
	SPQOS_ASSERT(NULL != src_colids_array);
	SPQOS_ASSERT(NULL != vartypemod_array);
	SPQOS_ASSERT(dxl_col_descr_array->Size() == vartypemod_array->Size());
	SPQOS_ASSERT(IMDRelation::ErelstorageSentinel > rel_storage_type);
	SPQOS_ASSERT(IMDRelation::EreldistrSentinel > rel_distr_policy);
	SPQOS_ASSERT(NULL == m_distr_column_pos_array ||
								...
								const CDXLNode *dxlnode) const
{
	...
	SPQOS_ASSERT(NULL != IMDRelation::GetStorageTypeStr(m_rel_storage_type));
	xml_serializer->AddAttribute(
