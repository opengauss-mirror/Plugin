									  ...
									  BOOL validate_children) const
{
	...
	SPQOS_ASSERT(EdxlsubqscanIndexSentinel == dxlnode->Arity());
	...
	SPQOS_ASSERT(NULL != m_mdname_alias);
	SPQOS_ASSERT(m_mdname_alias->GetMDName()->IsValid());
}
#endif	// SPQOS_DEBUG
