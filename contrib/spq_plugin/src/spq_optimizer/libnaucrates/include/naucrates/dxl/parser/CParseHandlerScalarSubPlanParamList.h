...
#ifndef SPQDXL_CParseHandlerScalarSubPlanParamList_H
#define SPQDXL_CParseHandlerScalarSubPlanParamList_H
...
#endif	// SPQDXL_CParseHandlerScalarSubPlanParamList_H
