...
#ifndef SPQDXL_CDXLScalarCoerceViaIO_H
#define SPQDXL_CDXLScalarCoerceViaIO_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarCoerceViaIO == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarCoerceViaIO_H
