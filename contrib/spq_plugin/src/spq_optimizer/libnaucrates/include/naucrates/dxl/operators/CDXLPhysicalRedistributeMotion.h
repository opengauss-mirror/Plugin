...
#ifndef SPQDXL_CDXLPhysicalRedistributeMotion_H
#define SPQDXL_CDXLPhysicalRedistributeMotion_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalMotionRedistribute ==
...
#endif	// !SPQDXL_CDXLPhysicalRedistributeMotion_H
