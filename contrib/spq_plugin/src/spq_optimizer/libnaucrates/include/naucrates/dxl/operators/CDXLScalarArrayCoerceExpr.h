...
#ifndef SPQDXL_CDXLScalarArrayCoerceExpr_H
#define SPQDXL_CDXLScalarArrayCoerceExpr_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarArrayCoerceExpr == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarArrayCoerceExpr_H
