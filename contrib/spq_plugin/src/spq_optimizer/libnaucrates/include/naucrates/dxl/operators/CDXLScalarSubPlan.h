...
#ifndef SPQDXL_CDXLScalarSubPlan_H
#define SPQDXL_CDXLScalarSubPlan_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarSubPlan == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarSubPlan_H
