...
#ifndef SPQDXL_CDXLScalarHashExpr_H
#define SPQDXL_CDXLScalarHashExpr_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarHashExpr == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarHashExpr_H
