...
#ifndef SPQDXL_CDXLScalarProjElem_H
#define SPQDXL_CDXLScalarProjElem_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarProjectElem == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarProjElem_H
