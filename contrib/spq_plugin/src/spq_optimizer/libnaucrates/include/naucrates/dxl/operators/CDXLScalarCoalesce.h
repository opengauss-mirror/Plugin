...
#ifndef SPQDXL_CDXLScalarCoalesce_H
#define SPQDXL_CDXLScalarCoalesce_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarCoalesce == dxl_op->GetDXLOperator());

		return dynamic_cast<CDXLScalarCoalesce *>(dxl_op);
	}
};
}  // namespace spqdxl
#endif	// !SPQDXL_CDXLScalarCoalesce_H
