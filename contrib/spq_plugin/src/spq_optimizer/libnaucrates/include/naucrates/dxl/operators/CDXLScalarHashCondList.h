...
#ifndef SPQDXL_CDXLScalarHashCondList_H
#define SPQDXL_CDXLScalarHashCondList_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarHashCondList == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarHashCondList_H
