...
#ifndef SPQDXL_CParseHandlerScalarPartListNullTest_H
#define SPQDXL_CParseHandlerScalarPartListNullTest_H
...
#endif	// !SPQDXL_CParseHandlerScalarPartListNullTest_H
