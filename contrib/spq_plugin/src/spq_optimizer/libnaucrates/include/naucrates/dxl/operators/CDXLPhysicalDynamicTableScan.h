...
#ifndef SPQDXL_CDXLPhysicalDynamicTableScan_H
#define SPQDXL_CDXLPhysicalDynamicTableScan_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalDynamicTableScan == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalDynamicTableScan_H
