...
//
//---------------------------------------------------------------------------
#ifndef SPQDXL_CDXLLogicalSetOp_H
#define SPQDXL_CDXLLogicalSetOp_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopLogicalSetOp == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLLogicalSetOp_H
