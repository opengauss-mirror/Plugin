...
#ifndef SPQDXL_CParseHandlerPhysicalAbstractBitmapScan_H
#define SPQDXL_CParseHandlerPhysicalAbstractBitmapScan_H
...
#endif	// !SPQDXL_CParseHandlerPhysicalAbstractBitmapScan_H
