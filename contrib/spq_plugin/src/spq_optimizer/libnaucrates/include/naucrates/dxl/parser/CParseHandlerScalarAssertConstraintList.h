...
#ifndef SPQDXL_CParseHandlerScalarAssertConstraintList_H
#define SPQDXL_CParseHandlerScalarAssertConstraintList_H
...
#endif	// !SPQDXL_CParseHandlerScalarAssertConstraintList_H
