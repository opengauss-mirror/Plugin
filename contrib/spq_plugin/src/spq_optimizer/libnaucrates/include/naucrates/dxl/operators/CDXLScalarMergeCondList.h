...
#ifndef SPQDXL_CDXLScalarMergeCondList_H
#define SPQDXL_CDXLScalarMergeCondList_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarMergeCondList == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarMergeCondList_H
