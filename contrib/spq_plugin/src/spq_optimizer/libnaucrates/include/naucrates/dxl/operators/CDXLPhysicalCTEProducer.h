...
//---------------------------------------------------------------------------
#ifndef SPQDXL_CDXLPhysicalCTEProducer_H
#define SPQDXL_CDXLPhysicalCTEProducer_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalCTEProducer == dxl_op->GetDXLOperator());
		return dynamic_cast<CDXLPhysicalCTEProducer *>(dxl_op);
	}
};
}  // namespace spqdxl
#endif	// !SPQDXL_CDXLPhysicalCTEProducer_H
