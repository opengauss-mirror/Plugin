...
#ifndef SPQDXL_CDXLPhysicalDynamicIndexScan_H
#define SPQDXL_CDXLPhysicalDynamicIndexScan_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalDynamicIndexScan == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalDynamicIndexScan_H
