...
#ifndef SPQDXL_CDXLPhysicalWindow_H
#define SPQDXL_CDXLPhysicalWindow_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalWindow == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalWindow_H
