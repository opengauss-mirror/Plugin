...
#ifndef SPQDXL_CDXLPhysicalAssert_H
#define SPQDXL_CDXLPhysicalAssert_H
...
private:
	// error code
	CHAR m_sql_state[SPQOS_SQLSTATE_LENGTH + 1];
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalAssert == dxl_op->GetDXLOperator());

		return dynamic_cast<CDXLPhysicalAssert *>(dxl_op);
	}
};
}  // namespace spqdxl
#endif	// !SPQDXL_CDXLPhysicalAssert_H
