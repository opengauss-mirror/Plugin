...
#ifndef SPQDXL_CDXLScalarLimitOffset_H
#define SPQDXL_CDXLScalarLimitOffset_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarLimitOffset == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarLimitOffset_H
