...
#ifndef SPQDXL_CDXLLogicalUpdate_H
#define SPQDXL_CDXLLogicalUpdate_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopLogicalUpdate == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLLogicalUpdate_H
