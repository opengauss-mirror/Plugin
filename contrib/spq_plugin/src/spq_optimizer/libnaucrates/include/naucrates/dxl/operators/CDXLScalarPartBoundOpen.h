...
#ifndef SPQDXL_CDXLScalarPartBoundOpen_H
#define SPQDXL_CDXLScalarPartBoundOpen_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarPartBoundOpen == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarPartBoundOpen_H
