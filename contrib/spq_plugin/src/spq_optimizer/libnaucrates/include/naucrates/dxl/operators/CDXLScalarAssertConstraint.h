...
#ifndef SPQDXL_CDXLScalarAssertConstraint_H
#define SPQDXL_CDXLScalarAssertConstraint_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarAssertConstraint == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarAssertConstraint_H
