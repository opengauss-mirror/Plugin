...
#ifndef SPQDXL_CParseHandlerFactory_H
#define SPQDXL_CParseHandlerFactory_H
...
private:
	...
	// construct a SPQDB plan parse handler
	...
	static CParseHandlerBase *CreateTableScanParseHandler(
		...
		CParseHandlerBase *parse_handler_root);
    /* SPQ: for ShareScan */
    static CParseHandlerBase *CreateTableShareScanParseHandler(
        CMemoryPool *mp,
...
#endif	// !SPQDXL_CParseHandlerFactory_H
