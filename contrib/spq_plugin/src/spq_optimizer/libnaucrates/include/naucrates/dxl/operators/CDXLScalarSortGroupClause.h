...
#ifndef SPQDXL_CDXLScalarSortGroupClause_H
#define SPQDXL_CDXLScalarSortGroupClause_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarSortGroupClause == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarSortGroupClause_H
