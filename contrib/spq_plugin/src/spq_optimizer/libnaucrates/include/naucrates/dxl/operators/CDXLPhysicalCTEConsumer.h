...
//---------------------------------------------------------------------------
#ifndef SPQDXL_CDXLPhysicalCTEConsumer_H
#define SPQDXL_CDXLPhysicalCTEConsumer_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalCTEConsumer == dxl_op->GetDXLOperator());
		return dynamic_cast<CDXLPhysicalCTEConsumer *>(dxl_op);
	}
};
}  // namespace spqdxl
#endif	// !SPQDXL_CDXLPhysicalCTEConsumer_H
