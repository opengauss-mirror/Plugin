...
#ifndef SPQDXL_CParseHandlerScalarScalarPartBoundInclusion_H
#define SPQDXL_CParseHandlerScalarScalarPartBoundInclusion_H
...
#endif	// !SPQDXL_CParseHandlerScalarScalarPartBoundInclusion_H
