...
#ifndef SPQDXL_CDXLScalarWindowFrameEdge_H
#define SPQDXL_CDXLScalarWindowFrameEdge_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarWindowFrameEdge == dxl_op->GetDXLOperator());

		return dynamic_cast<CDXLScalarWindowFrameEdge *>(dxl_op);
	}
};
}  // namespace spqdxl
#endif	// !SPQDXL_CDXLScalarWindowFrameEdge_H
