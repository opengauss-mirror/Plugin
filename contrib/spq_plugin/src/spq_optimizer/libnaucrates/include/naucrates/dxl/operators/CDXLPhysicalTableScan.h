...
#ifndef SPQDXL_CDXLPhysicalTableScan_H
#define SPQDXL_CDXLPhysicalTableScan_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalTableScan == dxl_op->GetDXLOperator() ||
...
#endif	// !SPQDXL_CDXLPhysicalTableScan_H
