...
#ifndef SPQDXL_CDXLLogicalDelete_H
#define SPQDXL_CDXLLogicalDelete_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopLogicalDelete == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLLogicalDelete_H
