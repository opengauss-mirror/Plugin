...
#ifndef SPQDXL_CDXLPhysicalNLJoin_H
#define SPQDXL_CDXLPhysicalNLJoin_H
...
public:
	...
	PdxlConvert(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalNLJoin == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalNLJoin_H
