...
#ifndef SPQDXL_CDXLScalarPartBoundInclusion_H
#define SPQDXL_CDXLScalarPartBoundInclusion_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarPartBoundInclusion == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarPartBoundInclusion_H
