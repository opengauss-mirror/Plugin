...
#ifndef SPQDXL_CDXLPhysicalSplit_H
#define SPQDXL_CDXLPhysicalSplit_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalSplit == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalSplit_H
