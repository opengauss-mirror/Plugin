...
#ifndef SPQDXL_CDXLScalarSubquery_H
#define SPQDXL_CDXLScalarSubquery_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarSubquery == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarSubquery_H
