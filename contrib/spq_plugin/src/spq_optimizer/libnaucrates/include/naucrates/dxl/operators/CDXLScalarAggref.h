...
#ifndef SPQDXL_CDXLScalarAggref_H
#define SPQDXL_CDXLScalarAggref_H
...
private:
	...
	// Denotes the SPQ Stage
	EdxlAggrefStage m_agg_stage;

	EdxlAggrefKind m_agg_kind;

	// MDId of corresponding spq_agg for supported ordered aggs (optional)
...
public:
	...
	CDXLScalarAggref(CMemoryPool *mp, IMDId *agg_mdid, IMDId *resolved_rettype,
					 ...
					 EdxlAggrefKind aggkind, IMDId *spq_agg_mdid = NULL);
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarAggref == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarAggref_H
