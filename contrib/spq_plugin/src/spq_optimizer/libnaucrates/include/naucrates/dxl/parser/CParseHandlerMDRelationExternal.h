...
#ifndef SPQDXL_CParseHandlerMDRelationExternal_H
#define SPQDXL_CParseHandlerMDRelationExternal_H
...
private:
	...
	// part constraint
	CMDPartConstraintSPQDB *m_part_constraint;
...
#endif	// !SPQDXL_CParseHandlerMDRelationExternal_H
