...
#ifndef SPQDXL_CDXLLogicalConstTable_H
#define SPQDXL_CDXLLogicalConstTable_H
...
public:
	...
	CDXLLogicalConstTable(CMemoryPool *mp,
						  ...
						  CDXLDatum2dArray *pdrspqdrspqdxldatum);
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopLogicalConstTable == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLLogicalConstTable_H
