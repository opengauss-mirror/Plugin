...
#ifndef SPQDXL_CDXLLogicalInsert_H
#define SPQDXL_CDXLLogicalInsert_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopLogicalInsert == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLLogicalInsert_H
