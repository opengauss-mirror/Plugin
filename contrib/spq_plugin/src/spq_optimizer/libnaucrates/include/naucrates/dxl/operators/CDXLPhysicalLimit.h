...
#ifndef SPQDXL_CDXLPhysicalLimit_H
#define SPQDXL_CDXLPhysicalLimit_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalLimit == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalLimit_H
