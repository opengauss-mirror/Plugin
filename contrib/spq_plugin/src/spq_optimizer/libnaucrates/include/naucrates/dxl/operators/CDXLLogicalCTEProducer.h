...
//---------------------------------------------------------------------------
#ifndef SPQDXL_CDXLLogicalCTEProducer_H
#define SPQDXL_CDXLLogicalCTEProducer_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopLogicalCTEProducer == dxl_op->GetDXLOperator());
		return dynamic_cast<CDXLLogicalCTEProducer *>(dxl_op);
	}
};
}  // namespace spqdxl
#endif	// !SPQDXL_CDXLLogicalCTEProducer_H
