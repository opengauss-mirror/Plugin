...
#ifndef SPQDXL_CParseHandlerScalarPartitionSelector_H
#define SPQDXL_CParseHandlerScalarPartitionSelector_H
...
#endif	// !SPQDXL_CParseHandlerScalarPartitionSelector_H
