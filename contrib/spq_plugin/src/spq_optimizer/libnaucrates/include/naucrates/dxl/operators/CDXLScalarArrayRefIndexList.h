...
#ifndef SPQDXL_CDXLScalarArrayRefIndexList_H
#define SPQDXL_CDXLScalarArrayRefIndexList_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopScalarArrayRefIndexList == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLScalarArrayRefIndexList_H
