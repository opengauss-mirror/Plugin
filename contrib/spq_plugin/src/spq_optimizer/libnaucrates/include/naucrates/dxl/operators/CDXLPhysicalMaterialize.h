...
#ifndef SPQDXL_CDXLPhysicalMaterialize_H
#define SPQDXL_CDXLPhysicalMaterialize_H
...
public:
	...
	Cast(CDXLOperator *dxl_op)
	{
		...
		SPQOS_ASSERT(EdxlopPhysicalMaterialize == dxl_op->GetDXLOperator());
...
#endif	// !SPQDXL_CDXLPhysicalMaterialize_H
