...
//---------------------------------------------------------------------------
#ifndef SPQDXL_CDXLNode_H
#define SPQDXL_CDXLNode_H
...
typedef CHashMap<ULONG, CDXLNode, spqos::HashValue<ULONG>, spqos::Equals<ULONG>,
