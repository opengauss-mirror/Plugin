...
//
//	@filename:
//		CDatumGenericSPQDB.h
//
//	@doc:
//		SPQDB-specific generic datum representation
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CDatumGenericSPQDB_H
#define SPQNAUCRATES_CDatumGenericSPQDB_H
...
//
//---------------------------------------------------------------------------
class CDatumGenericSPQDB : public IDatumGeneric
{
private:
	// memory pool
	CMemoryPool *m_mp;
	...
	// private copy ctor
	CDatumGenericSPQDB(const CDatumGenericSPQDB &);

public:
	// ctor
	CDatumGenericSPQDB(CMemoryPool *mp, IMDId *mdid, INT type_modifier,
					  const void *src, ULONG size, BOOL is_null,
					  LINT stats_comp_val_int, CDouble stats_comp_val_double);

	// dtor
	virtual ~CDatumGenericSPQDB();
...
};	// class CDatumGenericSPQDB
}  // namespace spqnaucrates


#endif	// !SPQNAUCRATES_CDatumGenericSPQDB_H
