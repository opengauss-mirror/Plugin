...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_IDatum_H
#define SPQNAUCRATES_IDatum_H
...
typedef CHashMap<ULONG, IDatum, spqos::HashValue<ULONG>, spqos::Equals<ULONG>,
...
public:
	...
	StatsAreGreaterThan(const IDatum *datum) const
	{
		...
		SPQOS_ASSERT(stats_are_comparable &&
