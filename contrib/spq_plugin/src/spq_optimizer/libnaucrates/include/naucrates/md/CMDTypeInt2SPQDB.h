...
//
//	@doc:
//		Class for representing INT2 types in SPQDB
//---------------------------------------------------------------------------



#ifndef SPQMD_CMDTypeInt2SPQDB_H
#define SPQMD_CMDTypeInt2SPQDB_H

#include "spqos/base.h"

#include "naucrates/md/SPQDBTypeHelper.h"
#include "naucrates/md/IMDTypeInt2.h"

#define SPQDB_INT2_OID OID(21)
#define SPQDB_INT2_OPFAMILY OID(1977)
#define SPQDB_INT2_LEGACY_OPFAMILY OID(7100)
#define SPQDB_INT2_LENGTH 2
#define SPQDB_INT2_EQ_OP OID(94)
#define SPQDB_INT2_NEQ_OP OID(519)
#define SPQDB_INT2_LT_OP OID(95)
#define SPQDB_INT2_LEQ_OP OID(522)
#define SPQDB_INT2_GT_OP OID(520)
#define SPQDB_INT2_GEQ_OP OID(524)
#define SPQDB_INT2_COMP_OP OID(350)
#define SPQDB_INT2_EQ_FUNC OID(63)
#define SPQDB_INT2_ARRAY_TYPE OID(1005)

#define SPQDB_INT2_AGG_MIN OID(2133)
#define SPQDB_INT2_AGG_MAX OID(2117)
#define SPQDB_INT2_AGG_AVG OID(2102)
#define SPQDB_INT2_AGG_SUM OID(2109)
#define SPQDB_INT2_AGG_COUNT OID(2147)
...
//
//	@doc:
//		Class for representing INT2 type in SPQDB
//
//---------------------------------------------------------------------------
class CMDTypeInt2SPQDB : public IMDTypeInt2
{
	friend class SPQDBTypeHelper<CMDTypeInt2SPQDB>;
...
private:
	...
	// private copy ctor
	CMDTypeInt2SPQDB(const CMDTypeInt2SPQDB &);

public:
	// ctor
	explicit CMDTypeInt2SPQDB(CMemoryPool *mp);

	// dtor
	virtual ~CMDTypeInt2SPQDB();
	...
	Length() const
	{
		return SPQDB_INT2_LENGTH;
	}

	// return the SPQDB length
	virtual INT
	GetSPQDBLength() const
	{
		return SPQDB_INT2_LENGTH;
	}
...
#endif	// !SPQMD_CMDTypeInt2SPQDB_H
