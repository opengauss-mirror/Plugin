...
//
//	@doc:
//		Class for representing OID types in SPQDB
//---------------------------------------------------------------------------

#ifndef SPQMD_CMDTypeOidSPQDB_H
#define SPQMD_CMDTypeOidSPQDB_H
...
#define SPQDB_OID_OID OID(26)
#define SPQDB_OID_OPFAMILY OID(1990)
#define SPQDB_OID_LEGACY_OPFAMILY OID(7109)
#define SPQDB_OID_LENGTH 4
#define SPQDB_OID_EQ_OP OID(607)
#define SPQDB_OID_NEQ_OP OID(608)
#define SPQDB_OID_LT_OP OID(609)
#define SPQDB_OID_LEQ_OP OID(611)
#define SPQDB_OID_GT_OP OID(610)
#define SPQDB_OID_GEQ_OP OID(612)
#define SPQDB_OID_EQ_FUNC OID(184)
#define SPQDB_OID_ARRAY_TYPE OID(1028)
#define SPQDB_OID_COMP_OP OID(356)
#define SPQDB_OID_HASH_OP OID(0)

#define SPQDB_OID_AGG_MIN OID(2134)
#define SPQDB_OID_AGG_MAX OID(2118)
#define SPQDB_OID_AGG_AVG OID(0)
#define SPQDB_OID_AGG_SUM OID(0)
#define SPQDB_OID_AGG_COUNT OID(2147)
...
//
//---------------------------------------------------------------------------
class CMDTypeOidSPQDB : public IMDTypeOid
{
	friend class SPQDBTypeHelper<CMDTypeOidSPQDB>;
...
private:
	...
	// private copy ctor
	CMDTypeOidSPQDB(const CMDTypeOidSPQDB &);

public:
	// ctor/dtor
	explicit CMDTypeOidSPQDB(CMemoryPool *mp);

	virtual ~CMDTypeOidSPQDB();
