...
//
//	@doc:
//		Class for representing Int8 types in SPQDB
//---------------------------------------------------------------------------



#ifndef SPQMD_CMDTypeInt8SPQDB_H
#define SPQMD_CMDTypeInt8SPQDB_H
...
#define SPQDB_INT8_OID OID(20)
#define SPQDB_INT8_OPFAMILY OID(1977)
#define SPQDB_INT8_LEGACY_OPFAMILY OID(7100)
#define SPQDB_INT8_LENGTH 8
#define SPQDB_INT8_EQ_OP OID(410)
#define SPQDB_INT8_NEQ_OP OID(411)
#define SPQDB_INT8_LT_OP OID(412)
#define SPQDB_INT8_LEQ_OP OID(414)
#define SPQDB_INT8_GT_OP OID(413)
#define SPQDB_INT8_GEQ_OP OID(415)
#define SPQDB_INT8_COMP_OP OID(351)
#define SPQDB_INT8_ARRAY_TYPE OID(1016)

#define SPQDB_INT8_AGG_MIN OID(2131)
#define SPQDB_INT8_AGG_MAX OID(2115)
#define SPQDB_INT8_AGG_AVG OID(2100)
#define SPQDB_INT8_AGG_SUM OID(2107)
#define SPQDB_INT8_AGG_COUNT OID(2147)
...
//
//---------------------------------------------------------------------------
class CMDTypeInt8SPQDB : public IMDTypeInt8
{
	friend class SPQDBTypeHelper<CMDTypeInt8SPQDB>;
...
private:
	...
	// private copy ctor
	CMDTypeInt8SPQDB(const CMDTypeInt8SPQDB &);

public:
	// ctor/dtor
	explicit CMDTypeInt8SPQDB(CMemoryPool *mp);

	virtual ~CMDTypeInt8SPQDB();
...
#endif	// !SPQMD_CMDTypeInt8SPQDB_H
