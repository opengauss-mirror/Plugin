...
//
//	@doc:
//		Class for representing SPQDB-specific scalar operators in the MD cache
//---------------------------------------------------------------------------



#ifndef SPQMD_CMDScalarOpSPQDB_H
#define SPQMD_CMDScalarOpSPQDB_H
...
//
//---------------------------------------------------------------------------
class CMDScalarOpSPQDB : public IMDScalarOp
{
private:
	// memory pool
	CMemoryPool *m_mp;
	...
	CMDScalarOpSPQDB(const CMDScalarOpSPQDB &);

public:
	// ctor/dtor
	CMDScalarOpSPQDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname,
...
#endif	// !SPQMD_CMDScalarOpSPQDB_H
