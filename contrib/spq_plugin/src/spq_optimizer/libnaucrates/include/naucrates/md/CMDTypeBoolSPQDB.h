...
//
//	@doc:
//		Class for representing BOOL types in SPQDB
//---------------------------------------------------------------------------



#ifndef SPQMD_CMDTypeBoolSPQDB_H
#define SPQMD_CMDTypeBoolSPQDB_H
...
#define SPQDB_BOOL_OID OID(16)
#define SPQDB_BOOL_OPFAMILY OID(2222)
#define SPQDB_BOOL_LEGACY_OPFAMILY OID(7124)
#define SPQDB_BOOL_LENGTH 1
#define SPQDB_BOOL_EQ_OP OID(91)
#define SPQDB_BOOL_NEQ_OP OID(85)
#define SPQDB_BOOL_LT_OP OID(58)
#define SPQDB_BOOL_LEQ_OP OID(1694)
#define SPQDB_BOOL_GT_OP OID(59)
#define SPQDB_BOOL_GEQ_OP OID(1695)
#define SPQDB_BOOL_COMP_OP OID(1693)
#define SPQDB_BOOL_ARRAY_TYPE OID(1000)
#define SPQDB_BOOL_AGG_MIN OID(0)
#define SPQDB_BOOL_AGG_MAX OID(0)
#define SPQDB_BOOL_AGG_AVG OID(0)
#define SPQDB_BOOL_AGG_SUM OID(0)
#define SPQDB_BOOL_AGG_COUNT OID(2147)
...
//
//---------------------------------------------------------------------------
class CMDTypeBoolSPQDB : public IMDTypeBool
{
	friend class SPQDBTypeHelper<CMDTypeBoolSPQDB>;
...
private:
	...
	// private copy ctor
	CMDTypeBoolSPQDB(const CMDTypeBoolSPQDB &);

public:
	// ctor
	explicit CMDTypeBoolSPQDB(CMemoryPool *mp);

	// dtor
	virtual ~CMDTypeBoolSPQDB();
...
#endif	// !SPQMD_CMDTypeBoolSPQDB_H
