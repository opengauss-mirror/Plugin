...
//
//	@doc:
//		Implementation of SPQDB-specific functions in the metadata cache
//---------------------------------------------------------------------------


#ifndef SPQMD_CMDFunctionSPQDB_H
#define SPQMD_CMDFunctionSPQDB_H
...
//
//	@doc:
//		Implementation for SPQDB-specific functions in the metadata cache
//
//---------------------------------------------------------------------------
class CMDFunctionSPQDB : public IMDFunction
{
private:
	// memory pool
	CMemoryPool *m_mp;
	...
	// private copy ctor
	CMDFunctionSPQDB(const CMDFunctionSPQDB &);

public:
	// ctor/dtor
	CMDFunctionSPQDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname,
...
#endif	// !SPQMD_CMDFunctionSPQDB_H
