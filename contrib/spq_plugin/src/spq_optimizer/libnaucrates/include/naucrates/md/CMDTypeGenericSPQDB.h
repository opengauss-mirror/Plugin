...
//
//	@filename:
//		CMDTypeGenericSPQDB.h
//
//	@doc:
//		Class representing SPQDB generic types
//---------------------------------------------------------------------------

#ifndef SPQMD_CMDTypeGenericSPQDB_H
#define SPQMD_CMDTypeGenericSPQDB_H
...
#define SPQDB_TEXT_EQ_OP OID(98)
#define SPQDB_TEXT_NEQ_OP OID(531)
#define SPQDB_TEXT_LT_OP OID(664)
#define SPQDB_TEXT_LEQ_OP OID(665)
#define SPQDB_TEXT_GT_OP OID(666)
#define SPQDB_TEXT_GEQ_OP OID(667)
...
//
//---------------------------------------------------------------------------
class CMDTypeGenericSPQDB : public IMDTypeGeneric
{
	friend class SPQDBTypeHelper<CMDTypeGenericSPQDB>;
...
private:
	...
	// private copy ctor
	CMDTypeGenericSPQDB(const CMDTypeGenericSPQDB &);
...
public:
	...
	CMDTypeGenericSPQDB(
		...
		IMDId *mdid_base_relation, IMDId *mdid_type_array, INT spqdb_length);

	// dtor
	virtual ~CMDTypeGenericSPQDB();
	...
	// is type an ambiguous one? e.g., AnyElement in SPQDB
...
#endif	// !SPQMD_CMDTypeGenericSPQDB_H
