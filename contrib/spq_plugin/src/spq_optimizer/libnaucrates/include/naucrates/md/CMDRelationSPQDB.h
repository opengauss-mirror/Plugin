...
#ifndef SPQMD_CMDRelationSPQDB_H
#define SPQMD_CMDRelationSPQDB_H
...
//
//---------------------------------------------------------------------------
class CMDRelationSPQDB : public IMDRelation
{
private:
	// memory pool
	CMemoryPool *m_mp;
	...
	// private copy ctor
	CMDRelationSPQDB(const CMDRelationSPQDB &);

public:
	// ctor
	CMDRelationSPQDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname,
...
#endif	// !SPQMD_CMDRelationSPQDB_H
