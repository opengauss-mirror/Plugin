...
#ifndef SPQMD_IMDRelationCTAS_H
#define SPQMD_IMDRelationCTAS_H
...
public:
	...
	{
		SPQOS_ASSERT(!"CTAS tables have no partition columns");
		return NULL;
	}
	...
	{
		SPQOS_ASSERT(!"CTAS tables have no partition types");
		return NULL;
	}
	...
	{
		SPQOS_ASSERT(!"CTAS tables have no keys");
		return NULL;
	}
