...
//
//	@filename:
//		CMDRelationCtasSPQDB.h
//
//	@doc:
//		Class representing MD CTAS relations
//---------------------------------------------------------------------------

#ifndef SPQMD_CMDRelationCTASSPQDB_H
#define SPQMD_CMDRelationCTASSPQDB_H
...
//---------------------------------------------------------------------------
//	@class:
//		CMDRelationCtasSPQDB
//
//	@doc:
//		Class representing MD CTAS relations
//
//---------------------------------------------------------------------------
class CMDRelationCtasSPQDB : public IMDRelationCtas
{
private:
	// memory pool
	CMemoryPool *m_mp;
	...
	// private copy ctor
	CMDRelationCtasSPQDB(const CMDRelationCtasSPQDB &);
...
public:
	...
	{
		SPQOS_ASSERT("CTAS tables have no indexes");
		return 0;
	}
	...
	{
		SPQOS_ASSERT("CTAS tables have no triggers");
		return 0;
	}
	...
	{
		SPQOS_ASSERT("CTAS tables have no constraints");
		return 0;
	}
...
#endif	// !SPQMD_CMDRelationCTASSPQDB_H
