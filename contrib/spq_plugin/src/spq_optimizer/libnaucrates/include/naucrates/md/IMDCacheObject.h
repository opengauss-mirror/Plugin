...
#ifndef SPQMD_IMDCacheObject_H
#define SPQMD_IMDCacheObject_H
...
public:
	...
	virtual void Serialize(spqdxl::CXMLSerializer *) const = 0;
	...
	virtual void SerializeMDIdAsElem(spqdxl::CXMLSerializer *xml_serializer,
