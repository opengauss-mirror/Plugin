...
//
//	@doc:
//		Class for representing INT4 types in SPQDB
//---------------------------------------------------------------------------



#ifndef SPQMD_CMDTypeInt4SPQDB_H
#define SPQMD_CMDTypeInt4SPQDB_H
...
#define SPQDB_INT4_OID OID(23)
#define SPQDB_INT4_OPFAMILY OID(1977)
#define SPQDB_INT4_LEGACY_OPFAMILY OID(7100)
#define SPQDB_INT4_LENGTH 4
#define SPQDB_INT4_EQ_OP OID(96)
#define SPQDB_INT4_NEQ_OP OID(518)
#define SPQDB_INT4_LT_OP OID(97)
#define SPQDB_INT4_LEQ_OP OID(523)
#define SPQDB_INT4_GT_OP OID(521)
#define SPQDB_INT4_GEQ_OP OID(525)
#define SPQDB_INT4_COMP_OP OID(351)
#define SPQDB_INT4_EQ_FUNC OID(65)
#define SPQDB_INT4_ARRAY_TYPE OID(1007)

#define SPQDB_INT4_AGG_MIN OID(2132)
#define SPQDB_INT4_AGG_MAX OID(2116)
#define SPQDB_INT4_AGG_AVG OID(2101)
#define SPQDB_INT4_AGG_SUM OID(2108)
#define SPQDB_INT4_AGG_COUNT OID(2147)
...
//
//---------------------------------------------------------------------------
class CMDTypeInt4SPQDB : public IMDTypeInt4
{
	friend class SPQDBTypeHelper<CMDTypeInt4SPQDB>;
...
private:
	...
	// private copy ctor
	CMDTypeInt4SPQDB(const CMDTypeInt4SPQDB &);

public:
	// ctor
	explicit CMDTypeInt4SPQDB(CMemoryPool *mp);

	//dtor
	virtual ~CMDTypeInt4SPQDB();
...
#endif	// !SPQMD_CMDTypeInt4SPQDB_H
