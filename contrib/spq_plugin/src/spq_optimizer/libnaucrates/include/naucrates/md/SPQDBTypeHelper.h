...
//		different SPQDB types (CMDTypeInt4SPQDB, CMDTypeBoolSPQDB, and CMDTypeGenericSPQDB)
//---------------------------------------------------------------------------
#ifndef SPQMD_SPQDBHelper_H
#define SPQMD_SPQDBHelper_H
