...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CStatisticsUtils_H
#define SPQOPT_CStatisticsUtils_H
...
public:
	...
	// If the grouping column is not a table column then the logical op id is initialized to spqos::ulong_max
...
{
	SPQOS_ASSERT(NULL != val1);
	SPQOS_ASSERT(NULL != val2);
...
#endif	// !SPQOPT_CStatisticsUtils_H
