...
//---------------------------------------------------------------------------
#ifndef SPQOPT_CScaleFactorUtils_H
#define SPQOPT_CScaleFactorUtils_H
...
public:
	struct SJoinCondition
	{
		...
		{
			return CombineHashes(spqos::HashPtr<IMDId>((*oid_pair)[0]),
								 spqos::HashPtr<IMDId>((*oid_pair)[1]));
		}
...
#endif	// !SPQOPT_CScaleFactorUtils_H
