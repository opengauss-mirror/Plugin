...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CStatsPredConj_H
#define SPQNAUCRATES_CStatsPredConj_H
...
public:
	// ctor
	explicit CStatsPredConj(CStatsPredPtrArry *pdrspqstatspred);
...
#endif	// !SPQNAUCRATES_CStatsPredConj_H
