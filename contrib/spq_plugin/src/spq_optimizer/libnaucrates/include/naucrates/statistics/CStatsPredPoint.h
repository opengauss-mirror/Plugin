...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CStatsPredPoint_H
#define SPQNAUCRATES_CStatsPredPoint_H
...
public:
	...
	ConvertPredStats(CStatsPred *pred_stats)
	{
		...
		SPQOS_ASSERT(CStatsPred::EsptPoint == pred_stats->GetPredStatsType());
...
#endif	// !SPQNAUCRATES_CStatsPredPoint_H
