...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CStatistics_H
#define SPQNAUCRATES_CStatistics_H
...
typedef CHashMap<ULONG, ULongPtrArray, spqos::HashValue<ULONG>,
				 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
				 CleanupRelease<ULongPtrArray> >
	UlongToUlongPtrArrayMap;

// iterator
typedef CHashMapIter<ULONG, ULongPtrArray, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<ULongPtrArray> >
...
#endif	// !SPQNAUCRATES_CStatistics_H
