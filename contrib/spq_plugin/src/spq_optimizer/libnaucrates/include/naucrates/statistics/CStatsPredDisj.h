...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CStatsPredDisj_H
#define SPQNAUCRATES_CStatsPredDisj_H
...
public:
	...
	static ULONG GetColId(const CStatsPredPtrArry *pdrspqstatspred);
	...
	ConvertPredStats(CStatsPred *pred_stats)
	{
		...
		SPQOS_ASSERT(CStatsPred::EsptDisj == pred_stats->GetPredStatsType());
...
#endif	// !SPQNAUCRATES_CStatsPredDisj_H
