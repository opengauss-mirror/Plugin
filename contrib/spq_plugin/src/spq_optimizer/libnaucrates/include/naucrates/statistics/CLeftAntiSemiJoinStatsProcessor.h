...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CLeftAntiSemiJoinStatsProcessor_H
#define SPQNAUCRATES_CLeftAntiSemiJoinStatsProcessor_H
...
#endif	// !SPQNAUCRATES_CLeftAntiSemiJoinStatsProcessor_H
