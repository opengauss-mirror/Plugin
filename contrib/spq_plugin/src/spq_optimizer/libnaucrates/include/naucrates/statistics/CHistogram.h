...
//---------------------------------------------------------------------------
#ifndef SPQNAUCRATES_CHistogram_H
#define SPQNAUCRATES_CHistogram_H
...
//
//---------------------------------------------------------------------------
class CHistogram : public spqos::DbgPrintMixin<CHistogram>
{
	// hash map from column id to a histogram
	typedef CHashMap<ULONG, CHistogram, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupDelete<CHistogram> >
		UlongToHistogramMap;

	// iterator
	typedef CHashMapIter<ULONG, CHistogram, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupDelete<CHistogram> >
		UlongToHistogramMapIter;

	// hash map from column ULONG to CDouble
	typedef CHashMap<ULONG, CDouble, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupDelete<CDouble> >
		UlongToDoubleMap;

	// iterator
	typedef CHashMapIter<ULONG, CDouble, spqos::HashValue<ULONG>,
						 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupDelete<CDouble> >
...
public:
	...
	GetNumBuckets() const
	{
		SPQOS_ASSERT(m_histogram_buckets != NULL);
...
#endif	// !SPQNAUCRATES_CHistogram_H
