...
#ifndef SPQNAUCRATES_CBucket_H
#define SPQNAUCRATES_CBucket_H
...
#define SPQOPT_BUCKET_DEFAULT_FREQ 1.0
#define SPQOPT_BUCKET_DEFAULT_DISTINCT 1.0
...
class CBucket : public IBucket, public spqos::DbgPrintMixin<CBucket>
{
private:
...
public:
	...
	{
		SPQOS_ASSERT(CDouble(0) <= frequency);
		SPQOS_ASSERT(CDouble(1.0) >= frequency);
	...
	{
		SPQOS_ASSERT(CDouble(0) <= distinct);
		m_distinct = distinct;
	}
