...
//		during iteration.
//---------------------------------------------------------------------------
#ifndef SPQOS_CSyncHashtableAccessByIter_H
#define SPQOS_CSyncHashtableAccessByIter_H
...
public:
	...
	Value() const
	{
		SPQOS_ASSERT(m_iter.m_invalid_elem_inserted &&
...
#endif	// !SPQOS_CSyncHashtableAccessByIter_H
