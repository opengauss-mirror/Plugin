...
//---------------------------------------------------------------------------
#ifndef SPQOS_DbgPrintMixin_H
#define SPQOS_DbgPrintMixin_H
...
// public base:
// namespace ns {
// class U : public spqos::DbgPrintMixin<U> { ... };
// }
//
...
#if defined(SPQOS_DEBUG)
#define FORCE_GENERATE_DBGSTR(Type) template struct ::spqos::DbgPrintMixin<Type>
#else
