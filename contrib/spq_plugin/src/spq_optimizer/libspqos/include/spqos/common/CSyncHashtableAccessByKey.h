...
//---------------------------------------------------------------------------
#ifndef SPQOS_CSyncHashtableAccessByKey_H
#define SPQOS_CSyncHashtableAccessByKey_H


#include "spqos/common/CSyncHashtableAccessorBase.h"
...
public:
	...
	Insert(T *value)
	{
		...
		SPQOS_ASSERT(Base::GetHashTable().IsValid(key));

		// make sure this is the right bucket
		SPQOS_ASSERT(CurrentBucketMatchesKey(key));
...
#endif	// !SPQOS_CSyncHashtableAccessByKey_H
