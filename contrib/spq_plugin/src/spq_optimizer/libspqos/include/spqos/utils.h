...
//
//---------------------------------------------------------------------------
#ifndef SPQOS_utils_H
#define SPQOS_utils_H
...
#define SPQOS_GET_FRAME_POINTER(x) ((x) = (ULONG_PTR) __builtin_frame_address(0))

#define SPQOS_MSEC_IN_SEC ((ULLONG) 1000)
#define SPQOS_USEC_IN_MSEC ((ULLONG) 1000)
#define SPQOS_USEC_IN_SEC (((ULLONG) 1000) * 1000)
#define SPQOS_NSEC_IN_SEC (((ULLONG) 1000) * 1000 * 1000)
...
{
	return HashByteArray((BYTE *) pt, SPQOS_SIZEOF(T));
}
...
HashPtr(const T *pt)
{
	return HashByteArray((BYTE *) &pt, SPQOS_SIZEOF(void *));
}
