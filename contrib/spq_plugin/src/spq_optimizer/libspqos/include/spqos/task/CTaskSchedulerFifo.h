...
//---------------------------------------------------------------------------
#ifndef SPQOS_CTaskSchedulerFifo_H
#define SPQOS_CTaskSchedulerFifo_H

#include "spqos/base.h"
#include "spqos/common/CList.h"
#include "spqos/task/CTask.h"
#include "spqos/task/ITaskScheduler.h"
...
public:
	...
	CTaskSchedulerFifo()
	{
		m_task_queue.Init(SPQOS_OFFSET(CTask, m_task_scheduler_link));
	}
	...
	SPQOS_RESULT Cancel(CTask *task);
...
#endif /* SPQOS_CTaskSchedulerFifo_H */
