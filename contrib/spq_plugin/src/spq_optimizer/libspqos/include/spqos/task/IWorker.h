...
//---------------------------------------------------------------------------
#ifndef SPQOS_IWorker_H
#define SPQOS_IWorker_H

#include "spqos/common/CStackObject.h"
#include "spqos/types.h"

#define SPQOS_CHECK_ABORT (IWorker::CheckAbort(__FILE__, __LINE__))

#define SPQOS_CHECK_STACK_SIZE                         \
	do                                                \
	{                                                 \
...
#define SPQOS_CHECK_ABORT_MAX_INTERVAL_MSEC (ULONG(1500))
