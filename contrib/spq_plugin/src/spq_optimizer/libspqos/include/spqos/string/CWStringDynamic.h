...
//---------------------------------------------------------------------------
#ifndef SPQOS_CWStringDynamic_H
#define SPQOS_CWStringDynamic_H

#include "spqos/memory/CMemoryPoolManager.h"
#include "spqos/string/CWString.h"

#define SPQOS_WSTR_DYNAMIC_CAPACITY_INIT (1 << 7)
#define SPQOS_WSTR_DYNAMIC_STATIC_BUFFER (1 << 10)
