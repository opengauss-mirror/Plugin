...
//---------------------------------------------------------------------------
#ifndef SPQOS_CWStringBase_H
#define SPQOS_CWStringBase_H

#include "spqos/common/clibwrapper.h"
#include "spqos/types.h"

#define SPQOS_WSZ_LENGTH(x) spqos::clib::Wcslen(x)
#define SPQOS_WSZ_STR_LENGTH(x) SPQOS_WSZ_LIT(x), SPQOS_WSZ_LENGTH(SPQOS_WSZ_LIT(x))

#define WCHAR_EOS SPQOS_WSZ_LIT('\0')
