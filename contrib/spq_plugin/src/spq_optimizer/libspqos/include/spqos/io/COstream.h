...
//---------------------------------------------------------------------------
#ifndef SPQOS_COstream_H
#define SPQOS_COstream_H
...
#define SPQOS_OSTREAM_CONVBUF_SIZE (256)
...
private:
	// formatting buffer
	WCHAR m_string_format_buffer[SPQOS_OSTREAM_CONVBUF_SIZE];
