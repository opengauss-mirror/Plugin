...
#ifndef SPQOS_ioutils_H
#define SPQOS_ioutils_H

#include <dlfcn.h>
#include <unistd.h>

#include "spqos/io/iotypes.h"
...
// and specified errno
#define SPQOS_CHECK_SIM_IO_ERR_CODE(return_value, error_no, IOFunc)      \
	do                                                                  \
	{                                                                   \
...
#define SPQOS_CHECK_SIM_IO_ERR(return_value, IOFunc) \
	SPQOS_CHECK_SIM_IO_ERR_CODE(return_value, 1, IOFunc)
