...
//
//---------------------------------------------------------------------------
#ifndef SPQOS_CCACHEACCESSOR_H_
#define SPQOS_CCACHEACCESSOR_H_
...
public:
	...
	Insert(K key, T val)
	{
		...
		SPQOS_ASSERT(!m_inserted && "Accessor was already used for insertion");

		SPQOS_ASSERT(NULL == m_entry && "Accessor already holds an entry");

		CCacheEntry<T, K> *entry = SPQOS_NEW(m_cache->m_mp)
