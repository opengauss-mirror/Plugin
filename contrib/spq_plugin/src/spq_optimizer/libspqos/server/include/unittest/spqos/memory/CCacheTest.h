...
//		Test for CCache
//---------------------------------------------------------------------------
#ifndef SPQOS_CCACHETEST_H_
#define SPQOS_CCACHETEST_H_

#include "spqos/common/CList.h"
#include "spqos/memory/CCache.h"
#include "spqos/memory/CCacheAccessor.h"
...
private:
	...
	static SPQOS_RESULT EresInsertDuplicates(CCache<SSimpleObject *, ULONG *> *);

	// remove
	static SPQOS_RESULT EresRemoveDuplicates(CCache<SSimpleObject *, ULONG *> *);
	...
	public:
		...
		CDeepObject()
		{
			m_list.Init(SPQOS_OFFSET(SDeepObjectEntry, m_link));
		}
...
public:
	...
	static SPQOS_RESULT EresUnittest_Refcount();
	static SPQOS_RESULT EresUnittest_Eviction();
	static SPQOS_RESULT EresUnittest_DeepObject();
	static SPQOS_RESULT EresUnittest_Iteration();
	static SPQOS_RESULT EresUnittest_IterativeDeletion();
