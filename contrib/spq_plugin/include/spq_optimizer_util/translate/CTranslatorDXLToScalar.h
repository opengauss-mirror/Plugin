...
#ifndef SPQDXL_CTranslatorDXLToScalar_H
#define SPQDXL_CTranslatorDXLToScalar_H
...
private:
	...
	// translate a CDXLScalarArrayComp into a SPQDB ScalarArrayOpExpr
	...
	// return a SPQDB subplan from a DXL subplan
	...
	// translate dxldatum to SPQDB Const
...
public:
	...
	// translate a DXL datum into SPQDB const expression
	Expr *TranslateDXLDatumToScalar(CDXLDatum *datum_dxl);
};
}  // namespace spqdxl
#endif	// !SPQDXL_CTranslatorDXLToScalar_H
