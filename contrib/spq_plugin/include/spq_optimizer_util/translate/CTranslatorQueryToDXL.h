...
//
//	@doc:
//		Class providing methods for translating a SPQDB Query object into a
//		DXL Tree
//
//	@test:
//
...
#ifndef SPQDXL_CTranslatorQueryToDXL_H
#define SPQDXL_CTranslatorQueryToDXL_H
...
typedef CHashMap<ULONG, BOOL, spqos::HashValue<ULONG>, spqos::Equals<ULONG>,
				 CleanupDelete<ULONG>, CleanupDelete<BOOL> >
	UlongBoolHashMap;

typedef CHashMapIter<INT, ULONG, spqos::HashValue<INT>, spqos::Equals<INT>,
...
private:
	...
	// translate FromExpr (in the SPQDB query) into a CDXLLogicalJoin or CDXLLogicalGet
	...
	CDXLNode *TranslateSetOpChild(Node *child_node, ULongPtrArray *pdrspqul,
	...
	CDXLNode *CreateDXLUnionAllForGroupingSets(
		...
		BOOL has_aggs, CBitSetArray *pdrspqbsGroupingSets,
...
#endif	// SPQDXL_CTranslatorQueryToDXL_H
