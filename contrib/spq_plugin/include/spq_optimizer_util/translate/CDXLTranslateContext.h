...
#ifndef SPQDXL_CDXLTranslateContext_H
#define SPQDXL_CDXLTranslateContext_H
...
typedef CHashMap<ULONG, TargetEntry, spqos::HashValue<ULONG>,
...
typedef CHashMap<ULONG, CMappingElementColIdParamId, spqos::HashValue<ULONG>,
				 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
				 CleanupRelease<CMappingElementColIdParamId> >
	ULongToColParamMap;

typedef CHashMapIter<ULONG, CMappingElementColIdParamId, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CMappingElementColIdParamId> >
...
private:
	...
	// in an Agg node, as expected in SPQDB
	// TODO: antovl - Jan 26, 2011; remove this when Agg node in SPQDB is fixed
	// to use OUTER instead of 0 for Var::varno in Agg target lists (SPQ-12034)
...
#endif	// !SPQDXL_CDXLTranslateContext_H
