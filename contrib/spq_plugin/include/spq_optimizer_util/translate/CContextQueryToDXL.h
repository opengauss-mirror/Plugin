...
#ifndef SPQDXL_CContextQueryToDXL_H
#define SPQDXL_CContextQueryToDXL_H
...
#define SPQDXL_CTE_ID_START 1
#define SPQDXL_COL_ID_START 1
...
#endif	// SPQDXL_CContextQueryToDXL_H
