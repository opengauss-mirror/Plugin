...
#ifndef SPQDXL_CCTEListEntry_H
#define SPQDXL_CCTEListEntry_H
...
{
	return spqos::HashByteArray((BYTE *) str, clib::Strlen(str));
}
...
typedef CHashMap<ULONG, CCTEListEntry, spqos::HashValue<ULONG>,
				 spqos::Equals<ULONG>, CleanupDelete<ULONG>, CleanupRelease>
	HMUlCTEListEntry;

// iterator
typedef CHashMapIter<ULONG, CCTEListEntry, spqos::HashValue<ULONG>,
					 spqos::Equals<ULONG>, CleanupDelete<ULONG>, CleanupRelease>
	HMIterUlCTEListEntry;

}  // namespace spqdxl
#endif	// !SPQDXL_CCTEListEntry_H
