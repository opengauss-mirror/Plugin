...
//		version tailored for SPQDB, and index strategy
//
//	@test:
//
//
...
#ifndef SPQDXL_CIndexQualInfo_H
#define SPQDXL_CIndexQualInfo_H
...
public:
	...
	// index qual expression tailored for SPQDB
	Expr *m_expr;
	...
	{
		SPQOS_ASSERT((IsA(m_expr, OpExpr) && IsA(m_original_expr, OpExpr)) ||
