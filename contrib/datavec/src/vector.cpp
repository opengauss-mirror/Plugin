...
void init_session_vars(void)
{
    ...
    datavec_session_context* ctx = (datavec_session_context*)MemoryContextAllocZero(u_sess->self_mem_cxt,
                                                                                    sizeof(datavec_session_context));
    ...
    DefineCustomIntVariable("hnsw.ef_search", "Sets the size of the dynamic candidate list for search",
                            "Valid range is 1..1000.", &(get_session_context()->hnsw_ef_search),
    ...
    DefineCustomIntVariable("ivfflat.probes", "Sets the number of probes",
                            "Valid range is 1..lists.", &(get_session_context()->ivfflat_probes),
                            IVFFLAT_DEFAULT_PROBES, IVFFLAT_MIN_LISTS, IVFFLAT_MAX_LISTS,
                            PGC_USERSET, 0, NULL, NULL, NULL);
