...
#define TRACE_POSTGRESQL_CSNLOG_CHECKPOINT_START(INT1)
#define TRACE_POSTGRESQL_CSNLOG_CHECKPOINT_START_ENABLED() (0)
#define TRACE_POSTGRESQL_CSNLOG_CHECKPOINT_DONE(INT1)
#define TRACE_POSTGRESQL_CSNLOG_CHECKPOINT_DONE_ENABLED() (0)
