...
typedef enum BgwHandleStatus {
    ...
    BGWH_STOPPED,//tsdb				/* worker has exited */
	BGWH_POSTMASTER_DIED,//tsdb		/* postmaster died; worker status unclear */
    BGWH_STARTED,//tsdb				/* worker is running */
 	BGWH_NOT_YET_STARTED//tsdb		/* worker hasn't been started yet */
} BgwHandleStatus;
...
typedef struct BackgroundWorker {
    ...
    char bgw_library_name[64];//tsdb	/* only if bgw_main is NULL */
	char bgw_function_name[64]; //tsdb
} BackgroundWorker;
