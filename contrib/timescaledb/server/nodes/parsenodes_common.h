...
typedef enum AlterTableType {
    ...
    AT_AddIntoCBI,
    AT_EnableRowSecurity,//tsdb
    AT_DisableRowSecurity,//tsdb
    AT_ForceRowSecurity,//tsdb
    AT_NoForceRowSecurity,//tsdb
    AT_SetUnLogged,//tsdb
    AT_AlterConstraint,//tsdb
    AT_ReAddComment,//tsdb
    AT_SetLogged,//tsdb
} AlterTableType;
