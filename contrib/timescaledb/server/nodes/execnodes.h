...
typedef struct ResultRelInfo {
    ...
    List *ri_WithCheckOptions;//tsdb
    List *ri_WithCheckOptionExprs;//tsdb
    ProjectionInfo *ri_onConflictSetProj;//tsdb
    ProjectionInfo *ri_onConflictSetWhere;//tsdb
} ResultRelInfo;
...
typedef struct ModifyTableState {
    ...
    List *mt_arbiterindexes;//tsdb
    TupleTableSlot *mt_existing;//tsdb
    TupleTableSlot *mt_conflproj;//tsdb
} ModifyTableState;
