...
static const ObjectPropertyType ObjectProperty[] =
{
	...
	},
	{
		TransformRelationId,
		TransformOidIndexId,
		51,//TRFOID,//需要在SysCacheIdentifier加成员
		InvalidAttrNumber
	},
	{
		TriggerRelationId,
	...
	},
	{
		...
		InvalidAttrNumber,
		(AclObjectKind)19,//(AclObjectKind)ACL_KIND_EVENT_TRIGGER,
		true
	},
	{
		TSConfigRelationId,
			...
			ObjectTypeMap[] =
{
	...
	{
		"domain constraint",(ObjectType) 13//OBJECT_DOMCONSTRAINT
	},
	/* OCLASS_CONVERSION */
	{
	...
	/* OCLASS_DEFAULT */
	{
		"default value", (ObjectType)10//OBJECT_DEFAULT
	},
	/* OCLASS_LANGUAGE */
	{
	...
	/* OCLASS_AM */
	{
		"access method",(ObjectType) 0//OBJECT_ACCESS_METHOD
	},
	/* OCLASS_AMOP */
	{
		"operator of access method",(ObjectType) 2//OBJECT_AMOP
	},
	/* OCLASS_AMPROC */
	{
		"function of access method",(ObjectType) 3//OBJECT_AMPROC
	},
	/* OCLASS_REWRITE */
	{
		"rule", OBJECT_RULE
	...
	/* OCLASS_USER_MAPPING */
	{
		"user mapping",(ObjectType) 42// OBJECT_USER_MAPPING
	},
	/* OCLASS_DEFACL */
	{
		"default acl", (ObjectType) 11 //OBJECT_DEFACL
	},
	/* OCLASS_EXTENSION */
	{
	...
	{
		"event trigger",(ObjectType)31// OBJECT_EVENT_TRIGGER
	},
	/* OCLASS_POLICY */
	{
		"policy",(ObjectType)32// OBJECT_POLICY
	},
	/* OCLASS_TRANSFORM */
	{
		"transform",(ObjectType) 33// OBJECT_TRANSFORM
	}
};
...
getObjectTypeDescription(const ObjectAddress *object)
{
	...
	switch (getObjectClass(object))
	{
		...
		case 31://OCLASS_EVENT_TRIGGER
			appendStringInfoString(&buffer, "event trigger");
			break;

		case 32://OCLASS_POLICY
			appendStringInfoString(&buffer, "policy");
			break;

		case 33://OCLASS_TRANSFORM
			appendStringInfoString(&buffer, "transform");
			break;

		case 29://OCLASS_AM,应该是13
