...
[!NOTE]说明
注意事项可见[ANALYZE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/analyze_analyse.html)。
...
[!NOTE]说明
涉及的参数可见[ANALYZE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/analyze_analyse.html)。
...
[ANALYZE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/analyze_analyse.html)
