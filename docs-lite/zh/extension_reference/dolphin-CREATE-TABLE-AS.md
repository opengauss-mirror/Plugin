...
[CREATE TABLE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/create_table_1.html)，[SELECT](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/SELECT.html)
