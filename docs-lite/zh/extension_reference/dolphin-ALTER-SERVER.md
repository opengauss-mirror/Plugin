...
- **OPTIONS**
    ...
    - mysql\_fdw支持的options包括：
        ...
        - **database**  （默认为空）
            ...
            无实际意义，仅做语法兼容。指定MySQL Server/MariaDB连接的数据库请在[CREATE FOREIGN TABLE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/create_foreign_table.html)或[ALTER FOREIGN TABLE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/alter_foreign_table.html)中完成。
...
[CREATE SERVER](dolphin-CREATE-SERVER.md)，[DROP SERVER](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/drop_server.html)
