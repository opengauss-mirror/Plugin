...
>涉及的参数表现与[DROP TABLE]相同(https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/drop_table.html)。
...
[DROP TABLE](https://docs.opengauss.org/zh/docs/latest-lite/sql_reference/drop_table.html)
