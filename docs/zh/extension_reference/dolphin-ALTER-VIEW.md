...
[CREATE VIEW](https://docs.opengauss.org/zh/docs/latest/sql_reference/create_view.html)，[DROP VIEW](https://docs.opengauss.org/zh/docs/latest/sql_reference/drop_view.html)
