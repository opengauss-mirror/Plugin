...
[ALTER TABLE PARTITION](https://docs.opengauss.org/zh/docs/latest/sql_reference/alter_table_partition.html)，[DROP TABLE](https://docs.opengauss.org/zh/docs/latest/sql_reference/drop_table.html)
