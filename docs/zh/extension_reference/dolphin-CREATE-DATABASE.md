...
[ALTER DATABASE](dolphin-ALTER-DATABASE.md)，[DROP DATABASE](dolphin-DROP-DATABASE.md),  [CREATE DATABASE](https://docs.opengauss.org/zh/docs/latest/sql_reference/create_database.html)
