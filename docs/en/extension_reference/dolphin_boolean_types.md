...
For more information about the Boolean type of the original openGauss, see [openGauss Boolean Types](https://docs.opengauss.org/en/docs/latest/sql_reference/boolean_types.html).
