...
[CREATE TABLE](https://docs.opengauss.org/en/docs/latest/sql_reference/create_table.html), [SELECT](https://docs.opengauss.org/en/docs/latest/sql_reference/select.html)
