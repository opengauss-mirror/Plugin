...
- **DEFERRABLE | NOT DEFERRABLE**
    ...
    For details, see  [CREATE TABLE](https://docs.opengauss.org/en/docs/latest/sql_reference/create_table.html).
...
[ALTER TRIGGER](https://docs.opengauss.org/en/docs/latest/sql_reference/alter_trigger.html),  [DROP TRIGGER](https://docs.opengauss.org/en/docs/latest/sql_reference/drop_trigger.html), and  [ALTER TABLE](https://docs.opengauss.org/en/docs/latest/sql_reference/alter_table.html)
